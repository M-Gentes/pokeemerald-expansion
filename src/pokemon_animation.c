...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
    {
        ...
        [SPECIES_SMASHBAG] = BACK_ANIM_H_SHAKE,
        [SPECIES_CLAWHILL] = BACK_ANIM_H_SHAKE,
        [SPECIES_MAGICORN] = BACK_ANIM_H_SHAKE,
        [SPECIES_MAGICOAT] = BACK_ANIM_H_SHAKE,
        [SPECIES_SWIRLHEAD] = BACK_ANIM_H_SHAKE,
        [SPECIES_TERRORKING] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONBLOON] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONHUT] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONTITAN] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONWINGS] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONWITCH] = BACK_ANIM_H_SHAKE,
        [SPECIES_BRUTEBONNET] = BACK_ANIM_H_SHAKE,
        [SPECIES_GREATTUSK] = BACK_ANIM_H_SHAKE,
        [SPECIES_SLITHERWING] = BACK_ANIM_H_SHAKE,
        [SPECIES_SCREAMTAIL] = BACK_ANIM_H_SHAKE,
        [SPECIES_SANDYSHOCKS] = BACK_ANIM_H_SHAKE,
        [SPECIES_FLUTTERMANE] = BACK_ANIM_H_SHAKE,
        [SPECIES_ROARINGMOON] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONBUNDLE] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONHANDS] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONJUGULIS] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONMOTH] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONTHORNS] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONTREADS] = BACK_ANIM_H_SHAKE,
        [SPECIES_IRONVALIANT] = BACK_ANIM_H_SHAKE,
        [SPECIES_SPIRIGATITO] = BACK_ANIM_H_SHAKE,
        [SPECIES_FLORAGATO] = BACK_ANIM_H_SHAKE,
        [SPECIES_YUKAXATO] = BACK_ANIM_H_SHAKE,
        [SPECIES_FUECOCO] = BACK_ANIM_H_SHAKE,
        [SPECIES_CROCALOR] = BACK_ANIM_H_SHAKE,
        [SPECIES_SPICABORO] = BACK_ANIM_H_SHAKE,
        [SPECIES_QUAXLY] = BACK_ANIM_H_SHAKE,
        [SPECIES_QUAXWELL] = BACK_ANIM_H_SHAKE,
        [SPECIES_QUAXISTADOR] = BACK_ANIM_H_SHAKE,
        [SPECIES_PAWMI] = BACK_ANIM_H_SHAKE,
        [SPECIES_PAWMO] = BACK_ANIM_H_SHAKE,
        [SPECIES_PAWMOT] = BACK_ANIM_H_SHAKE,
        [SPECIES_ANNIHILAPE] = BACK_ANIM_H_SHAKE,
        [SPECIES_DUDUNSPARCE] = BACK_ANIM_H_SHAKE,
        [SPECIES_FARIGIRAF] = BACK_ANIM_H_SHAKE,
        [SPECIES_KINGAMBIT] = BACK_ANIM_H_SHAKE,
        [SPECIES_CASTSTORM] = BACK_ANIM_H_SHAKE,
        [SPECIES_BRYNXESS] = BACK_ANIM_H_SHAKE,
        [SPECIES_APOKARGO] = BACK_ANIM_H_SHAKE,
        [SPECIES_QUEZATU] = BACK_ANIM_H_SHAKE,
        [SPECIES_RELICLIFFON] = BACK_ANIM_H_SHAKE,
        [SPECIES_DRACONEON] = BACK_ANIM_H_SHAKE,
        [SPECIES_MERAKI] = BACK_ANIM_H_SHAKE,
};
...
static const u8 sBackAnimationIds[] =
    {
        ...
        ANIM_GROW,
        ANIM_GROW_IN_STAGES,
        [(BACK_ANIM_CIRCLE_COUNTERCLOCKWISE - 1) * 3] = ANIM_CIRCLE_C_CLOCKWISE_LONG,
