const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_BRUTEBONNET] = _("Brute Bonnet"),
    [SPECIES_GREATTUSK] = _("Great Tusk"),
    [SPECIES_SLITHERWING] = _("Slither Wing"),
    [SPECIES_SCREAMTAIL] = _("Scream Tail"),
    [SPECIES_SANDYSHOCKS] = _("Sandy Shocks"),
    [SPECIES_FLUTTERMANE] = _("Flutter Mane"),
    [SPECIES_ROARINGMOON] = _("Roaring Moon"),
    [SPECIES_IRONBUNDLE] = _("Iron Bundle"),
    [SPECIES_IRONHANDS] = _("Iron Hands"),
    [SPECIES_IRONJUGULIS] = _("Iron Jugulis"),
    [SPECIES_IRONMOTH] = _("Iron Moth"),
    [SPECIES_IRONTHORNS] = _("Iron Thorns"),
    [SPECIES_IRONTREADS] = _("Iron Treads"),
    [SPECIES_IRONVALIANT] = _("Iron Valiant"),
    //Paldea
