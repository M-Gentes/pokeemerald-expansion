const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_KAGECOON] = _("Kagecoon"),
    [SPECIES_TANDAYU] = _("Tandayu"),
    // Custom Megas
    ...
    [SPECIES_FEAROW_MEGA] = _("Fearow"),
    [SPECIES_MACHAMP_MEGA] = _("Machamp"),
    [SPECIES_GOLEM_MEGA] = _("Golem"),
    [SPECIES_NOCTOWL_MEGA] = _("Noctowl"),
    [SPECIES_KINGDRA_MEGA] = _("Kingdra"),
    [SPECIES_CHIMECHO_MEGA] = _("Chimecho"),
    [SPECIES_WAILORD_MEGA] = _("Wailord"),
    [SPECIES_CHESNAUGHT_MEGA] = _("Chesnaught"),
    [SPECIES_DELPHOX_MEGA] = _("Delphox"),
    [SPECIES_PALOSSAND_MEGA] = _("Palossand"),
    [SPECIES_FALINKS_MEGA] = _("Falinks"),
    [SPECIES_ECLIMINARY] = _("Ecliminary"),
    [SPECIES_PUMPKING] = _("Pumpking"),
    ...
    [SPECIES_KECLILISK] = _("Keclilisk"),
    [SPECIES_DHELVESSEL] = _("Dhelvessel"),
    [SPECIES_SPIKEDASH] = _("Spikedash"),
    [SPECIES_IRONWALKS] = _("Ironwalks"),
    [SPECIES_LURINSKULL] = _("Lurinskull"),
    [SPECIES_IRONSEEKER] = _("Ironseeker"),
    [SPECIES_NOKAY] = _("Nokay"),
    [SPECIES_IRONKNEEL] = _("Ironkneel"),
    [SPECIES_VENOMFEAR] = _("Skullfear"),
    [SPECIES_IRONSTING] = _("Ironsting"),
    [SPECIES_SLENDERSUN] = _("Slendersun"),
    [SPECIES_IRONPANEL] = _("Ironpanel"),
    [SPECIES_DREADBOULD] = _("Dreadbould"),
    [SPECIES_IRONHOLE] = _("Ironhole"),
    [SPECIES_ARCHMUSSEL] = _("Archmussel"),
    [SPECIES_IRONPUMP] = _("Ironpump"),
    [SPECIES_STEAMOUNT] = _("Steamount"),
    [SPECIES_IRONFUSE] = _("Ironfuse"),
    [SPECIES_ABYSSCLAW] = _("Abyssclaw"),
    [SPECIES_IRONSUB] = _("Ironsub"),
    [SPECIES_CINDEROOT] = _("Cinderoot"),
    [SPECIES_IRONPLASMA] = _("Ironplasma"),
    [SPECIES_GLACIARMOR] = _("Glaciarmor"),
    [SPECIES_IRONWAVES] = _("Ironsuit"),
    [SPECIES_SUMMONCIRCLE] = _("Summncircl"),
    [SPECIES_IRONGATE] = _("Irongate"),
    [SPECIES_CUBEPUNCH] = _("Cubepunch"),
    [SPECIES_IRONVISION] = _("Ironvision"),
    [SPECIES_BARKJAM] = _("Barkjam"),
    [SPECIES_IRONBUZZ] = _("Ironbuzz"),
    [SPECIES_FLOATINHUNT] = _("Floatnhunt"),
    [SPECIES_IRONROCKET] = _("Ironrocket"),
    [SPECIES_PLEASODOR] = _("Pleasodor"),
    [SPECIES_IRONSPRAY] = _("Ironspray"),
    [SPECIES_SANESECT] = _("Sanesect"),
    [SPECIES_IRONFECTION] = _("Ironfection"),
    [SPECIES_INFINAGA] = _("Infinaga"),
    [SPECIES_IRONFAN] = _("Ironfan"),
    [SPECIES_TOXSPITTLE] = _("Toxspittle"),
    [SPECIES_IRONSAT] = _("Ironsat"),
    [SPECIES_CRAWLFANG] = _("Crawlfang"),
    [SPECIES_IRONBOOM] = _("Ironboom"),
    [SPECIES_SEALSTONE] = _("Sealstone"),
    [SPECIES_IRONSABER] = _("Ironsaber"),
    [SPECIES_GLIDEBURN] = _("Glideburn"),
    [SPECIES_IRONCUBATOR] = _("Ironcubator"),
    [SPECIES_RAPIDASH_MEGA] = _("Rapidash"),
    [SPECIES_MIGHTYENA_MEGA] = _("Mightyena"),
    [SPECIES_DRIFBLIM_MEGA] = _("Drifblim"),
    [SPECIES_VANILLUXE_MEGA] = _("Vanilluxe"),
    [SPECIES_FORRETRESS_MEGA] = _("Forretress"),
    [SPECIES_BOLTUND_MEGA] = _("Boltund"),
    [SPECIES_SWALOT_MEGA] = _("Swalot"),
    [SPECIES_SLOWKING_MEGA] = _("Slowking"),
    [SPECIES_SEAKING_MEGA] = _("Seaking"),
    [SPECIES_LEDIAN_MEGA] = _("Ledian"),
    [SPECIES_ARBOK_MEGA] = _("Arbok"),
    [SPECIES_SMEARGLE_MEGA] = _("Smeargle"),
    [SPECIES_REVAVROOM_MEGA] = _("Revavroom"),
    [SPECIES_KLEFKI_MEGA] = _("Klefki"),
    [SPECIES_PINCURCHIN_MEGA] = _("Pincurchin"),
    [SPECIES_TURTONATOR_MEGA] = _("Turtonator"),
    [SPECIES_THIEVUL_MEGA] = _("Thievul"),
    [SPECIES_TOUCANNON_MEGA] = _("Toucannon"),
    [SPECIES_YANMEGA_MEGA] = _("Yanmega"),
    [SPECIES_LIEPARD_MEGA] = _("Liepard"),
    [SPECIES_KLINKLANG_MEGA] = _("Klinklang"),
    [SPECIES_HONCHKROW_MEGA] = _("Honchkrow"),
    [SPECIES_GOLDUCK_MEGA] = _("Golduck"),
    [SPECIES_ROSERADE_MEGA] = _("Roserade"),
    [SPECIES_SIGILYPH_MEGA] = _("Sigilyph"),
    [SPECIES_MANTINE_MEGA] = _("Mantine"),
    [SPECIES_BIDOOF_MEGA] = _("Bidoof"),
    [SPECIES_OMASTAR_MEGA] = _("Omastar"),
    [SPECIES_KABUTOPS_MEGA] = _("Kabutops"),
    [SPECIES_PORYGON_Z_MEGA] = _("Porygon-Z"),
    [SPECIES_MARACTUS_MEGA] = _("Maractus"),
    [SPECIES_WHISCASH_MEGA] = _("Whiscash"),
    [SPECIES_SHUCKLE_MEGA] = _("Shuckle"),
    [SPECIES_PARASECT_MEGA] = _("Parasect"),
    [SPECIES_RABSCA_MEGA] = _("Rabsca"),
    [SPECIES_SPIDOPS_MEGA] = _("Spidops"),
    [SPECIES_KRICKETUNE_MEGA] = _("Krickitune"),
    [SPECIES_VENOMOTH_MEGA] = _("Venomoth"),
    ...
    [SPECIES_MEOWSCARADA_MEGA] = _("Meowscrada"),
    ...
    [SPECIES_STARAPTOR_MEGA] = _("Staraptor"),
    [SPECIES_FROSLASS_MEGA] = _("Froslass"),
    [SPECIES_EXCADRILL_MEGA] = _("Excadrill"),
    [SPECIES_SCOLIPEDE_MEGA] = _("Scolipede"),
    [SPECIES_SCRAFTY_MEGA] = _("Scrafty"),
    [SPECIES_EELEKTROSS_MEGA] = _("Eelektross"),
    [SPECIES_CHANDELURE_MEGA] = _("Chandelure"),
    [SPECIES_GOLURK_MEGA] = _("Golurk"),
    [SPECIES_PYROAR_MEGA_M] = _("Pyroar"),
    [SPECIES_PYROAR_MEGA_F] = _("Pyroar"),
    [SPECIES_MEOWSTIC_MEGA] = _("Meowstic"),
    [SPECIES_MALAMAR_MEGA] = _("Malamar"),
    [SPECIES_BARBARACLE_MEGA] = _("Barbaracle"),
    [SPECIES_DRAGALGE_MEGA] = _("Dragalge"),
    [SPECIES_HAWLUCHA_MEGA] = _("Hawlucha"),
    [SPECIES_CRABOMINABLE_MEGA] = _("Crabominbl"),
    [SPECIES_GOLISOPOD_MEGA] = _("Golisopod"),
    [SPECIES_DRAMPA_MEGA] = _("Drampa"),
    [SPECIES_SCOVILLAIN_MEGA] = _("Scovillain"),
    [SPECIES_GLIMMORA_MEGA] = _("Glimmora"),
    [SPECIES_TATSUGIRI_MEGA] = _("Tatsugiri"),
    [SPECIES_BAXCALIBUR_MEGA] = _("Baxcalibur"),
    // Megas
