...
static const u8 sIlluminateDescription[] = _("Light+, Fairy absorb, Enc.+");
...
static const u8 sTangledFeetDescription[] = _("Ups evasion and Damage if confused.");
...
static const u8 sPickpocketDescription[] = _("Steals item, thief move+.");
static const u8 sMagicianDescription[] = _("Steals item, while attack.");
...
static const u8 sMegaLauncherDescription[] = _("Boosts pulse, ballistic moves, Acc+.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
    {
        ...
        [ABILITY_PURE_POWER] = _("Mind Power"),
