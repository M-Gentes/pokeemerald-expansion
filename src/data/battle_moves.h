const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_EGG_BOMB] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_HIGH_CRIT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_BALLISTIC,
        .split = SPLIT_PHYSICAL,
        .zMovePower = 180,
        .zMoveEffect = Z_EFFECT_NONE,
    },
    ...
    [MOVE_OCTAZOOKA] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_BALLISTIC | FLAG_SHEER_FORCE_BOOST | FLAG_HIGH_CRIT | FLAG_MEGA_LAUNCHER_BOOST,
        .split = SPLIT_SPECIAL,
        .zMovePower = 120,
        .zMoveEffect = Z_EFFECT_NONE,
    },
    ...
    [MOVE_DIRE_CLAW] =
    {
            ...
            .power = 60,
        #endif
        .effect = EFFECT_TRI_ATTACK, // EFFECT_DIRE_CLAW,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 15,
        .secondaryEffectChance = 50,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_HIGH_CRIT | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SHEER_FORCE_BOOST,
        .split = SPLIT_PHYSICAL,
    ...
    [MOVE_STONE_AXE] =
    {
        .effect = EFFECT_DEFENSE_DOWN_HIT, // EFFECT_STONE_AXE,
        .power = 65,
        .type = TYPE_ROCK,
        .accuracy = 90,
        .pp = 15,
    ...
    [MOVE_BARB_BARRAGE] =
    {
        .effect = EFFECT_HEX, // EFFECT_BARB_BARRAGE,
        .power = 60,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
            ...
            .power = 50,
        #endif
        .effect = EFFECT_DEFENSE_DOWN_HIT, // EFFECT_TRIPLE_ARROWS,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,
        .secondaryEffectChance = 50,
    ...
    [MOVE_CEASELESS_EDGE] =
    {
        .effect =  EFFECT_DEFENSE_DOWN_HIT, // EFFECT_CEASELESS_EDGE,
        .power = 85,
        .type = TYPE_DARK,
        .accuracy = 90,
        .pp = 15,
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_SLICING_MOVE | FLAG_HIGH_CRIT,
        .split = SPLIT_PHYSICAL,
        .zMovePower = 120,
        .zMoveEffect = Z_EFFECT_NONE,
    },
    ...
    // Physical Revelation Dance -> Type Strike
    [MOVE_TERA_BLAST] =
    {
        .effect = EFFECT_REVELATION_DANCE, // EFFECT_TERA_BLAST,
        .power = 80,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_FILLET_AWAY] =
    {
        .effect = EFFECT_CLANGOROUS_SOUL, // EFFECT_FILLET_AWAY
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_RAGING_BULL] =
    {
        .effect = EFFECT_BRICK_BREAK, // EFFECT_RAGING_BULL
        .power = 90,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_HIGH_CRIT, // TO VERIFY
        .split = SPLIT_PHYSICAL,
        .zMovePower = 175,
        .zMoveEffect = Z_EFFECT_NONE,
        // Uncallable by Metronome (to be implemented)
    ...
    [MOVE_RAGE_FIST] =
    {
        .effect = EFFECT_RAGE, // EFFECT_RAGE_FIST
        .power = 50,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 10,
