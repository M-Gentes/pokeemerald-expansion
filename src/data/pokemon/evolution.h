const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
    {
        ...
        [SPECIES_RUFFLET] = {{EVO_LEVEL, 54, SPECIES_BRAVIARY}, {EVO_ITEM, ITEM_ODD_INCENSE, SPECIES_BRAVIARY_HISUIAN}},
        [SPECIES_VULLABY] = {{EVO_LEVEL, 54, SPECIES_MANDIBUZZ}},
        [SPECIES_DEINO] = {{EVO_LEVEL, 50, SPECIES_ZWEILOUS}},
        [SPECIES_ZWEILOUS] = {{EVO_LEVEL, 54, SPECIES_HYDREIGON}, {EVO_ITEM, ITEM_WATER_STONE, SPECIES_SWIRLHEAD}, {EVO_ITEM, ITEM_UPGRADE, SPECIES_IRONJUGULIS}},
        [SPECIES_LARVESTA] = {{EVO_LEVEL, 50, SPECIES_VOLCARONA}, {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_SLITHERWING}, {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_IRONMOTH}},
#endif
#if P_GEN_6_POKEMON == TRUE
