const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
    {
        ...
        [SPECIES_SCYTHER] = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR}, {EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_KLEAVOR}},
#if P_GEN_4_POKEMON == TRUE
        ...
        [SPECIES_QUILAVA] = {{EVO_LEVEL_NIGHT, 36, SPECIES_TYPHLOSION_HISUIAN}},
        ...
        [SPECIES_FEEBAS] = {{EVO_BEAUTY, 170, SPECIES_MILOTIC}, {EVO_TRADE_ITEM, ITEM_PRISM_SCALE, SPECIES_MILOTIC}},
        [SPECIES_CASTFORM] = {{EVO_LEVEL, 40, SPECIES_CASTSTORM}},
        ...
        [SPECIES_CLAMPERL] = {{EVO_TRADE_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL}, {EVO_TRADE_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS}},
        ...
        [SPECIES_DEWOTT] = {{EVO_LEVEL_DARK_TYPE_MON_IN_PARTY, 36, SPECIES_SAMUROTT_HISUIAN}},
        ...
        [SPECIES_DARTRIX] = {{EVO_MOVE_TYPE, TYPE_FIGHTING, SPECIES_DECIDUEYE_HISUIAN}},
