const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
    {
        ...
        [SPECIES_SANESECT] = sSanesectLevelUpLearnset,
        [SPECIES_IRONFECTION] = sIronfectionLevelUpLearnset,
        [SPECIES_INFINAGA] = sInfinagaLevelUpLearnset,
        [SPECIES_IRONFAN] = sIronfanLevelUpLearnset,
        [SPECIES_TOXSPITTLE] = sToxspittleLevelUpLearnset,
        [SPECIES_IRONSAT] = sIronsatLevelUpLearnset,
        [SPECIES_CRAWLFANG] = sCrawlfangLevelUpLearnset,
        [SPECIES_IRONBOOM] = sIronboomLevelUpLearnset,
        [SPECIES_SEALSTONE] = sSealstoneLevelUpLearnset,
        [SPECIES_IRONSABER] = sIronsaberLevelUpLearnset,
        [SPECIES_GLIDEBURN] = sGlideburnLevelUpLearnset,
        [SPECIES_IRONCUBATOR] = sIroncubatorLevelUpLearnset,
        [SPECIES_RAPIDASH_MEGA] = sRapidashLevelUpLearnset,
        [SPECIES_MIGHTYENA_MEGA] = sMightyenaLevelUpLearnset,
        [SPECIES_DRIFBLIM_MEGA] = sDrifblimLevelUpLearnset,
        [SPECIES_VANILLUXE_MEGA] = sVanilluxeLevelUpLearnset,
        [SPECIES_FORRETRESS_MEGA] = sForretressLevelUpLearnset,
        [SPECIES_BOLTUND_MEGA] = sBoltundLevelUpLearnset,
        [SPECIES_SWALOT_MEGA] = sSwalotLevelUpLearnset,
        [SPECIES_SLOWKING_MEGA] = sSlowkingLevelUpLearnset,
        [SPECIES_SEAKING_MEGA] = sSeakingLevelUpLearnset,
        [SPECIES_LEDIAN_MEGA] = sLedianLevelUpLearnset,
        [SPECIES_ARBOK_MEGA] = sArbokLevelUpLearnset,
        [SPECIES_SMEARGLE_MEGA] = sSmeargleLevelUpLearnset,
        [SPECIES_REVAVROOM_MEGA] = sRevavroomLevelUpLearnset,
        [SPECIES_KLEFKI_MEGA] = sKlefkiLevelUpLearnset,
        [SPECIES_PINCURCHIN_MEGA] = sPincurchinLevelUpLearnset,
        [SPECIES_TURTONATOR_MEGA] = sTurtonatorLevelUpLearnset,
        [SPECIES_THIEVUL_MEGA] = sThievulLevelUpLearnset,
        [SPECIES_TOUCANNON_MEGA] = sToucannonLevelUpLearnset,
        [SPECIES_YANMEGA_MEGA] = sYanmegaLevelUpLearnset,
        [SPECIES_LIEPARD_MEGA] = sLiepardLevelUpLearnset,
        [SPECIES_KLINKLANG_MEGA] = sKlinklangLevelUpLearnset,
        [SPECIES_HONCHKROW_MEGA] = sHonchkrowLevelUpLearnset,
        [SPECIES_GOLDUCK_MEGA] = sGolduckLevelUpLearnset,
        [SPECIES_ROSERADE_MEGA] = sRoseradeLevelUpLearnset,
        [SPECIES_SIGILYPH_MEGA] = sSigilyphLevelUpLearnset,
        [SPECIES_MANTINE_MEGA] = sMantineLevelUpLearnset,
        [SPECIES_BIDOOF_MEGA] = sBidoofLevelUpLearnset,
        [SPECIES_OMASTAR_MEGA] = sOmastarLevelUpLearnset,
        [SPECIES_KABUTOPS_MEGA] = sKabutopsLevelUpLearnset,
        [SPECIES_PORYGON_Z_MEGA] = sPorygonZLevelUpLearnset,
        [SPECIES_MARACTUS_MEGA] = sMaractusLevelUpLearnset,
        [SPECIES_WHISCASH_MEGA] = sWhiscashLevelUpLearnset,
        [SPECIES_SHUCKLE_MEGA] = sShuckleLevelUpLearnset,
        [SPECIES_PARASECT_MEGA] = sParasectLevelUpLearnset,
        [SPECIES_RABSCA_MEGA] = sRabscaLevelUpLearnset,
        [SPECIES_SPIDOPS_MEGA] = sSpidopsLevelUpLearnset,
        [SPECIES_KRICKETUNE_MEGA] = sKricketuneLevelUpLearnset,
        [SPECIES_VENOMOTH_MEGA] = sVenomothLevelUpLearnset,
        ...
        [SPECIES_MEOWSCARADA_MEGA] = sYukaxatoLevelUpLearnset,
        [SPECIES_SKELEDIRGE_MEGA] = sSpicaboroLevelUpLearnset,
        [SPECIES_QUAQUAVAL_MEGA] = sQuaxistadorLevelUpLearnset,
        ...
        [SPECIES_FLAPPLE_MEGA] = sFlappleLevelUpLearnset,
        ...
        [SPECIES_PYROAR_MEGA_M] = sPyroarLevelUpLearnset,
        [SPECIES_PYROAR_MEGA_F] = sPyroarLevelUpLearnset,
