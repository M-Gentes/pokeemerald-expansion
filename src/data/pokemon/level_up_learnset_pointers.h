const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
    {
...
#endif
        [SPECIES_SMASHBAG] = sSmashbagLevelUpLearnset,
        [SPECIES_CLAWHILL] = sClawhillLevelUpLearnset,
        [SPECIES_MAGICORN] = sMagicornLevelUpLearnset,
        [SPECIES_MAGICOAT] = sMagicoatLevelUpLearnset,
        [SPECIES_SWIRLHEAD] = sSwirlheadLevelUpLearnset,
        [SPECIES_TERRORKING] = sTerrorkingLevelUpLearnset,
        [SPECIES_IRONBLOON] = sIronbloonLevelUpLearnset,
        [SPECIES_IRONHUT] = sIronhutLevelUpLearnset,
        [SPECIES_IRONTITAN] = sIrontitanLevelUpLearnset,
        [SPECIES_IRONWINGS] = sIronwingsLevelUpLearnset,
        [SPECIES_IRONWITCH] = sIronwitchLevelUpLearnset,
        ...
        [SPECIES_KAGECOON] = sKagecoonLevelUpLearnset,
        [SPECIES_TANDAYU] = sTandayuLevelUpLearnset,
        // Custom Megas
        ...
        [SPECIES_KECLILISK] = sKecliliskLevelUpLearnset,
        [SPECIES_DHELVESSEL] = sDhelvesselLevelUpLearnset,
        [SPECIES_SPIKEDASH] = sSpikedashLevelUpLearnset,
        [SPECIES_IRONWALKS] = sIronwalksLevelUpLearnset,
        [SPECIES_LURINSKULL] = sLurinskullLevelUpLearnset,
        [SPECIES_IRONSEEKER] = sIronseekerLevelUpLearnset,
        [SPECIES_NOKAY] = sNokayLevelUpLearnset,
        [SPECIES_IRONKNEEL] = sIronkneelLevelUpLearnset,
        [SPECIES_VENOMFEAR] = sVenomfearLevelUpLearnset,
        [SPECIES_IRONSTING] = sIronstingLevelUpLearnset,
        [SPECIES_SLENDERSUN] = sSlendersunLevelUpLearnset,
        [SPECIES_IRONPANEL] = sIronpanelLevelUpLearnset,
        [SPECIES_DREADBOULD] = sDreadbouldLevelUpLearnset,
        [SPECIES_IRONHOLE] = sIronholeLevelUpLearnset,
        [SPECIES_ARCHMUSSEL] = sArchmusselLevelUpLearnset,
        [SPECIES_IRONPUMP] = sIronpumpLevelUpLearnset,
        [SPECIES_STEAMOUNT] = sSteamountLevelUpLearnset,
        [SPECIES_IRONFUSE] = sIronfuseLevelUpLearnset,
        [SPECIES_ABYSSCLAW] = sAbyssclawLevelUpLearnset,
        [SPECIES_IRONSUB] = sIronsubLevelUpLearnset,
        [SPECIES_CINDEROOT] = sCinderootLevelUpLearnset,
        [SPECIES_IRONPLASMA] = sIronplasmaLevelUpLearnset,
        [SPECIES_GLACIARMOR] = sGlaciarmorLevelUpLearnset,
        [SPECIES_IRONWAVES] = sIronwavesLevelUpLearnset,
        [SPECIES_SUMMONCIRCLE] = sSummoncircleLevelUpLearnset,
        [SPECIES_IRONGATE] = sIrongateLevelUpLearnset,
        [SPECIES_CUBEPUNCH] = sCubepunchLevelUpLearnset,
        [SPECIES_IRONVISION] = sIronvisionLevelUpLearnset,
        [SPECIES_BARKJAM] = sBarkjamLevelUpLearnset,
        [SPECIES_IRONBUZZ] = sIronbuzzLevelUpLearnset,
        [SPECIES_FLOATINHUNT] = sFloatinhuntLevelUpLearnset,
        [SPECIES_IRONROCKET] = sIronrocketLevelUpLearnset,
        [SPECIES_PLEASODOR] = sPleasodorLevelUpLearnset,
        [SPECIES_IRONSPRAY] = sIronsprayLevelUpLearnset,
        [SPECIES_RAPIDASH_MEGA] = sRapidashMegaLevelUpLearnset,
        [SPECIES_MIGHTYENA_MEGA] = sMightyenaMegaLevelUpLearnset,
        [SPECIES_DRIFBLIM_MEGA] = sDrifblimMegaLevelUpLearnset,
        [SPECIES_VANILLUXE_MEGA] = sVanilluxeMegaLevelUpLearnset,
        [SPECIES_FORRETRESS_MEGA] = sForretressMegaLevelUpLearnset,
        [SPECIES_BOLTUND_MEGA] = sBoltundMegaLevelUpLearnset,
        [SPECIES_SWALOT_MEGA] = sSwalotMegaLevelUpLearnset,
        [SPECIES_SLOKING_MEGA] = sSlokingMegaLevelUpLearnset,
        [SPECIES_GOLKING_MEGA] = sGolkingMegaLevelUpLearnset,
        [SPECIES_LEDIAN_MEGA] = sLedianMegaLevelUpLearnset,
        [SPECIES_ARBOK_MEGA] = sArbokMegaLevelUpLearnset,
        [SPECIES_SMEARGLE_MEGA] = sSmeargleMegaLevelUpLearnset,
        [SPECIES_REVAVROOM_MEGA] = sRevavroomMegaLevelUpLearnset,
        [SPECIES_KLEFKI_MEGA] = sKlefkiMegaLevelUpLearnset,
        [SPECIES_PINCURCHIN_MEGA] = sPincurchinMegaLevelUpLearnset,
        [SPECIES_TURTONATOR_MEGA] = sTurtonatorMegaLevelUpLearnset,
        [SPECIES_THIEVUL_MEGA] = sThievulMegaLevelUpLearnset,
        [SPECIES_TOUCANNON_MEGA] = sToucannonMegaLevelUpLearnset,
        [SPECIES_YANMEGA_MEGA] = sYanmegaMegaLevelUpLearnset,
        [SPECIES_LIEPARD_MEGA] = sLiepardMegaLevelUpLearnset,
        [SPECIES_KLINKLANG_MEGA] = sKlinklangMegaLevelUpLearnset,
        [SPECIES_HONCHKROW_MEGA] = sHonchkrowMegaLevelUpLearnset,
        [SPECIES_GOLDUCK_MEGA] = sGolduckMegaLevelUpLearnset,
        [SPECIES_ROSERADE_MEGA] = sRoseradeMegaLevelUpLearnset,
        [SPECIES_SIGILYPH_MEGA] = sSigilyphMegaLevelUpLearnset,
        [SPECIES_MANTINE_MEGA] = sMantineMegaLevelUpLearnset,
        [SPECIES_BIDOOF_MEGA] = sBidoofMegaLevelUpLearnset,
        [SPECIES_OMASTAR_MEGA] = sOmastarMegaLevelUpLearnset,
        [SPECIES_KABUTOPS_MEGA] = sKabutopsMegaLevelUpLearnset,
        [SPECIES_PORYGONZ_MEGA] = sPorygonzMegaLevelUpLearnset,
        [SPECIES_MARACTUS_MEGA] = sMaractusMegaLevelUpLearnset,
        [SPECIES_WHISCASH_MEGA] = sWhiscashMegaLevelUpLearnset,
        [SPECIES_SHUCKLE_MEGA] = sShuckleMegaLevelUpLearnset,
        [SPECIES_PARASECT_MEGA] = sParasectMegaLevelUpLearnset,
        [SPECIES_RABSCA_MEGA] = sRabascaMegaLevelUpLearnset,
        [SPECIES_SPIDOPS_MEGA] = sSpidopsMegaLevelUpLearnset,
        [SPECIES_KRICKETUNE_MEGA] = sKricketuneMegaLevelUpLearnset,
        [SPECIES_VENOMOTH_MEGA] = sVenomothMegaLevelUpLearnset,
        [SPECIES_MEGANIUM_MEGA] = sMeganiumMegaLevelUpLearnset,
        [SPECIES_FERALIGATR_MEGA] = sFeraligatrMegaLevelUpLearnset,
        [SPECIES_TORTERRA_MEGA] = sTorterraMegaLevelUpLearnset,
        [SPECIES_INFERNAPE_MEGA] = sInfernapeMegaLevelUpLearnset,
        [SPECIES_EMPOLEON_MEGA] = sEmpoleonMegaLevelUpLearnset,
        [SPECIES_SERPERIOR_MEGA] = sSerperiorMegaLevelUpLearnset,
        [SPECIES_EMBOAR_MEGA] = sEmboarMegaLevelUpLearnset,
        [SPECIES_INCINEROAR_MEGA] = sIncineroarMegaLevelUpLearnset,
        [SPECIES_PRIMARINA_MEGA] = sPrimarinaMegaLevelUpLearnset,
        [SPECIES_RILLABOOM_MEGA] = sRillaboomMegaLevelUpLearnset,
        [SPECIES_CINDERACE_MEGA] = sCinderaceMegaLevelUpLearnset,
        [SPECIES_INTELEON_MEGA] = sInteleonMegaLevelUpLearnset,
        [SPECIES_MEOWSCARADA_MEGA] = sMeowscaradaMegaLevelUpLearnset,
        [SPECIES_SKELEDIRGE_MEGA] = sSkeledirgeMegaLevelUpLearnset,
        [SPECIES_QUAQUAVAL_MEGA] = sQuaquavalMegaLevelUpLearnset,
        [SPECIES_KINGLER_MEGA] = sKinglerMegaLevelUpLearnset,
        [SPECIES_LAPRAS_MEGA] = sLaprasMegaLevelUpLearnset,
        [SPECIES_GARBODOR_MEGA] = sGarbodorMegaLevelUpLearnset,
        [SPECIES_CORVIKNIGHT_MEGA] = sCorviknightMegaLevelUpLearnset,
        [SPECIES_ORBEETLE_MEGA] = sOrbeetleMegaLevelUpLearnset,
        [SPECIES_COALOSSAL_MEGA] = sCoalossalMegaLevelUpLearnset,
        [SPECIES_DREDNAW_MEGA] = sDrednawMegaLevelUpLearnset,
        [SPECIES_FLAPPLE_MEGA] = sFlappleMegaLevelUpLearnset,
        [SPECIES_SANDACONDA_MEGA] = sSandacondaMegaLevelUpLearnset,
        [SPECIES_TOXTRICITY_MEGA] = sToxtricityMegaLevelUpLearnset,
        [SPECIES_CENTISKORCH_MEGA] = sCentiskorchMegaLevelUpLearnset,
        [SPECIES_HATTERENE_MEGA] = sHattereneMegaLevelUpLearnset,
        [SPECIES_GRIMMSNARL_MEGA] = sGrimmsnarlMegaLevelUpLearnset,
        [SPECIES_ALCREMIE_MEGA] = sAlcremieMegaLevelUpLearnset,
        [SPECIES_COPPERAJAH_MEGA] = sCopperajahMegaLevelUpLearnset,
        [SPECIES_CLEFABLE_MEGA] = sClefableMegaLevelUpLearnset,
        [SPECIES_VICTREEBEL_MEGA] = sVictreebelMegaLevelUpLearnset,
        [SPECIES_STARMIE_MEGA] = sStarmieMegaLevelUpLearnset,
        [SPECIES_DRAGONITE_MEGA] = sDragoniteMegaLevelUpLearnset,
        [SPECIES_SKARMORY_MEGA] = sSkarmoryMegaLevelUpLearnset,
        [SPECIES_STARAPTOR_MEGA] = sStaraptorMegaLevelUpLearnset,
        [SPECIES_FROSLASS_MEGA] = sFroslassMegaLevelUpLearnset,
        [SPECIES_EXCADRILL_MEGA] = sExcadrillMegaLevelUpLearnset,
        [SPECIES_SCOLIPEDE_MEGA] = sScolipedeMegaLevelUpLearnset,
        [SPECIES_SRAFTY_MEGA] = sSraftyMegaLevelUpLearnset,
        [SPECIES_EELEKTROSS_MEGA] = sEelektrossMegaLevelUpLearnset,
        [SPECIES_CHANDELURE_MEGA] = sChandelureMegaLevelUpLearnset,
        [SPECIES_GOLURK_MEGA] = sGolurkMegaLevelUpLearnset,
        [SPECIES_PYROAR_MEGA_M] = sPyroarMegaMLevelUpLearnset,
        [SPECIES_PYROAR_MEGA_F] = sPyroarMegaFLevelUpLearnset,
        [SPECIES_MEOWSTIC_MEGA] = sMeowsticMegaLevelUpLearnset,
        [SPECIES_MALAMAR_MEGA] = sMalamarMegaLevelUpLearnset,
        [SPECIES_BARBARACLE_MEGA] = sBarbaracleMegaLevelUpLearnset,
        [SPECIES_DRAGALGE_MEGA] = sDragalgeMegaLevelUpLearnset,
        [SPECIES_HAWLUCHA_MEGA] = sHawluchaMegaLevelUpLearnset,
        [SPECIES_CRABOMINABLE_MEGA] = sCrabominableMegaLevelUpLearnset,
        [SPECIES_GOLISOPOD_MEGA] = sGolisopodMegaLevelUpLearnset,
        [SPECIES_DRAMPA_MEGA] = sDrampaMegaLevelUpLearnset,
        [SPECIES_SCOVILLAIN_MEGA] = sScovillainMegaLevelUpLearnset,
        [SPECIES_GLIMMORA_MEGA] = sGlimmoraMegaLevelUpLearnset,
        [SPECIES_TATSUGIRI_MEGA] = sTatsugiriMegaLevelUpLearnset,
        [SPECIES_BAXCALIBUR_MEGA] = sBaxcaliburMegaLevelUpLearnset,
        ...
        [SPECIES_ROTOM_SOUND] = sRotomSoundLevelUpLearnset,
        // Origin Forme
