...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    {.iv = 0,
     ...
     .moves = {MOVE_ZEN_HEADBUTT, MOVE_BRICK_BREAK, MOVE_ICE_PUNCH, MOVE_NONE}},
    {.iv = 0,
     .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    {.iv = 150,
     ...
     .species = SPECIES_NINETALES,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_OVERHEAT, MOVE_HYPNOSIS, MOVE_GRUDGE, MOVE_SUNNY_DAY}},
    {.iv = 150,
     .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    {.iv = 0,
     ...
     .species = SPECIES_CLAYDOL,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_TRICK_ROOM, MOVE_NONE}},
    {.iv = 0,
     .lvl = 43,
     .species = SPECIES_DHELMISE,
     .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_Diana1[] = {
    {
        ...
        .moves = {MOVE_ROCK_TOMB, MOVE_TACKLE, MOVE_NONE, MOVE_NONE}
    }};
