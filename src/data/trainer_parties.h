...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    {.iv = 250,
     ...
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_SHADOW_PUNCH, MOVE_SUCKER_PUNCH, MOVE_FIRE_PUNCH, MOVE_POISON_JAB}},
    {.iv = 250,
     .lvl = 49,
     .species = SPECIES_BANETTE,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    {.iv = 250,
     ...
     .heldItem = ITEM_YACHE_BERRY,
     .moves = {MOVE_HURRICANE, MOVE_DRAGON_CLAW, MOVE_EXTREME_SPEED, MOVE_DRAGON_DANCE}},
    {.iv = 250,
     .lvl = 54,
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_LEFTOVERS,
    ...
    {.iv = 250,
     ...
     .moves = {MOVE_ACROBATICS, MOVE_KNOCK_OFF, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE}},
    {.iv = 255,
     .lvl = 55,
