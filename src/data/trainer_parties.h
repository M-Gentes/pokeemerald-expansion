...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    {.iv = 255,
     ...
     .moves = {MOVE_FISSURE, MOVE_THUNDER, MOVE_NONE, MOVE_NONE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    {.iv = 255,
     ...
     .moves = {MOVE_HEAD_CHARGE, MOVE_SWORDS_DANCE, MOVE_QUICK_ATTACK, MOVE_AQUA_JET}},
    {.iv = 255,
     .lvl = 22,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    {.iv = 250,
     ...
     .moves = {MOVE_SHADOW_SNEAK, MOVE_SWORDS_DANCE, MOVE_WILL_O_WISP, MOVE_KNOCK_OFF}},
    {.iv = 250,
     .lvl = 49,
     .species = SPECIES_GENGAR,
     .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    {.iv = 0,
     .lvl = 22,
     .species = SPECIES_SANDSHREW,
     .moves = {MOVE_SAND_ATTACK, MOVE_POISON_STING, MOVE_SLASH, MOVE_NATURE_POWER}},
    {.iv = 0,
     .lvl = 22,
     .species = SPECIES_MARILL,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMagmaHideout[] = {
    ...
    {.iv = 150,
     ...
     .moves = {MOVE_FIERY_DANCE, MOVE_SLUDGE_WAVE, MOVE_DISCHARGE, MOVE_ELECTRIC_TERRAIN}},
    {.iv = 150,
     .lvl = 39,
     .species = SPECIES_TERRORKING,
