...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    ...
    {.iv = 0,
     ...
     .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_ROCK_SLIDE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    {.iv = 250,
     ...
     .moves = {MOVE_SHADOW_SNEAK, MOVE_SWORDS_DANCE, MOVE_WILL_O_WISP, MOVE_ME_FIRST}},
    {.iv = 250,
     .lvl = 49,
     .species = SPECIES_GENGAR,
     .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    {.iv = 100,
     .lvl = 43,
     .species = SPECIES_SLAKING,
     .moves = {MOVE_ATTRACT, MOVE_ROCK_SLIDE, MOVE_GIGA_IMPACT, MOVE_FLAMETHROWER}},
    {.iv = 100,
     .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    ...
    {.iv = 0,
     ...
     .species = SPECIES_LANTURN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_THUNDERBOLT, MOVE_EARTHQUAKE, MOVE_ICE_BEAM, MOVE_SIGNAL_BEAM}}};
