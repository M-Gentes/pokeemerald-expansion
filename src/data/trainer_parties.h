...
static const struct TrainerMonNoItemCustomMoves sParty_GruntSeafloorCavern4[] = {
    ...
    {.iv = 0,
     .lvl = 36,
     .species = SPECIES_IRONSEEKER,
     .moves = {MOVE_FLASH, MOVE_THUNDERBOLT, MOVE_SIGNAL_BEAM, MOVE_WATER_PULSE}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GruntMtPyre1[] = {
    {
        ...
        .lvl = 32,
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_BRINE, MOVE_AERIAL_ACE, MOVE_WEATHER_BALL, MOVE_ROOST}
    },
    {
        .iv = 0,
        .lvl = 34,
        .species = SPECIES_BASCULEGION,
        .moves = {MOVE_AQUA_JET, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS, MOVE_SURF}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Matt[] = {
    {
        ...
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_HURRICANE, MOVE_SCALD, MOVE_TAILWIND, MOVE_ICE_BEAM}
    },
    {
        .iv = 50,
        .lvl = 35,
        .species = SPECIES_BASCULEGION,
        .moves = {MOVE_WATERFALL, MOVE_PHANTOM_FORCE, MOVE_CRUNCH, MOVE_ICE_FANG}
    },
    {
        .iv = 50,
        .lvl = 35,
        .species = SPECIES_LURINSKULL,
        .moves = {MOVE_LIQUIDATION, MOVE_PHANTOM_FORCE, MOVE_ICE_FANG, MOVE_THUNDER_FANG}
    },
    {
        .iv = 50,
        .lvl = 34,
        .species = SPECIES_CASTFORM,
        .moves = {MOVE_WEATHER_BALL, MOVE_HYDRO_PUMP, MOVE_THUNDER, MOVE_HURRICANE}
    },
    {
        .iv = 50,
        .lvl = 36,
        .species = SPECIES_MALAMAR,
        .moves = {MOVE_SUPERPOWER, MOVE_KNOCK_OFF, MOVE_PSYCHO_CUT, MOVE_LIQUIDATION}
    },
    {
        .iv = 50,
        .lvl = 38,
...
static const struct TrainerMonItemCustomMoves sParty_ShellyWeatherInstitute[] = {
    {
        ...
        .lvl = 27,
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_WING_ATTACK, MOVE_WEATHER_BALL, MOVE_AQUA_RING, MOVE_TAILWIND}
    },
    {
        .iv = 50,
        .lvl = 27,
        .species = SPECIES_TORKOAL,
        .moves = {MOVE_SOLAR_BEAM, MOVE_WEATHER_BALL, MOVE_OVERHEAT, MOVE_YAWN}
    },
    {
        .iv = 50,
        .lvl = 30,
        .species = SPECIES_PUPITAR,
        .moves = {MOVE_ROCK_SLIDE, MOVE_WEATHER_BALL, MOVE_SANDSTORM, MOVE_STEALTH_ROCK}
    },
    {
        .iv = 50,
        .lvl = 28,
        .species = SPECIES_SNOVER,
        .moves = {MOVE_BLIZZARD, MOVE_WEATHER_BALL, MOVE_NATURE_POWER, MOVE_INGRAIN}
    },
    {
        .iv = 50,
        .lvl = 27,
        ...
        .species = SPECIES_CASTFORM,
        .moves = {MOVE_FIRE_BLAST, MOVE_BLIZZARD, MOVE_WATER_PULSE, MOVE_WEATHER_BALL}
    },
    {
        .iv = 0,
        .lvl = 28,
        .heldItem = ITEM_CASTSTORMITE,
        .species = SPECIES_CASTFORM,
...
static const struct TrainerMonItemCustomMoves sParty_ShellySeafloorCavern[] = {
    {.iv = 50,
     .lvl = 37,
     .species = SPECIES_PELIPPER,
     .moves = {MOVE_HURRICANE, MOVE_WEATHER_BALL, MOVE_AQUA_RING, MOVE_TAILWIND}},
    {.iv = 50,
     .lvl = 37,
     .species = SPECIES_HIPPOWDON,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_HIGH_HORSEPOWER, MOVE_WEATHER_BALL, MOVE_STONE_EDGE, MOVE_YAWN}},
    {.iv = 50,
     .lvl = 40,
     .heldItem = ITEM_CHOICE_SPECS,
     .species = SPECIES_CASTSTORM,
     .moves = {MOVE_WEATHER_BALL, MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_THUNDER}}};
...
static const struct TrainerMonItemCustomMoves sParty_Archie[] = {
    {
        ...
        .moves = {MOVE_SURF, MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_SCARY_FACE}
    },
    {
        .iv = 150,
        .lvl = 41,
        .species = SPECIES_DHELVESSEL,
        .moves = {MOVE_POWER_WHIP, MOVE_LIQUIDATION, MOVE_PHANTOM_FORCE, MOVE_ANCHOR_SHOT}
    },
    {
        .iv = 150,
        .lvl = 43,
        .heldItem = ITEM_TENTACRUELITE,
        .species = SPECIES_TENTACRUEL,
        .moves = {MOVE_PHANTOM_FORCE, MOVE_WATERFALL, MOVE_WRAP, MOVE_SWORDS_DANCE}
    },
    {
        .iv = 150,
        .lvl = 41,
        .species = SPECIES_IRONSUB,
        .moves = {MOVE_WATERFALL, MOVE_GEAR_GRIND, MOVE_DRILL_RUN, MOVE_RAIN_DANCE}
    },
    {
        .iv = 150,
        .lvl = 42,
        .species = SPECIES_ARCHMUSSEL,
        .moves = {MOVE_ROCK_BLAST, MOVE_HYDRO_PUMP, MOVE_EARTHQUAKE, MOVE_SPIKE_CANNON}
    },  
    {
        .iv = 150,
        .lvl = 42,
        ...
        .heldItem = ITEM_CHOICE_SCARF,
        .moves = {MOVE_WAVE_CRASH, MOVE_HEAD_SMASH, MOVE_EARTHQUAKE, MOVE_AQUA_JET}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    {.iv = 0,
     .lvl = 43,
     .species = SPECIES_IRONWAVES,
     .moves = {MOVE_BOOMBURST, MOVE_BRICK_BREAK, MOVE_ICE_PUNCH, MOVE_CLANGING_SCALES}},
    {.iv = 0,
     .lvl = 43,
     .species = SPECIES_KINGAMBIT,
     .moves = {MOVE_IRON_HEAD, MOVE_SUCKER_PUNCH, MOVE_PROTECT, MOVE_NIGHT_SLASH}},
    {.iv = 0,
     .lvl = 43,
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    {.iv = 50,
     ...
     .moves = {MOVE_DIG, MOVE_SHADOW_PUNCH, MOVE_SAND_ATTACK, MOVE_NONE}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Austina[] = {
    {.iv = 100,
     ...
     .moves = {MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_U_TURN, MOVE_TOXIC}},
    {.iv = 100,
     .lvl = 55,
    ...
    {.iv = 100,
     ...
     .moves = {MOVE_ICE_PUNCH, MOVE_DRAIN_PUNCH, MOVE_CLANGOROUS_SOUL, MOVE_STEALTH_ROCK}},
    {.iv = 100,
     .lvl = 55,
     .species = SPECIES_GRIMMSNARL,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_SPIRIT_BREAK, MOVE_DARKEST_LARIAT, MOVE_BODY_PRESS, MOVE_BULK_UP}},
    {.iv = 100,
     .lvl = 55,
    ...
    {.iv = 100,
     ...
     .moves = {MOVE_DRACO_METEOR, MOVE_HYPER_VOICE, MOVE_HEAL_BELL, MOVE_ROOST}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    {.iv = 255,
     ...
     .moves = {MOVE_QUICK_ATTACK, MOVE_ME_FIRST, MOVE_LAST_RESORT, MOVE_NONE}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_TEETER_DANCE, MOVE_DIZZY_PUNCH, MOVE_FOCUS_PUNCH, MOVE_SUPERPOWER}},
    {.iv = 255,
     .lvl = 23,
     .species = SPECIES_STANTLER,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_CONFUSE_RAY, MOVE_PSYBEAM, MOVE_SIGNAL_BEAM, MOVE_BODY_SLAM}},
    {.iv = 255,
     .lvl = 23,
     .species = SPECIES_PORYGON,
     .heldItem = ITEM_EVIOLITE,
     .moves = {MOVE_TRI_ATTACK, MOVE_SIGNAL_BEAM, MOVE_THUNDER_WAVE, MOVE_NONE}},
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_SLACK_OFF, MOVE_COUNTER, MOVE_SHADOW_CLAW, MOVE_NONE}},
    {.iv = 255,
     .lvl = 23,
     .species = SPECIES_SNORLAX,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_BODY_SLAM, MOVE_BITE}},
    {.iv = 255,
     .lvl = 23,
     .species = SPECIES_CHANSEY,
     .heldItem = ITEM_FIGY_BERRY,
     .moves = {MOVE_SOFT_BOILED, MOVE_EGG_BOMB, MOVE_SEISMIC_TOSS, MOVE_WISH}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    {.iv = 255,
     ...
     .moves = {MOVE_FISSURE, MOVE_THUNDER, MOVE_FORESIGHT, MOVE_NONE}}};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    {.iv = 100,
     ...
     .moves = {MOVE_BITE, MOVE_DIG, MOVE_FIRST_IMPRESSION, MOVE_SAND_TOMB}},
    {.iv = 100,
     .lvl = 28,
    ...
    {.iv = 100,
     ...
     .moves = {MOVE_GIGA_DRAIN, MOVE_FEINT_ATTACK, MOVE_DOUBLE_TEAM, MOVE_LEAF_BLADE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    {.iv = 255,
     ...
     .moves = {MOVE_HYPER_FANG, MOVE_QUICK_ATTACK, MOVE_SHOCK_WAVE, MOVE_NONE}},
    {.iv = 255,
     .lvl = 23,
     .species = SPECIES_DELCATTY,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_FEINT_ATTACK, MOVE_SHOCK_WAVE, MOVE_FORESIGHT, MOVE_NONE}},
    {.iv = 255,
     .lvl = 23,
     .species = SPECIES_HERDIER,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_RETALIATE, MOVE_AERIAL_ACE, MOVE_BITE, MOVE_NONE}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    {.iv = 255,
     ...
     .heldItem = ITEM_EVIOLITE,
     .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_STOMP, MOVE_PSYBEAM}},
    {.iv = 255,
     .lvl = 24,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_EVIOLITE,
     .moves = {MOVE_COIL, MOVE_BODY_SLAM, MOVE_GLARE, MOVE_NONE}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    {.iv = 255,
     ...
     .moves = {MOVE_SKULL_BASH, MOVE_SWORDS_DANCE, MOVE_QUICK_ATTACK, MOVE_AQUA_JET}},
    {.iv = 255,
     .lvl = 22,
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    {.iv = 100,
     ...
     .heldItem = ITEM_NUGGET,
     .moves = {MOVE_HEAL_PULSE, MOVE_WISH, MOVE_ICE_BEAM, MOVE_WATER_PULSE}},
    {.iv = 100,
     .lvl = 39,
     .species = SPECIES_BRUXISH,
     .heldItem = ITEM_EXPERT_BELT,
     .moves = {MOVE_PSYCHIC_FANGS, MOVE_THUNDER_FANG, MOVE_AQUA_JET, MOVE_CRUNCH}}};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    {.iv = 100,
     .lvl = 37,
     .species = SPECIES_KINGLER,
     .moves = {MOVE_KNOCK_OFF, MOVE_CRABHAMMER, MOVE_ICY_WIND, MOVE_NONE}},
    {.iv = 100,
     .lvl = 39,
     .species = SPECIES_PRIMARINA,
     .moves = {MOVE_SCALD, MOVE_DAZZLING_GLEAM, MOVE_AQUA_JET, MOVE_HYPER_VOICE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Douglas[] = {
    {
        ...
        .species = SPECIES_TENTACRUEL,
        .heldItem = ITEM_BLACK_SLUDGE,
        .moves = {MOVE_TOXIC_SPIKES, MOVE_VENOSHOCK, MOVE_HAZE, MOVE_SURF}
    },
    {
        .iv = 10,
        .lvl = 50,
        .species = SPECIES_DEWGONG,
        .heldItem = ITEM_SITRUS_BERRY,
        .moves = {MOVE_RAIN_DANCE, MOVE_WHIRLPOOL, MOVE_PERISH_SONG, MOVE_REST}
    },
    {
        .iv = 10,
        .lvl = 50,
        ...
        .heldItem = ITEM_DAMP_ROCK,
        .moves = {MOVE_RAIN_DANCE, MOVE_TELEPORT, MOVE_SLACK_OFF, MOVE_SCALD}
    },
    {
        .iv = 10,
        .lvl = 50,
        ...
        .moves = {MOVE_POWER_UP_PUNCH, MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_BULK_UP}
    },
    {
        .iv = 10,
        .lvl = 50,
        .species = SPECIES_KABUTOPS,
        .heldItem = ITEM_CHOICE_BAND,
        .moves = {MOVE_AQUA_JET, MOVE_STONE_EDGE, MOVE_WATERFALL, MOVE_X_SCISSOR}
    },
    {
        .iv = 10,
        .lvl = 50,
        ...
        .species = SPECIES_BLASTOISE,
        .moves = {MOVE_AURA_SPHERE, MOVE_WATER_PULSE, MOVE_FLASH_CANNON, MOVE_SHELL_SMASH}
    }};
...
static const struct TrainerMonItemCustomMoves sParty_Matthew[] = {
    {
        ...
        .heldItem = ITEM_SITRUS_BERRY,
        .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_PSYCHIC, MOVE_TRICK_ROOM}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .moves = {MOVE_SUNNY_DAY, MOVE_FLARE_BLITZ, MOVE_SWORDS_DANCE, MOVE_STONE_EDGE}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_LEFTOVERS,
        .moves = {MOVE_TRICK_ROOM, MOVE_FLAMETHROWER, MOVE_TELEPORT, MOVE_FUTURE_SIGHT}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_ASSAULT_VEST,
        .moves = {MOVE_POWER_UP_PUNCH, MOVE_BULLET_PUNCH, MOVE_ZEN_HEADBUTT, MOVE_FIRE_PUNCH}
    },
    {
        .iv = 0,
        .lvl = 50,
        .species = SPECIES_GIRAFARIG,
        .heldItem = ITEM_EVIOLITE,
        .moves = {MOVE_CALM_MIND, MOVE_CHARGE_BEAM, MOVE_PSYSHOCK, MOVE_DAZZLING_GLEAM}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .moves = {MOVE_BULLET_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ZEN_HEADBUTT, MOVE_HIGH_JUMP_KICK}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_David[] = {
    {
        ...
        .moves = {MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_TAILWIND}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .moves = {MOVE_GIGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_STRENGTH_SAP, MOVE_U_TURN}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_EVIOLITE,
        .moves = {MOVE_EARTHQUAKE, MOVE_ROOST, MOVE_SWORDS_DANCE, MOVE_TOXIC}
    },
    {
        .iv = 200,
        .lvl = 50,
        ...
        .moves = {MOVE_DESTINY_BOND, MOVE_POWER_UP_PUNCH, MOVE_RAPID_SPIN, MOVE_AERIAL_ACE}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_LEFTOVERS,
        .moves = {MOVE_ICE_BEAM, MOVE_SCALD, MOVE_HURRICANE, MOVE_ROOST}
    },
    {
        .iv = 0,
        .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Dean[] = {
    {
        ...
        .heldItem = ITEM_SITRUS_BERRY,
        .moves = {MOVE_KNOCK_OFF, MOVE_BRAVE_BIRD, MOVE_ROOST, MOVE_U_TURN}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_EXPERT_BELT,
        .moves = {MOVE_SUCKER_PUNCH, MOVE_POISON_JAB, MOVE_FLAMETHROWER, MOVE_PLAY_ROUGH}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .moves = {MOVE_NASTY_PLOT, MOVE_OVERHEAT, MOVE_SLUDGE_BOMB, MOVE_FLAME_CHARGE}
    },
    {
        .iv = 100,
        .lvl = 50,
        .species = SPECIES_SABLEYE,
        .heldItem = ITEM_LEFTOVERS,
        .moves = {MOVE_CALM_MIND, MOVE_RECOVER, MOVE_WILL_O_WISP, MOVE_HEX}
    },
    {
        .iv = 0,
        .lvl = 50,
    ...
    },
    {
        ...
        .species = SPECIES_SHARPEDO,
        .heldItem = ITEM_SHARPEDONITE,
        .moves = {MOVE_CRUNCH, MOVE_AQUA_JET, MOVE_POISON_JAB, MOVE_PSYCHIC_FANGS}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Jack[] = {
    {
        ...
        .moves = {MOVE_DRAGON_DANCE, MOVE_STONE_EDGE, MOVE_FIRE_PUNCH, MOVE_CRUNCH}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .moves = {MOVE_STEALTH_ROCK, MOVE_DISCHARGE, MOVE_VOLT_SWITCH, MOVE_FLASH_CANNON}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_LEFTOVERS,
        .moves = {MOVE_SEED_BOMB, MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_ROCK_POLISH}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_POWER_HERB,
        .moves = {MOVE_ENDEAVOR, MOVE_SKY_ATTACK, MOVE_U_TURN, MOVE_ACROBATICS}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_TOXIC, MOVE_HEAD_SMASH}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .moves = {MOVE_SHELL_SMASH, MOVE_COUNTER, MOVE_EARTHQUAKE, MOVE_STONE_EDGE}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    {.iv = 100,
     ...
     .moves = {MOVE_SHOCK_WAVE, MOVE_NIGHT_SHADE, MOVE_NONE, MOVE_NONE}},
    {.iv = 100,
     .lvl = 17,
     .species = SPECIES_FLAAFFY,
     .moves = {MOVE_CHARGE, MOVE_SHOCK_WAVE, MOVE_TACKLE, MOVE_THUNDER_PUNCH}}};
...
static const struct TrainerMonNoItemCustomMoves sParty_Shawn[] = {
    {
        ...
        .moves = {MOVE_ELECTRIC_TERRAIN, MOVE_SHOCK_WAVE, MOVE_METEOR_MASH, MOVE_QUICK_ATTACK}
    },
    {
        .iv = 100,
        .lvl = 17,
        .species = SPECIES_MIMIKYU,
        .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_SNEAK, MOVE_SCRATCH, MOVE_BABY_DOLL_EYES}
    }};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    {.iv = 0,
     ...
     .moves = {MOVE_MEGA_DRAIN, MOVE_SILVER_WIND, MOVE_DRAINING_KISS, MOVE_GUST}},
    {.iv = 0,
     .lvl = 21,
     .species = SPECIES_FLABEBE_ORANGE_FLOWER,
     .moves = {MOVE_FAIRY_WIND, MOVE_MAGICAL_LEAF, MOVE_WEATHER_BALL, MOVE_NATURE_POWER}}};
...
static const struct TrainerMonItemCustomMoves sParty_Preston[] = {
    {
        ...
        .heldItem = ITEM_EVIOLITE,
        .moves = {MOVE_DARK_PULSE, MOVE_PSYSHOCK, MOVE_TRICK_ROOM, MOVE_FAKE_TEARS}
    },
    {
        .iv = 100,
        .lvl = 36,
        ...
        .moves = {MOVE_GIGA_DRAIN, MOVE_PSYCHIC, MOVE_HIDDEN_POWER, MOVE_LEECH_SEED}
    },
    {
        .iv = 100,
        .lvl = 36,
        ...
        .heldItem = ITEM_EXPERT_BELT,
        .moves = {MOVE_STRUGGLE_BUG, MOVE_PSYCHIC, MOVE_BUG_BUZZ, MOVE_CALM_MIND}
    }};
...
static const struct TrainerMonItemCustomMoves sParty_Maura[] = {
    {
        ...
        .moves = {MOVE_PSYSHOCK, MOVE_FOCUS_BLAST, MOVE_CHARGE_BEAM, MOVE_TRICK}
    },
    {
        .iv = 100,
        .lvl = 36,
        ...
        .moves = {MOVE_DAZZLING_GLEAM, MOVE_SNORE, MOVE_SYNCHRONOISE, MOVE_MOONLIGHT}
    }};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    {.iv = 250,
     ...
     .species = SPECIES_MIGHTYENA,
     .heldItem = ITEM_EXPERT_BELT,
     .moves = {MOVE_ROAR, MOVE_SHADOW_CLAW, MOVE_PLAY_ROUGH, MOVE_CRUNCH}},
    {.iv = 250,
     .lvl = 48,
     .species = SPECIES_SHIFTRY,
     .heldItem = ITEM_POWER_HERB,
     .moves = {MOVE_SOLAR_BEAM, MOVE_GIGA_DRAIN, MOVE_SUNNY_DAY, MOVE_EXTRASENSORY}},
    {.iv = 250,
     .lvl = 48,
     .species = SPECIES_HOUNDOOM,
     .heldItem = ITEM_LIFE_ORB,
     .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_SLUDGE_BOMB, MOVE_ICE_FANG}},
    {.iv = 250,
     .lvl = 48,
     .species = SPECIES_VENOMFEAR,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_POISON_JAB, MOVE_KNOCK_OFF, MOVE_LEECH_LIFE, MOVE_SUCKER_PUNCH}},
    {.iv = 255,
     .lvl = 48,
     .species = SPECIES_IRONJUGULIS,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_AIR_SLASH, MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB}},
    {.iv = 255,
     .lvl = 49,
     .species = SPECIES_ABSOL,
     .heldItem = ITEM_ABSOLITE,
     .moves = {MOVE_KNOCK_OFF, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_PLAY_ROUGH}}};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    {.iv = 250,
     ...
     .moves = {MOVE_SHADOW_BALL, MOVE_CALM_MIND, MOVE_TRICK_ROOM, MOVE_DARK_PULSE}},
    {.iv = 250,
     .lvl = 48,
     .species = SPECIES_DUSKNOIR,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_SHADOW_PUNCH, MOVE_SUCKER_PUNCH, MOVE_DRAIN_PUNCH, MOVE_POISON_JAB}},
    {.iv = 250,
     .lvl = 49,
     .species = SPECIES_BANETTE,
     .heldItem = ITEM_BANETTITE,
     .moves = {MOVE_SHADOW_SNEAK, MOVE_BULK_UP, MOVE_WILL_O_WISP, MOVE_ME_FIRST}},
    {.iv = 250,
     .lvl = 49,
     .species = SPECIES_GENGAR,
     .heldItem = ITEM_LIFE_ORB,
    ...
    {.iv = 255,
     ...
     .heldItem = ITEM_ASSAULT_VEST,
     .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_DAZZLING_GLEAM}},
    {.iv = 255,
     .lvl = 51,
     .species = SPECIES_FLUTTERMANE,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_SHADOW_BALL, MOVE_MOONBLAST, MOVE_ICY_WIND, MOVE_NASTY_PLOT}},
};

static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    {.iv = 250,
     .lvl = 50,
     .species = SPECIES_CUBEPUNCH,
     .heldItem = ITEM_CHOPLE_BERRY,
     .moves = {MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE, MOVE_HAIL}},
    {.iv = 250,
     .lvl = 50,
    ...
    {.iv = 250,
     .lvl = 52,
     .species = SPECIES_BRYNXESS,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_PSYSHOCK, MOVE_FOCUS_BLAST, MOVE_HYPER_VOICE, MOVE_BLIZZARD}},
    {.iv = 250,
     .lvl = 52,
     .species = SPECIES_IRONBUNDLE,
     .heldItem = ITEM_EXPERT_BELT,
     .moves = {MOVE_THUNDERBOLT, MOVE_ELECTRIC_TERRAIN, MOVE_HYDRO_PUMP, MOVE_BLIZZARD}},
    {.iv = 250,
     .lvl = 52,
     .species = SPECIES_GLALIE,
     .heldItem = ITEM_GLALITITE,
     .moves = {MOVE_CRUNCH, MOVE_EXPLOSION, MOVE_DOUBLE_EDGE, MOVE_THUNDER_FANG}},
    {.iv = 255,
     .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    {.iv = 250,
     .lvl = 52,
     .species = SPECIES_ABYSSCLAW,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_NIGHT_SLASH, MOVE_CLOSE_COMBAT, MOVE_POISON_FANG, MOVE_DRAGON_DANCE}},
    {.iv = 250,
     .lvl = 54,
     .species = SPECIES_ARCHALUDON,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_DRACO_METEOR, MOVE_FLASH_CANNON, MOVE_BODY_PRESS, MOVE_IRON_DEFENSE}},
    {.iv = 250,
     .lvl = 53,
     .species = SPECIES_KINGDRA,
     .heldItem = ITEM_SCOPE_LENS,
     .moves = {MOVE_DRACO_METEOR, MOVE_DRAGON_CLAW, MOVE_SURF, MOVE_FOCUS_ENERGY}},
    {.iv = 250,
     .lvl = 53,
    ...
    {.iv = 250,
     ...
     .moves = {MOVE_BOOMBURST, MOVE_DRAIN_PUNCH, MOVE_DRAGON_CLAW, MOVE_BULLET_PUNCH}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_SALAMENCE,
     .heldItem = ITEM_SALAMENCITE,
     .moves = {MOVE_DOUBLE_EDGE, MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE, MOVE_CRUNCH}}};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    {.iv = 0,
        ...
        .heldItem = ITEM_NONE,
        .moves = {MOVE_SUNNY_DAY, MOVE_BULLET_SEED, MOVE_ANCIENT_POWER, MOVE_NONE}},
    {.iv = 0,
        .lvl = 9,
        .species = SPECIES_ANORITH,
        .heldItem = ITEM_NONE,
        .moves = {MOVE_SCRATCH, MOVE_DEFENSE_CURL, MOVE_FURY_CUTTER, MOVE_STEALTH_ROCK}},
    {.iv = 50,
        .lvl = 14,
    ...
    {.iv = 0,
        .lvl = 10,
        .species = SPECIES_IRONGATE,
        .heldItem = ITEM_RED_CARD,
        .moves = {MOVE_ROCK_TOMB, MOVE_CHARGE_BEAM, MOVE_MIRROR_MOVE, MOVE_NONE}},
    {.iv = 0,
        .lvl = 11,
        .species = SPECIES_SPIKEDASH,
        .heldItem = ITEM_CHESTO_BERRY,
        .moves = {MOVE_QUICK_ATTACK, MOVE_ROCK_SMASH, MOVE_TAIL_WHIP, MOVE_ROCK_TOMB}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    {.iv = 50,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_MACH_PUNCH, MOVE_THIEF, MOVE_THUNDER_PUNCH, MOVE_BULK_UP}},
    {.iv = 0,
     .lvl = 17,
     .species = SPECIES_IRONHANDS,
     .heldItem = ITEM_PECHA_BERRY,
     .moves = {MOVE_FORCE_PALM, MOVE_ROCK_TOMB, MOVE_FAKE_OUT, MOVE_NONE}},
    {.iv = 50,
     .lvl = 18,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    {.iv = 100,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SHOCK_WAVE, MOVE_SWIFT, MOVE_GRASS_KNOT, MOVE_HELPING_HAND}},
    {.iv = 100,
     .lvl = 20,
     .species = SPECIES_MINUN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SHOCK_WAVE, MOVE_PROTECT, MOVE_FAKE_TEARS, MOVE_THUNDER_WAVE}},
    {.iv = 100,
     .lvl = 20,
     .species = SPECIES_BARKJAM,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_SHOCK_WAVE, MOVE_DRUM_BEATING, MOVE_NOBLE_ROAR, MOVE_BELCH}},
    {.iv = 100,
     .lvl = 22,
     .species = SPECIES_IRONHUT,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_SLUDGE, MOVE_SHOCK_WAVE, MOVE_MEGA_DRAIN, MOVE_SPORE}},
    {.iv = 250,
     .lvl = 24,
     .species = SPECIES_MANECTRIC,
     .heldItem = ITEM_SHUCA_BERRY,
     .moves = {MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_BITE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    {.iv = 150,
     ...
     .species = SPECIES_NINETALES,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_OVERHEAT, MOVE_HYPNOSIS, MOVE_GRUDGE, MOVE_FIRE_SPIN}},
    {.iv = 150,
     .lvl = 24,
     .species = SPECIES_COMBUSKEN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_FIRE_PUNCH, MOVE_AERIAL_ACE, MOVE_BRICK_BREAK, MOVE_SWORDS_DANCE}},
    {.iv = 150,
     .lvl = 26,
     .species = SPECIES_IRONSABER,
     .heldItem = ITEM_SHUCA_BERRY,
     .moves = {MOVE_CUT, MOVE_SLASH, MOVE_FIRE_LASH, MOVE_SHADOW_SNEAK}},
    {.iv = 150,
     .lvl = 26,
     .species = SPECIES_TERRORKING,
     .heldItem = ITEM_CHARCOAL,
     .moves = {MOVE_OVERHEAT, MOVE_ANCIENT_POWER, MOVE_BITE, MOVE_DRAGON_CLAW}},
    {.iv = 250,
     .lvl = 29,
     .species = SPECIES_TORKOAL,
     .heldItem = ITEM_WHITE_HERB,
     .moves = {MOVE_OVERHEAT, MOVE_SOLAR_BEAM, MOVE_BODY_SLAM, MOVE_YAWN}}};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    {.iv = 200,
     ...
     .moves = {MOVE_FACADE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_SLACK_OFF}},
    {.iv = 200,
     .lvl = 27,
     .species = SPECIES_SMEARGLE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SPORE, MOVE_SKILL_SWAP, MOVE_FOLLOW_ME, MOVE_NIGHT_SHADE}},
    {.iv = 150,
     .lvl = 27,
     .species = SPECIES_PLEASODOR,
     .heldItem = ITEM_LIECHI_BERRY,
     .moves = {MOVE_COVET, MOVE_BODY_SLAM, MOVE_STUFF_CHEEKS, MOVE_SNORE}},
    {.iv = 200,
     .lvl = 28,
     .species = SPECIES_LINOONE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_EXTREME_SPEED, MOVE_BELLY_DRUM, MOVE_SHADOW_CLAW, MOVE_PROTECT}},
    {.iv = 150,
     .lvl = 28,
     .species = SPECIES_KANGASKHAN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_BODY_SLAM, MOVE_BRICK_BREAK, MOVE_DETECT, MOVE_FAKE_OUT}},
    {.iv = 200,
     .lvl = 31,
     .species = SPECIES_IRONBLOON,
     .heldItem = ITEM_ORAN_BERRY,
     .moves = {MOVE_HYPER_VOICE, MOVE_AIR_CUTTER, MOVE_FLASH, MOVE_PROTECT}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    {.iv = 220,
     ...
     .species = SPECIES_SKARMORY,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SPIKES, MOVE_TAILWIND, MOVE_STEEL_WING, MOVE_WHIRLWIND}},
    {.iv = 210,
    .lvl = 29,
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_YACHE_BERRY,
    .moves = {MOVE_GIGA_DRAIN, MOVE_EARTHQUAKE, MOVE_AERIAL_ACE, MOVE_SYNTHESIS}},
    {.iv = 210,
     .lvl = 29,
     .species = SPECIES_GLIDEBURN,
     .heldItem = ITEM_CHARTI_BERRY,
     .moves = {MOVE_FIRE_LASH, MOVE_AERIAL_ACE, MOVE_FAKE_OUT, MOVE_DISABLE}},
    {.iv = 210,
     .lvl = 30,
     .species = SPECIES_GLIGAR,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_EARTHQUAKE, MOVE_TOXIC, MOVE_U_TURN, MOVE_ROOST}},
    {.iv = 255,
     .lvl = 32,
     .species = SPECIES_IRONWINGS,
     .heldItem = ITEM_SCOPE_LENS,
     .moves = {MOVE_STEEL_WING, MOVE_DUAL_WINGBEAT, MOVE_RAZOR_LEAF, MOVE_DRAGON_DANCE}},
    {.iv = 255,
     .lvl = 33,
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_ICE_BEAM, MOVE_FLAMETHROWER, MOVE_DRAGON_CLAW, MOVE_HURRICANE}}};

static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    {.iv = 250,
     .lvl = 40,
     .species = SPECIES_IRONKNEEL,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_DOUBLE_IRON_BASH, MOVE_METAL_BURST, MOVE_PSYSHIELD_BASH, MOVE_PROTECT}},
    {.iv = 250,
     .lvl = 40,
     .species = SPECIES_NOKAY,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_EARTHQUAKE, MOVE_DRAIN_PUNCH, MOVE_PAYBACK, MOVE_OBSTRUCT}},
    {.iv = 250,
     .lvl = 41,
     .species = SPECIES_LUNATONE,
     .heldItem = ITEM_ECLIMINARINITE,
     .moves = {MOVE_ICE_BEAM, MOVE_POWER_GEM, MOVE_HYPNOSIS, MOVE_CALM_MIND}},
    {.iv = 250,
     .lvl = 41,
     .species = SPECIES_SOLROCK,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_SUNNY_DAY, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_FLAMETHROWER}},
    {.iv = 250,
     .lvl = 44,
     .species = SPECIES_MAGICOAT,
     .heldItem = ITEM_PETAYA_BERRY,
     .moves = {MOVE_PSYCHIC, MOVE_EARTH_POWER, MOVE_THUNDERBOLT, MOVE_SOLAR_BEAM}},
    {.iv = 250,
     .lvl = 44,
     .species = SPECIES_MAGICORN,
     .heldItem = ITEM_LIECHI_BERRY,
     .moves = {MOVE_ROCK_SLIDE, MOVE_PSYCHO_CUT, MOVE_LEAF_BLADE, MOVE_BRICK_BREAK}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    {.iv = 200,
     ...
     .species = SPECIES_POLITOED,
     .heldItem = ITEM_DAMP_ROCK,
     .moves = {MOVE_WEATHER_BALL, MOVE_ICY_WIND, MOVE_PERISH_SONG, MOVE_PARTING_SHOT}},
     {.iv = 200,
      .lvl = 43,
      .species = SPECIES_GOREBYSS,
      .heldItem = ITEM_DEEP_SEA_SCALE,
      .moves = {MOVE_MUDDY_WATER, MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_RAIN_DANCE}},
    {.iv = 200,
     .lvl = 41,
     .species = SPECIES_SWAMPERT,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_WIDE_GUARD, MOVE_WATERFALL, MOVE_ROCK_SLIDE, MOVE_HIGH_HORSEPOWER}},
    {.iv = 200,
     .lvl = 43,
     .species = SPECIES_IRONPUMP,
     .heldItem = ITEM_QUICK_CLAW,
     .moves = {MOVE_OCTAZOOKA, MOVE_SLUDGE_BOMB, MOVE_FIRE_SPIN, MOVE_TAR_SHOT}},
    {.iv = 250,
     .lvl = 46,
     .species = SPECIES_KINGDRA,
     .heldItem = ITEM_CUSTOMITE,
     .moves = {MOVE_WATERFALL, MOVE_DRACO_METEOR, MOVE_ICE_BEAM, MOVE_DRAGON_CLAW}},
    {.iv = 250,
     .lvl = 46,
     .species = SPECIES_SWIRLHEAD,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_MUDDY_WATER, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_TOXIC}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Vicky[] = {
    {.iv = 0,
     ...
     .moves = {MOVE_NIGHT_SHADE, MOVE_CONFUSION, MOVE_WILL_O_WISP, MOVE_DETECT}}};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    {.iv = 150,
     ...
     .moves = {MOVE_WATER_GUN, MOVE_SHOCK_WAVE, MOVE_AURORA_BEAM, MOVE_THUNDER_WAVE}}};

static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    {.iv = 100,
     .lvl = 43,
     .species = SPECIES_SLAKING,
     .moves = {MOVE_ATTRACT, MOVE_ROCK_SLIDE, MOVE_GIGA_IMPACT, MOVE_SHADOW_CLAW}},
    {.iv = 100,
     .lvl = 43,
     .species = SPECIES_DUSCLOPS,
     .moves = {MOVE_SKILL_SWAP, MOVE_PROTECT, MOVE_WILL_O_WISP, MOVE_NIGHT_SHADE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    {.iv = 255,
     ...
     .species = SPECIES_PELIPPER,
     .heldItem = ITEM_DAMP_ROCK,
     .moves = {MOVE_SCALD, MOVE_HURRICANE, MOVE_U_TURN, MOVE_DETECT}},
    {.iv = 255,
     .lvl = 56,
     .species = SPECIES_LUDICOLO,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_GIGA_DRAIN, MOVE_MUDDY_WATER, MOVE_ICE_BEAM, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_FLOATINHUNT,
     .heldItem = ITEM_SCOPE_LENS,
     .moves = {MOVE_BREAKING_SWIPE, MOVE_TRIPLE_DIVE, MOVE_DRACO_METEOR, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 56,
     .species = SPECIES_HUNTAIL,
     .heldItem = ITEM_DEEP_SEA_TOOTH,
     .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_SUCKER_PUNCH, MOVE_SHELL_SMASH}},
    {.iv = 255,
     .lvl = 58,
     .species = SPECIES_IRONFAN,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_RECOVER, MOVE_MUDDY_WATER, MOVE_ICE_BEAM, MOVE_HURRICANE}},
    {.iv = 255,
     .lvl = 56,
     .species = SPECIES_SWAMPERT,
...
static const struct TrainerMonItemCustomMoves sParty_Pablo1[] = {
    {.iv = 0,
     ...
     .heldItem = ITEM_CUSTOMITE,
     .moves = {MOVE_EARTH_POWER, MOVE_STRUGGLE_BUG, MOVE_VENOSHOCK, MOVE_QUIVER_DANCE}},
    {.iv = 0,
     .lvl = 45,
     .species = SPECIES_ORICORIO_SENSU,
     .moves = {MOVE_REVELATION_DANCE, MOVE_AIR_CUTTER, MOVE_ICY_WIND, MOVE_QUIVER_DANCE}
    }};
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    {.iv = 0,
     ...
     .species = SPECIES_CLAYDOL,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_TRICK_ROOM, MOVE_ROCK_SLIDE}},
    {.iv = 0,
     .lvl = 43,
     .species = SPECIES_DHELMISE,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_POWER_WHIP, MOVE_EARTHQUAKE, MOVE_PHANTOM_FORCE, MOVE_ANCHOR_SHOT}},
    {.iv = 0,
     .lvl = 43,
     .species = SPECIES_VANILLUXE,
     .heldItem = ITEM_CUSTOMITE,
     .moves = {MOVE_FUSION_FLARE, MOVE_PROTECT, MOVE_FREEZE_DRY, MOVE_BLIZZARD}}};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    {.iv = 0,
     ...
     .moves = {MOVE_DOUBLE_KICK, MOVE_HORN_ATTACK, MOVE_DIG, MOVE_POISON_STING}},
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Angelica[] = {
    {.iv = 50,
     .lvl = 30,
     .species = SPECIES_CASTFORM,
     .moves = {MOVE_POWDER_SNOW, MOVE_WEATHER_BALL, MOVE_THUNDER, MOVE_WATER_PULSE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Beverly[] = {
    {.iv = 0,
     ...
     .species = SPECIES_TORKOAL,
     .heldItem = ITEM_EXPERT_BELT,
     .moves = {MOVE_WEATHER_BALL, MOVE_EARTHQUAKE, MOVE_SOLAR_BEAM, MOVE_STEALTH_ROCK}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_CHANDELURE,
     .heldItem = ITEM_EJECT_PACK,
     .moves = {MOVE_SHADOW_BALL, MOVE_OVERHEAT, MOVE_ENERGY_BALL, MOVE_CLEAR_SMOG}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_CHARIZARD,
     .heldItem = ITEM_CHARIZARDITE_Y,
     .moves = {MOVE_SOLAR_BEAM, MOVE_FLAMETHROWER, MOVE_AIR_SLASH, MOVE_TAILWIND}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_LURANTIS,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_SOLAR_BLADE, MOVE_SUPERPOWER, MOVE_KNOCK_OFF, MOVE_SYNTHESIS}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_BRELOOM,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_MACH_PUNCH, MOVE_ROCK_TOMB, MOVE_THUNDER_PUNCH, MOVE_SPORE}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_SHIFTRY,
     .heldItem = ITEM_LIFE_ORB,
     .moves = {MOVE_SOLAR_BEAM, MOVE_DARK_PULSE, MOVE_HEAT_WAVE, MOVE_NASTY_PLOT}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Tara[] = {
    {
        ...
        .heldItem = ITEM_ROCKY_HELMET,
        .species = SPECIES_CLAYDOL,
        .moves = {MOVE_STEALTH_ROCK, MOVE_TRICK_ROOM, MOVE_PSYCHIC, MOVE_EXPLOSION}
    },
    {
        .iv = 0,
        .lvl = 50,
        .species = SPECIES_TORTERRA,
        .heldItem = ITEM_LIFE_ORB,
        .moves = {MOVE_WOOD_HAMMER, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_ROAR}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_WEAKNESS_POLICY,
        .moves = {MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_MEGAHORN, MOVE_SUBSTITUTE}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_LEFTOVERS,
        .moves = {MOVE_SCALD, MOVE_CLEAR_SMOG, MOVE_ICE_BEAM, MOVE_TOXIC}
    },
    {
        .iv = 0,
        .lvl = 50,
        .species = SPECIES_CAMERUPT,
        .heldItem = ITEM_CHOICE_SPECS,
        .moves = {MOVE_ERUPTION, MOVE_EARTH_POWER, MOVE_OVERHEAT, MOVE_FLASH_CANNON}
    },
    {
        .iv = 0,
        .lvl = 50,
        .heldItem = ITEM_STEELIXITE,
        .species = SPECIES_STEELIX,
        .moves = {MOVE_IRON_TAIL, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_SANDSTORM}
    }};
...
static const struct TrainerMonItemCustomMoves sParty_Alice[] = {
    {.iv = 0,
     ...
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_TRICK_ROOM, MOVE_CALM_MIND, MOVE_BATON_PASS, MOVE_DAZZLING_GLEAM}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_BEWEAR,
     .heldItem = ITEM_ASSAULT_VEST,
     .moves = {MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_ZEN_HEADBUTT, MOVE_DARKEST_LARIAT}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_OBSTAGOON,
     .heldItem = ITEM_FLAME_ORB,
     .moves = {MOVE_OBSTRUCT, MOVE_ICE_PUNCH, MOVE_KNOCK_OFF, MOVE_PARTING_SHOT}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_TOXTRICITY,
     .heldItem = ITEM_THROAT_SPRAY,
     .moves = {MOVE_BOOMBURST, MOVE_OVERDRIVE, MOVE_POISON_JAB, MOVE_SHIFT_GEAR}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_VIKAVOLT,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_ENERGY_BALL, MOVE_VOLT_SWITCH, MOVE_STICKY_WEB, MOVE_ROOST}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_AMPHAROS,
     .heldItem = ITEM_AMPHAROSITE,
     .moves = {MOVE_VOLT_SWITCH, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_FOCUS_BLAST}}};
...
static const struct TrainerMonItemCustomMoves sParty_Tanya[] = {
    {.iv = 0,
     ...
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_TOXIC_SPIKES, MOVE_SPIKES, MOVE_AQUA_JET, MOVE_LIQUIDATION}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_ROSERADE,
     .heldItem = ITEM_SALAC_BERRY,
     .moves = {MOVE_VENOSHOCK, MOVE_GIGA_DRAIN, MOVE_DAZZLING_GLEAM, MOVE_ENDURE}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_DRAGALGE,
     .heldItem = ITEM_CHOICE_SPECS,
     .moves = {MOVE_DRACO_METEOR, MOVE_VENOSHOCK, MOVE_FOCUS_BLAST, MOVE_HYDRO_PUMP}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_DUSTOX,
     .heldItem = ITEM_HEAVY_DUTY_BOOTS,
     .moves = {MOVE_MOONLIGHT, MOVE_VENOSHOCK, MOVE_LIGHT_SCREEN, MOVE_WHIRLWIND}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_MASQUERAIN,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_QUIVER_DANCE, MOVE_STICKY_WEB}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_SCIZOR,
     .heldItem = ITEM_SCIZORITE,
     .moves = {MOVE_BUG_BITE, MOVE_BULLET_PUNCH, MOVE_U_TURN, MOVE_SWORDS_DANCE}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Susie[] = {
    {.iv = 0,
     ...
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_TRICK_ROOM, MOVE_WONDER_ROOM, MOVE_WILL_O_WISP, MOVE_SHADOW_BALL}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_MARSHADOW,
     .heldItem = ITEM_LIFE_ORB,
     .moves = {MOVE_SPECTRAL_THIEF, MOVE_DRAIN_PUNCH, MOVE_SHADOW_SNEAK, MOVE_ROCK_TOMB}},
    {.iv = 0,
     .lvl = 50,
    ...
    {.iv = 0,
     ...
     .heldItem = ITEM_CHOICE_BAND,
     .moves = {MOVE_GUNK_SHOT, MOVE_X_SCISSOR, MOVE_BULLET_PUNCH, MOVE_SUCKER_PUNCH}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_EMBOAR,
     .heldItem = ITEM_ASSAULT_VEST,
     .moves = {MOVE_FLARE_BLITZ, MOVE_FLAME_CHARGE, MOVE_WILD_CHARGE, MOVE_POWER_UP_PUNCH}},
    {.iv = 0,
     .lvl = 50,
     .species = SPECIES_GALLADE,
     .heldItem = ITEM_GALLADITE,
     .moves = {MOVE_SWORDS_DANCE, MOVE_KNOCK_OFF, MOVE_CLOSE_COMBAT, MOVE_ICE_PUNCH}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Sienna[] = {
    {
        ...
        .moves = {MOVE_REVELATION_DANCE, MOVE_AIR_SLASH, MOVE_FEATHER_DANCE, MOVE_QUIVER_DANCE}
    },
    {
        .iv = 0,
        .lvl = 45,
        ...
        .heldItem = ITEM_CUSTOMITE,
        .moves = {MOVE_REVELATION_DANCE, MOVE_GIGA_DRAIN, MOVE_COTTON_GUARD, MOVE_PETAL_BLIZZARD}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Linda[] = {
    {
        ...
        .moves = {MOVE_BLIZZARD, MOVE_WOOD_HAMMER, MOVE_AURORA_VEIL, MOVE_BULLDOZE}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_LIFE_ORB,
        .moves = {MOVE_BLIZZARD, MOVE_SHADOW_BALL, MOVE_DRAINING_KISS, MOVE_ICE_SHARD}
    },
    {
        .iv = 0,
        .lvl = 50,
    ...
    },
    {
        ...
        .heldItem = ITEM_ASSAULT_VEST,
        .moves = {MOVE_EARTHQUAKE, MOVE_ICICLE_CRASH, MOVE_KNOCK_OFF, MOVE_ROCK_SLIDE}
    },
    {
        .iv = 0,
        .lvl = 50,
    ...
    },
    {
        ...
        .heldItem = ITEM_HEAVY_DUTY_BOOTS,
        .moves = {MOVE_KNOCK_OFF, MOVE_FREEZE_DRY, MOVE_RAPID_SPIN, MOVE_AURORA_VEIL}
    }};
...
static const struct TrainerMonNoItemCustomMoves sParty_Carlee[] = {
    {
        .iv = 0,
        .lvl = 35,
        .species = SPECIES_MILTANK,
        .moves = {MOVE_MILK_DRINK, MOVE_STOMP, MOVE_SURF, MOVE_NONE}
    },
    {
        .iv = 0,
        .lvl = 35,
        .species = SPECIES_NIDOQUEEN,
        .moves = {MOVE_BULLDOZE, MOVE_POISON_JAB, MOVE_SURF, MOVE_ICE_BEAM}
    },
    {
        .iv = 0,
        .lvl = 35,
        .species = SPECIES_HARIYAMA,
        .moves = {MOVE_SURF, MOVE_FAKE_OUT, MOVE_BRICK_BREAK, MOVE_NONE}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Heidi[] = {
    {.iv = 0,
     ...
     .moves = {MOVE_DIG, MOVE_SAND_ATTACK, MOVE_RAZOR_LEAF, MOVE_JUMP_KICK}},
    {.iv = 0,
     .lvl = 22,
     .species = SPECIES_BALTOY,
     .moves = {MOVE_RAPID_SPIN, MOVE_MUD_SLAP, MOVE_PSYBEAM, MOVE_ROCK_TOMB}}};
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    {.iv = 0,
     ...
     .moves = {MOVE_SAND_ATTACK, MOVE_DIG, MOVE_SLASH, MOVE_NATURE_POWER}},
    {.iv = 0,
     .lvl = 22,
     .species = SPECIES_MARILL,
     .moves = {MOVE_ROLLOUT, MOVE_BUBBLE_BEAM, MOVE_TAIL_WHIP, MOVE_SECRET_POWER}},
    {.iv = 0,
     .lvl = 22,
     .species = SPECIES_CASTFORM,
     .moves = {MOVE_WEATHER_BALL, MOVE_WATER_GUN, MOVE_POWDER_SNOW, MOVE_NONE}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Diana1[] = {
    {
        ...
        .moves = {MOVE_ROCK_TOMB, MOVE_TACKLE, MOVE_PECK, MOVE_NONE}
    }};
...
static const struct TrainerMonItemCustomMoves sParty_Annika[] = {
    {.iv = 100,
     ...
     .species = SPECIES_WISHIWASHI,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_FLAIL, MOVE_WATER_PULSE, MOVE_AQUA_TAIL, MOVE_ICE_BEAM}},
    {.iv = 100,
     .lvl = 39,
     .species = SPECIES_OCTILLERY,
     .heldItem = ITEM_ORAN_BERRY,
     .moves = {MOVE_FLASH_CANNON, MOVE_WATER_PULSE, MOVE_DARK_PULSE, MOVE_FLAMETHROWER}}};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jonas[] = {
    ...
    {.iv = 0,
     ...
     .moves = {MOVE_AQUA_JET, MOVE_FIRST_IMPRESSION, MOVE_BUG_BITE, MOVE_SWORDS_DANCE}}};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kayley[] = {
    ...
    {.iv = 0,
     .lvl = 33,
     .species = SPECIES_POLITOED,
     .moves = {MOVE_ICE_BEAM, MOVE_WEATHER_BALL, MOVE_ECHOED_VOICE, MOVE_BULLET_SEED}}};
...
static const struct TrainerMonItemCustomMoves sParty_TabithaMossdeep[] = {
        {
            ...
            .heldItem = ITEM_HEAT_ROCK,
            .species = SPECIES_NINETALES,
            .moves = {MOVE_HEAT_WAVE, MOVE_SOLAR_BEAM, MOVE_WILL_O_WISP, MOVE_EXTRASENSORY}
        },
        {
            .iv = 100,
            .lvl = 38,
            ...
            .moves = {MOVE_FLARE_BLITZ, MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_RAGING_FURY}
        },
        {
            .iv = 100,
            .lvl = 40,
            ...
            .species = SPECIES_CAMERUPT,
            .moves = {MOVE_EARTH_POWER, MOVE_FLAME_BURST, MOVE_PROTECT, MOVE_SOLAR_BEAM}
        },
    };
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    {.iv = 150,
     .lvl = 44,
     .species = SPECIES_ALTARIA,
     .moves = {MOVE_HURRICANE, MOVE_HYPER_VOICE, MOVE_DRAGON_PULSE, MOVE_ROOST}},
    {.iv = 150,
     .lvl = 43,
     .species = SPECIES_GOODRA_HISUIAN,
     .moves = {MOVE_IRON_HEAD, MOVE_DRACO_METEOR, MOVE_SURF, MOVE_RECOVER}},
    {.iv = 150,
     .lvl = 44,
     .species = SPECIES_BRUTEBONNET,
     .moves = {MOVE_SEED_BOMB, MOVE_SUCKER_PUNCH, MOVE_CLOSE_COMBAT, MOVE_SPORE}},
    {.iv = 150,
     .lvl = 41,
     .species = SPECIES_SANDYSHOCKS,
     .moves = {MOVE_EARTH_POWER, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_VOLT_SWITCH}},
    {.iv = 150,
     .lvl = 44,
     .species = SPECIES_IRONVALIANT,
     .moves = {MOVE_AURA_SPHERE, MOVE_LEAF_BLADE, MOVE_MOONBLAST, MOVE_KNOCK_OFF}},
    {.iv = 250,
     .lvl = 45,
     .species = SPECIES_GALLADE,
     .heldItem = ITEM_GALLADITE,
     .moves = {MOVE_PSYCHO_CUT, MOVE_CLOSE_COMBAT, MOVE_SHADOW_SNEAK, MOVE_SWORDS_DANCE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Mitchell[] = {
    ...
    {.iv = 0,
     ...
     .species = SPECIES_SOLROCK,
     .heldItem = ITEM_ECLIMINARINITE,
     .moves = {MOVE_ZEN_HEADBUTT, MOVE_FLARE_BLITZ, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Halle[] = {
    {
        ...
        .moves = {MOVE_DISCHARGE, MOVE_EARTHQUAKE, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH}
    },
    {
        .iv = 0,
        .lvl = 43,
        .species = SPECIES_MAGMORTAR,
        .heldItem = ITEM_WHITE_HERB,
        .moves = {MOVE_FLAME_BURST, MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_OVERHEAT}
    },
    {
        .iv = 0,
        .lvl = 43,
        .species = SPECIES_BRYNXESS,
        .heldItem = ITEM_LIFE_ORB,
        .moves = {MOVE_BOOMBURST, MOVE_SHADOW_BALL, MOVE_BLIZZARD, MOVE_PSYSHOCK}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMagmaHideout[] = {
    {
        ...
        .heldItem = ITEM_HEAT_ROCK,
        .moves = {MOVE_EARTHQUAKE, MOVE_FLAME_BURST, MOVE_ANCIENT_POWER, MOVE_SCARY_FACE}
    },
    {.iv = 150,
     .lvl = 38,
     .species = SPECIES_SHIFTRY,
     .moves = {MOVE_SOLAR_BEAM, MOVE_WEATHER_BALL, MOVE_SUCKER_PUNCH, MOVE_LEAF_BLADE}},
    {.iv = 150,
    .lvl = 39,
    .species = SPECIES_IRONPLASMA,
    .moves = {MOVE_LAVA_PLUME, MOVE_HEX, MOVE_DISCHARGE, MOVE_PAIN_SPLIT}},
    {.iv = 150,
        .lvl = 39,
        .species = SPECIES_STEAMOUNT,
        .moves = {MOVE_SCALD, MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_SHELL_SMASH}},
    {.iv = 150,
        .lvl = 39,
        .species = SPECIES_TURTONATOR,
        .heldItem = ITEM_CUSTOMITE,
        .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_PULSE, MOVE_SPIKY_SHIELD, MOVE_SHELL_TRAP}},
    {.iv = 150,
        .lvl = 39,
        .species = SPECIES_APOKARGO,
    .heldItem = ITEM_SHUCA_BERRY,
        .moves = {MOVE_FLAMETHROWER, MOVE_ROCK_SLIDE, MOVE_SOLAR_BEAM, MOVE_EARTH_POWER}},
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    {.iv = 100,
     .lvl = 22,
     .species = SPECIES_CHARMELEON,
     .moves = {MOVE_FLAMETHROWER, MOVE_SCRATCH, MOVE_HOWL, MOVE_METAL_CLAW}},
    {.iv = 100,
     .lvl = 22,
     .species = SPECIES_MONFERNO,
     .moves = {MOVE_MACH_PUNCH, MOVE_FIRE_PUNCH, MOVE_U_TURN, MOVE_THUNDER_PUNCH}},
    {.iv = 100,
     .lvl = 22,
     .species = SPECIES_PIGNITE,
     .moves = {MOVE_ARM_THRUST, MOVE_FLAME_CHARGE, MOVE_FEINT_ATTACK, MOVE_BULK_UP}},
    {.iv = 100,
     .lvl = 22,
     .species = SPECIES_TORRACAT,
     .moves = {MOVE_FLAME_CHARGE, MOVE_LEECH_LIFE, MOVE_BITE, MOVE_ACROBATICS}},
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    {.iv = 100,
     .lvl = 17,
     .species = SPECIES_VOLTORB,
     .moves = {MOVE_SWIFT, MOVE_PROTECT, MOVE_SHOCK_WAVE, MOVE_SELF_DESTRUCT}},
    {.iv = 100,
     .lvl = 17,
     .species = SPECIES_DEDENNE,
     .moves = {MOVE_SHOCK_WAVE, MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_NUZZLE}}};

static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    {.iv = 100,
     .lvl = 23,
     .species = SPECIES_BRAIXEN,
     .moves = {MOVE_FLAME_CHARGE, MOVE_SUNNY_DAY, MOVE_PSYBEAM, MOVE_MYSTICAL_FIRE}},
    {.iv = 100,
     .lvl = 23,
     .species = SPECIES_ORICORIO,
     .moves = {MOVE_REVELATION_DANCE, MOVE_AIR_CUTTER, MOVE_ACROBATICS, MOVE_FEATHER_DANCE}},
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    {.iv = 0,
     ...
     .moves = {MOVE_BITE, MOVE_POISON_GAS, MOVE_SLUDGE, MOVE_GLARE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Keigo[] = {
    ...
    {.iv = 0,
     ...
     .moves = {MOVE_FEINT, MOVE_SEISMIC_TOSS, MOVE_FURY_CUTTER, MOVE_SWORDS_DANCE}},
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Riley[] = {
    {.iv = 0,
     ...
     .moves = {MOVE_BUG_BITE, MOVE_GYRO_BALL, MOVE_SPIKES, MOVE_SELF_DESTRUCT}},
    {.iv = 0,
     .lvl = 28,
     .species = SPECIES_VOLBEAT,
     .moves = {MOVE_THUNDER, MOVE_SILVER_WIND, MOVE_THUNDER_WAVE, MOVE_TAIL_GLOW}}};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR2[] = {
    {.iv = 150,
     ...
     .species = SPECIES_DELCATTY,
     .heldItem = ITEM_SILK_SCARF,
     .moves = {MOVE_SING, MOVE_METEOR_MASH, MOVE_U_TURN, MOVE_FAKE_OUT}},
    {.iv = 150,
     .lvl = 50,
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_AERIAL_ACE, MOVE_DRAGON_CLAW, MOVE_BODY_SLAM, MOVE_DRAGON_DANCE}},
    {.iv = 150,
     .lvl = 50,
     .species = SPECIES_ROSERADE,
     .heldItem = ITEM_BLACK_SLUDGE,
     .moves = {MOVE_SLUDGE_BOMB, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_TOXIC_SPIKES}},
    {.iv = 150,
     .lvl = 50,
     .species = SPECIES_MAGNEZONE,
     .heldItem = ITEM_SHUCA_BERRY,
    ...
    {.iv = 250,
     ...
     .moves = {MOVE_HYPER_VOICE, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_FUTURE_SIGHT}}};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveTorchic[] = {
    ...
    {.iv = 150,
     ...
     .species = SPECIES_FLYGON,
     .moves = {MOVE_DRAGON_BREATH, MOVE_HYPER_VOICE, MOVE_EARTH_POWER, MOVE_FLAMETHROWER}},
    {.iv = 200,
     .lvl = 34,
     .species = SPECIES_SMASHBAG,
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveTorchic[] = {
    {
        ...
        .lvl = 31,
        .species = SPECIES_FLUTTERMANE,
        .moves = {MOVE_DAZZLING_GLEAM, MOVE_SHADOW_BALL, MOVE_ICY_WIND, MOVE_NASTY_PLOT}
    },
    {
        .iv = 150,
        .lvl = 32,
    ...
    },
    {
        ...
        .lvl = 32,
        .species = SPECIES_GREATTUSK,
        .moves = {MOVE_EARTHQUAKE, MOVE_BRICK_BREAK, MOVE_ROCK_TOMB, MOVE_STEALTH_ROCK}
    },
    {
        .iv = 150,
        .lvl = 32,
        .species = SPECIES_CLAWHILL,
        .moves = {MOVE_FIRE_PUNCH, MOVE_BRICK_BREAK, MOVE_SUNNY_DAY, MOVE_BULK_UP}
    },
    {
        .iv = 150,
        .lvl = 38,
        .heldItem = ITEM_FLYGONITE,
        .species = SPECIES_FLYGON,
        .moves = {MOVE_EARTH_POWER, MOVE_HYPER_VOICE, MOVE_DRAGON_BREATH, MOVE_FLAMETHROWER}
    },
    {
        .iv = 200,
        .lvl = 34,
        .species = SPECIES_SMASHBAG,
        .moves = {MOVE_ROCK_SLIDE, MOVE_AERIAL_ACE, MOVE_WAKE_UP_SLAP, MOVE_STRENGTH}
    }};

static const struct TrainerMonItemCustomMoves sParty_RivalLeagueMudkip[] = {
    {
        .iv = 150,
        .lvl = 45,
        .species = SPECIES_MISMAGIUS,
        .heldItem = ITEM_EXPERT_BELT,
        .moves = {MOVE_SHADOW_BALL, MOVE_DAZZLING_GLEAM, MOVE_MYSTICAL_FIRE, MOVE_THUNDERBOLT}
    },
    {
        .iv = 150,
        .lvl = 45,
        .species = SPECIES_WIGGLYTUFF,
        .heldItem = ITEM_CHESTO_BERRY,
        .moves = {MOVE_HYPER_VOICE, MOVE_MOONBLAST, MOVE_THUNDERBOLT, MOVE_REST}
    },
    {
        .iv = 150,
        .lvl = 45,
        .species = SPECIES_DONPHAN,
        .heldItem = ITEM_RED_CARD,
        .moves = {MOVE_EARTHQUAKE, MOVE_KNOCK_OFF, MOVE_ICE_SHARD, MOVE_STEALTH_ROCK}
    },
    {
        .iv = 150,
        .lvl = 45,
        .species = SPECIES_HARIYAMA,
        .heldItem = ITEM_SITRUS_BERRY,
        .moves = {MOVE_FAKE_OUT, MOVE_BELLY_DRUM, MOVE_DRAIN_PUNCH, MOVE_ROCK_SLIDE}
    },
    {
        .iv = 150,
        .lvl = 48,
    ...
    },
    {
        ...
        .species = SPECIES_DELIBIRD,
        .heldItem = ITEM_CHARTI_BERRY,
        .moves = {MOVE_ICE_SHARD, MOVE_AERIAL_ACE, MOVE_REVERSAL, MOVE_SWORDS_DANCE}
    }};

static const struct TrainerMonItemCustomMoves sParty_RivalLeagueTreecko[] = {
    {
        .iv = 150,
        .lvl = 45,
        .species = SPECIES_IRONWITCH,
        .heldItem = ITEM_COLBUR_BERRY,
        .moves = {MOVE_PSYSHOCK, MOVE_DAZZLING_GLEAM, MOVE_SHADOW_BALL, MOVE_WILL_O_WISP}
    },
    {
        .iv = 150,
        .lvl = 45,
        .species = SPECIES_IRONBLOON,
        .heldItem = ITEM_LIFE_ORB,
        .moves = {MOVE_HYPER_VOICE, MOVE_DAZZLING_GLEAM, MOVE_BLIZZARD, MOVE_HURRICANE}
    },
    {
        .iv = 150,
        .lvl = 45,
        .species = SPECIES_IRONTREADS,
        .heldItem = ITEM_LEFTOVERS,
        .moves = {MOVE_EARTHQUAKE, MOVE_IRON_HEAD, MOVE_VOLT_SWITCH, MOVE_STEALTH_ROCK}
    },
    {
        .iv = 150,
        .lvl = 45,
        .species = SPECIES_IRONHANDS,
        .heldItem = ITEM_MAGNET,
        .moves = {MOVE_THUNDER_PUNCH, MOVE_DRAIN_PUNCH, MOVE_FAKE_OUT, MOVE_WILD_CHARGE}
    },
    {
        .iv = 150,
        .lvl = 48,
        .heldItem = ITEM_GARDEVOIRITE,
        .species = SPECIES_GARDEVOIR,
        .moves = {MOVE_HYPER_VOICE, MOVE_PSYSHOCK, MOVE_DRAINING_KISS, MOVE_CALM_MIND}
    },
    {
        .iv = 200,
        .lvl = 50,
        .species = SPECIES_IRONBUNDLE,
        .heldItem = ITEM_SITRUS_BERRY,
        .moves = {MOVE_HYDRO_PUMP, MOVE_FREEZE_DRY, MOVE_FLIP_TURN, MOVE_AIR_CUTTER}
    }};

static const struct TrainerMonItemCustomMoves sParty_RivalLeagueTorchic[] = {
    {.iv = 150,
     .lvl = 45,
     .species = SPECIES_FLUTTERMANE,
     .heldItem = ITEM_LIFE_ORB,
    ...
    {.iv = 150,
     ...
     .species = SPECIES_GREATTUSK,
     .heldItem = ITEM_EJECT_PACK,
     .moves = {MOVE_EARTHQUAKE, MOVE_CLOSE_COMBAT, MOVE_STONE_EDGE, MOVE_STEALTH_ROCK}},
    {.iv = 150,
     .lvl = 45,
     .species = SPECIES_CLAWHILL,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_FIRE_PUNCH, MOVE_DRAIN_PUNCH, MOVE_SUNNY_DAY, MOVE_BULK_UP}},
    {.iv = 150,
     .lvl = 48,
     .heldItem = ITEM_FLYGONITE,
     .species = SPECIES_FLYGON,
     .moves = {MOVE_EARTH_POWER, MOVE_BUG_BUZZ, MOVE_DRAGON_RUSH, MOVE_BOOMBURST}},
    {.iv = 200,
     .lvl = 50,
     .species = SPECIES_SMASHBAG,
     .heldItem = ITEM_EXPERT_BELT,
     .moves = {MOVE_ROCK_SLIDE, MOVE_BRAVE_BIRD, MOVE_WAKE_UP_SLAP, MOVE_STRENGTH}}};
...
static const struct TrainerMonItemCustomMoves sParty_Henry[] = {
    {
        ...
        .species = SPECIES_BRONZONG,
        .heldItem = ITEM_RED_CARD,
        .moves = {MOVE_STEALTH_ROCK, MOVE_EARTHQUAKE, MOVE_STEEL_BEAM, MOVE_TRICK_ROOM}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_ROCKY_HELMET,
        .moves = {MOVE_STEALTH_ROCK, MOVE_LEECH_SEED, MOVE_KNOCK_OFF, MOVE_POWER_WHIP}
    },
    {
        .iv = 0,
        .lvl = 50,
        .species = SPECIES_SKARMORY,
        .heldItem = ITEM_LEFTOVERS,
        .moves = {MOVE_SKY_DROP, MOVE_TOXIC, MOVE_SANDSTORM, MOVE_PROTECT}
    },
    {
        .iv = 0,
        .lvl = 50,
        .species = SPECIES_EMPOLEON,
        .heldItem = ITEM_SALAC_BERRY,
        .moves = {MOVE_FLASH_CANNON, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_ROAR}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .heldItem = ITEM_LIFE_ORB,
        .moves = {MOVE_CLOSE_COMBAT, MOVE_DRILL_RUN, MOVE_RAZOR_SHELL, MOVE_SUBSTITUTE}
    },
    {
        .iv = 0,
        .lvl = 50,
        ...
        .moves = {MOVE_DRAGON_TAIL, MOVE_IRON_TAIL, MOVE_METAL_BURST, MOVE_STONE_EDGE}
    }};
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    {.iv = 0,
     .lvl = 18,
     .species = SPECIES_ZANGOOSE,
     .moves = {MOVE_SLASH, MOVE_EARTHQUAKE, MOVE_POISON_JAB, MOVE_SWORDS_DANCE}},
    {.iv = 0,
     .lvl = 20,
     .species = SPECIES_SEVIPER,
     .moves = {MOVE_POISON_TAIL, MOVE_BITE, MOVE_BRUTAL_SWING, MOVE_COIL}}};
...
static const struct TrainerMonItemCustomMoves sParty_GruntMagmaHideout11[] = {
    {
        ...
        .moves = {MOVE_ESPER_WING, MOVE_AIR_SLASH, MOVE_U_TURN, MOVE_TAILWIND}
    },
    {
        .iv = 0,
        .lvl = 30,
        .species = SPECIES_ZOROARK_HISUIAN,
        .moves = {MOVE_U_TURN, MOVE_HYPER_VOICE, MOVE_FLAMETHROWER, MOVE_BITTER_MALICE}
    },
    {
        .iv = 0,
        .lvl = 32,
        ...
        .heldItem = ITEM_CUSTOMITE,
        .moves = {MOVE_FLAMETHROWER, MOVE_INFERNAL_PARADE, MOVE_OVERHEAT, MOVE_THUNDER_PUNCH}
    },
    {
        .iv = 0,
        .lvl = 30,
    ...
    },
    {
        ...
        .moves = {MOVE_BARB_BARRAGE, MOVE_CRUNCH, MOVE_WATERFALL, MOVE_AGILITY}
    },
    {
        .iv = 0,
        .lvl = 31,
        .species = SPECIES_SNEASLER,
        .moves = {MOVE_DIRE_CLAW, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_FIRE_PUNCH}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_TabithaMagmaHideout[] = {
    {
        ...
        .heldItem = ITEM_HEAT_ROCK,
        .species = SPECIES_NINETALES,
        .moves = {MOVE_SOLAR_BEAM, MOVE_FLAMETHROWER, MOVE_EXTRASENSORY, MOVE_HYPNOSIS}
    },
    {
        .iv = 75,
        .lvl = 32,
        .species = SPECIES_MEGANIUM,
        .moves = {MOVE_SOLAR_BEAM, MOVE_SYNTHESIS, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED}
    },
    {
        .iv = 75,
        .lvl = 32,
        .species = SPECIES_CASTFORM,
        .moves = {MOVE_SOLAR_BEAM, MOVE_WEATHER_BALL, MOVE_FIRE_BLAST, MOVE_SHADOW_BALL}
    },
    {
        .iv = 75,
        .lvl = 32,
        .species = SPECIES_ARCANINE_HISUIAN,
        .moves = {MOVE_FLARE_BLITZ, MOVE_ROCK_SLIDE, MOVE_STEALTH_ROCK, MOVE_BITE}
    },
    {
        .iv = 75,
        .lvl = 36,
        .species = SPECIES_CINDEROOT,
        .moves = {MOVE_ENERGY_BALL, MOVE_SHADOW_BALL, MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM}
    },
    {
        .iv = 75,
        .lvl = 35,
        .heldItem = ITEM_CAMERUPTITE,
        .species = SPECIES_CAMERUPT,
        .moves = {MOVE_FLAME_BURST, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_YAWN}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMossdeep[] = {
    {.iv = 150,
     ...
     .species = SPECIES_SHIFTRY,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_SOLAR_BEAM, MOVE_WEATHER_BALL, MOVE_DARK_PULSE, MOVE_HEAT_WAVE}},
     {.iv = 150,
      .lvl = 40,
      .species = SPECIES_TURTONATOR,
      .heldItem = ITEM_CUSTOMITE,
      .moves = {MOVE_HEAT_WAVE, MOVE_DRAGON_PULSE, MOVE_SPIKY_SHIELD, MOVE_WIDE_GUARD}},
    {.iv = 150,
     .lvl = 39,
     .species = SPECIES_IRONPLASMA,
     .heldItem = ITEM_SHUCA_BERRY,
     .moves = {MOVE_HEAT_WAVE, MOVE_THUNDERBOLT, MOVE_PROTECT, MOVE_CHARGE_BEAM}},
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Myles[] = {
    {
        ...
        .moves = {MOVE_COPYCAT, MOVE_TRICK_ROOM}
    },
    {
        .iv = 10,
        .lvl = 29,
...
static const struct TrainerMonNoItemCustomMoves sParty_Pat[] = {
    {.iv = 10,
     .lvl = 31,
     .species = SPECIES_DELCATTY,
     .moves = {MOVE_ASSIST, MOVE_HYPNOSIS}},
    {.iv = 10,
     .lvl = 29,
     .species = SPECIES_OCTILLERY,
     .moves = {MOVE_WATER_SPOUT}}
    };
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    {.iv = 255,
     ...
     .species = SPECIES_GOLEM_ALOLAN,
     .heldItem = ITEM_AIR_BALLOON,
     .moves = {MOVE_STEALTH_ROCK, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_EXPLOSION}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_CRADILY,
     .heldItem = ITEM_HEAT_ROCK,
     .moves = {MOVE_PROTECT, MOVE_SUNNY_DAY, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_SMASHBAG,
     .heldItem = ITEM_LIFE_ORB,
     .moves = {MOVE_ROCK_SLIDE, MOVE_BRAVE_BIRD, MOVE_HONE_CLAWS, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_ARMALDO,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_SWORDS_DANCE, MOVE_X_SCISSOR, MOVE_AQUA_JET, MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 52,
     .species = SPECIES_PROBOPASS,
     .heldItem = ITEM_SHUCA_BERRY,
     .moves = {MOVE_FLASH_CANNON, MOVE_VOLT_SWITCH, MOVE_PROTECT, MOVE_POWER_GEM}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_AGGRON,
     .heldItem = ITEM_AGGRONITE,
     .moves = {MOVE_IRON_TAIL, MOVE_EARTHQUAKE, MOVE_ROAR, MOVE_ROCK_SLIDE}},
     };
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_MACHAMP,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_KARATE_CHOP, MOVE_ROCK_SLIDE, MOVE_FISSURE, MOVE_BULK_UP}},
    {.iv = 255,
     .lvl = 43,
     .species = SPECIES_MEDICHAM,
     .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    {.iv = 255,
     ...
     .species = SPECIES_HITMONTOP,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_TRIPLE_AXEL, MOVE_DARKEST_LARIAT, MOVE_PROTECT, MOVE_SURGING_STRIKES}},
    {.iv = 255,
     .lvl = 52,
     .species = SPECIES_HARIYAMA,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_FAKE_OUT, MOVE_DRAIN_PUNCH, MOVE_BELLY_DRUM, MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_IRONHANDS,
     .heldItem = ITEM_ASSAULT_VEST,
     .moves = {MOVE_THUNDER_PUNCH, MOVE_FOCUS_PUNCH, MOVE_EARTHQUAKE, MOVE_DRAIN_PUNCH}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_CLAWHILL,
     .heldItem = ITEM_SHELL_BELL,
     .moves = {MOVE_DRAIN_PUNCH, MOVE_PROTECT, MOVE_FIRE_PUNCH, MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_RIOLU,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_FORCE_PALM, MOVE_HELPING_HAND, MOVE_COPYCAT, MOVE_COACHING}},
    {.iv = 255,
     .lvl = 52,
     .species = SPECIES_MEDICHAM,
     .heldItem = ITEM_MEDICHAMITE,
     .moves = {MOVE_BULLET_PUNCH, MOVE_HIGH_JUMP_KICK, MOVE_ZEN_HEADBUTT, MOVE_ICE_PUNCH}},
     };
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_MANECTRIC,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_BITE, MOVE_ICE_BEAM, MOVE_THUNDER, MOVE_PROTECT}}};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson5[] = {
    {.iv = 255,
     ...
     .species = SPECIES_PLUSLE,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_SWIFT, MOVE_VOLT_SWITCH, MOVE_HELPING_HAND, MOVE_ELECTRIC_TERRAIN}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_MINUN,
     .heldItem = ITEM_SHUCA_BERRY,
     .moves = {MOVE_FLASH, MOVE_NUZZLE, MOVE_FAKE_TEARS, MOVE_LIGHT_SCREEN}},
    {.iv = 255,
     .lvl = 51,
     .species = SPECIES_RAICHU_ALOLAN,
     .heldItem = ITEM_LIFE_ORB,
     .moves = {MOVE_RISING_VOLTAGE, MOVE_SURF, MOVE_GRASS_KNOT, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_ELECTRODE_HISUIAN,
     .heldItem = ITEM_MIRACLE_SEED,
     .moves = {MOVE_CHLOROBLAST, MOVE_DISCHARGE, MOVE_ENERGY_BALL, MOVE_ELECTRIC_TERRAIN}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_IRONHUT,
     .heldItem = ITEM_AIR_BALLOON,
     .moves = {MOVE_CHARGE_BEAM, MOVE_PROTECT, MOVE_SLUDGE_BOMB, MOVE_SPORE}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_MANECTRIC,
     .heldItem = ITEM_MANECTITE,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery5[] = {
    {.iv = 255,
     ...
     .species = SPECIES_TURTONATOR,
     .heldItem = ITEM_EJECT_PACK,
     .moves = {MOVE_DRACO_METEOR, MOVE_OVERHEAT, MOVE_SHELL_TRAP, MOVE_WIDE_GUARD}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_PYROAR,
     .heldItem = ITEM_HEART_SCALE,
     .moves = {MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_EARTH_POWER, MOVE_EXTRASENSORY}},
    {.iv = 255,
     .lvl = 51,
     .species = SPECIES_ARCANINE_HISUIAN,
     .heldItem = ITEM_SHELL_BELL,
     .moves = {MOVE_HEAD_SMASH, MOVE_FLARE_BLITZ, MOVE_ROCK_SLIDE, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 51,
     .species = SPECIES_TERRORKING,
     .heldItem = ITEM_LIFE_ORB,
     .moves = {MOVE_WEATHER_BALL, MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_BLAZIKEN,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_SKY_UPPERCUT, MOVE_BLAZE_KICK, MOVE_THUNDER_PUNCH, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_TORKOAL,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_YAWN, MOVE_HEAT_WAVE, MOVE_ROCK_SLIDE, MOVE_RAPID_SPIN}}};
...
static const struct TrainerMonItemCustomMoves sParty_Norman4[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_KANGASKHAN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_FAKE_OUT, MOVE_DIZZY_PUNCH, MOVE_BEAT_UP, MOVE_REVERSAL}},
     {.iv = 255,
     .lvl = 50,
     .species = SPECIES_SMEARGLE,
     .heldItem = ITEM_CUSTOMITE,
...
static const struct TrainerMonItemCustomMoves sParty_Norman5[] = {
    {.iv = 255,
     ...
     .species = SPECIES_SLAKING,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_STRENGTH, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_PLAY_ROUGH}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_WYRDEER,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_PROTECT, MOVE_STRENGTH, MOVE_SKILL_SWAP, MOVE_PSYSHIELD_BASH}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_KANGASKHAN,
     .heldItem = ITEM_KANGASKHANITE,
     .moves = {MOVE_SUCKER_PUNCH, MOVE_BODY_SLAM, MOVE_POWER_UP_PUNCH, MOVE_ROCK_SLIDE}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_ZOROARK_HISUIAN,
     .heldItem = ITEM_FOCUS_SASH,
     .moves = {MOVE_HYPER_VOICE, MOVE_PROTECT, MOVE_BITTER_MALICE, MOVE_EXTRASENSORY}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_ORANGURU,
     .heldItem = ITEM_ROCKY_HELMET,
     .moves = {MOVE_INSTRUCT, MOVE_SKILL_SWAP, MOVE_FUTURE_SIGHT, MOVE_HYPNOSIS}},
    {.iv = 255,
     .lvl = 58,
     .species = SPECIES_IRONBLOON,
     .heldItem = ITEM_THROAT_SPRAY,
     .moves = {MOVE_BOOMBURST, MOVE_DAZZLING_GLEAM, MOVE_THUNDERBOLT, MOVE_BLIZZARD}}};
...
static const struct TrainerMonItemCustomMoves sParty_Winona4[] = {
    {.iv = 255,
     ...
     .species = SPECIES_NOCTOWL,
     .heldItem = ITEM_CUSTOMITE,
     .moves = {MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_REFLECT, MOVE_NIGHT_DAZE}},
    {.iv = 255,
     .lvl = 49,
     .species = SPECIES_GLIDEBURN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SUNNY_DAY, MOVE_AERIAL_ACE, MOVE_SOLAR_BEAM, MOVE_HEAT_WAVE}},
    {.iv = 255,
     .lvl = 50,
     .species = SPECIES_QUEZATU,
     .heldItem = ITEM_SITRUS_BERRY,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_IRONWINGS,
     .heldItem = ITEM_POWER_HERB,
     .moves = {MOVE_SOLAR_BEAM, MOVE_AIR_CUTTER, MOVE_PROTECT, MOVE_RAZOR_LEAF}},
    {.iv = 255,
     .lvl = 53,
     .species = SPECIES_SKARMORY,
     .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_Winona5[] = {
    {.iv = 255,
     ...
     .species = SPECIES_TROPIUS,
     .heldItem = ITEM_YACHE_BERRY,
     .moves = {MOVE_SUNNY_DAY, MOVE_DUAL_WINGBEAT, MOVE_SOLAR_BLADE, MOVE_EARTHQUAKE}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_QUEZATU,
     .heldItem = ITEM_WISE_GLASSES,
     .moves = {MOVE_PSYSHOCK, MOVE_HEAT_WAVE, MOVE_PROTECT, MOVE_AIR_CUTTER}},
    {.iv = 255,
     .lvl = 58,
     .species = SPECIES_NOCTOWL,
     .heldItem = ITEM_CUSTOMITE,
     .moves = {MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_REFLECT, MOVE_FIERY_WRATH}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_IRONWINGS,
     .heldItem = ITEM_POWER_HERB,
     .moves = {MOVE_SOLAR_BEAM, MOVE_CHARGE_BEAM, MOVE_AIR_SLASH, MOVE_TAILWIND}},
    {.iv = 255,
     .lvl = 58,
     .species = SPECIES_SKARMORY,
     .heldItem = ITEM_LEFTOVERS,
    ...
    {.iv = 255,
     ...
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_POWER_HERB,
     .moves = {MOVE_SKY_ATTACK, MOVE_ROOST, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE}}};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza4[] = {
    ...
    {.iv = 255,
     ...
     .species = SPECIES_NOKAY,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_POWER_UP_PUNCH, MOVE_DRAIN_PUNCH, MOVE_PAYBACK, MOVE_OBSTRUCT}},
    {.iv = 255,
     .lvl = 58,
     .species = SPECIES_SLOWKING,
     .heldItem = ITEM_CUSTOMITE,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza5[] = {
    {.iv = 255,
     ...
     .moves = {MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_DAZZLING_GLEAM, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 54,
     .species = SPECIES_FARIGIRAF,
     .heldItem = ITEM_THROAT_SPRAY,
     .moves = {MOVE_HYPER_VOICE, MOVE_SUNNY_DAY, MOVE_TRICK_ROOM, MOVE_LIGHT_SCREEN}},
    {.iv = 255,
     .lvl = 56,
     .species = SPECIES_SLOWBRO,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_FUTURE_SIGHT, MOVE_FLAMETHROWER, MOVE_CALM_MIND, MOVE_MUDDY_WATER}},
    {.iv = 255,
     .lvl = 58,
     .species = SPECIES_MAGICOAT,
     .heldItem = ITEM_COLBUR_BERRY,
     .moves = {MOVE_PSYSHOCK, MOVE_EARTH_POWER, MOVE_WEATHER_BALL, MOVE_CALM_MIND}},
    {.iv = 255,
     .lvl = 58,
     .species = SPECIES_MAGICORN,
     .heldItem = ITEM_POWER_HERB,
     .moves = {MOVE_SOLAR_BLADE, MOVE_PSYCHO_CUT, MOVE_ROCK_SLIDE, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_ECLIMINARY,
     .heldItem = ITEM_ECLIMINARINITE,
     .moves = {MOVE_POWER_GEM, MOVE_PSYCHIC, MOVE_MORNING_SUN, MOVE_CALM_MIND}},
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan5[] = {
    {.iv = 255,
     ...
     .species = SPECIES_SWANNA,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_WEATHER_BALL, MOVE_HURRICANE, MOVE_ICE_BEAM, MOVE_PROTECT}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_RELICLIFFON,
     .heldItem = ITEM_RINDO_BERRY,
     .moves = {MOVE_WATERFALL, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_ROCK_POLISH}},
    {.iv = 255,
     .lvl = 55,
     .species = SPECIES_POLITOED,
     .heldItem = ITEM_DAMP_ROCK,
     .moves = {MOVE_WHIRLPOOL, MOVE_ICE_BEAM, MOVE_WEATHER_BALL, MOVE_PARTING_SHOT}},
    {.iv = 255,
     .lvl = 58,
     .species = SPECIES_GOREBYSS,
     .heldItem = ITEM_FOCUS_SASH,
    ...
    {.iv = 255,
     ...
     .moves = {MOVE_PROTECT, MOVE_SLUDGE_BOMB, MOVE_OUTRAGE, MOVE_WATERFALL}},
    {.iv = 255,
     .lvl = 60,
     .species = SPECIES_KINGDRA,
     .heldItem = ITEM_CUSTOMITE,
     .moves = {MOVE_DRAGON_CLAW, MOVE_WATERFALL, MOVE_DRACO_METEOR, MOVE_DRAGON_DANCE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    {.iv = 100,
     ...
     .species = SPECIES_MAGNEMITE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SHOCK_WAVE, MOVE_MAGNET_BOMB, MOVE_THUNDER_WAVE, MOVE_TACKLE}},
    {.iv = 100,
     .lvl = 17,
     .species = SPECIES_VOLBEAT,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_SIGNAL_BEAM, MOVE_NONE}}};
...
static const struct TrainerMonItemCustomMoves sParty_Steven_Custom[] = {
    {.iv = 100,
     .lvl = 42,
     .species = SPECIES_SKARMORY,
     .heldItem = ITEM_NONE,
    ...
    {.iv = 100,
     ...
     .species = SPECIES_SCIZOR,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_U_TURN, MOVE_AERIAL_ACE, MOVE_SWORDS_DANCE, MOVE_BULLET_PUNCH}},
    {.iv = 100,
     .lvl = 43,
     .species = SPECIES_AGGRON,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_HEAD_SMASH, MOVE_ROCK_POLISH, MOVE_IRON_HEAD, MOVE_STEALTH_ROCK}},
    {.iv = 100,
     .lvl = 43,
     .species = SPECIES_STEELIX,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_ICE_FANG, MOVE_COIL}},
    {.iv = 100,
     .lvl = 44,
     .species = SPECIES_IRONTITAN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_METEOR_MASH, MOVE_CLOSE_COMBAT, MOVE_POWER_UP_PUNCH, MOVE_THUNDER_PUNCH}},
    {.iv = 100,
     .lvl = 45,
     .species = SPECIES_METAGROSS,
     .heldItem = ITEM_METAGROSSITE,
     .moves = {MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_METEOR_MASH, MOVE_BULLET_PUNCH}}};
...
static const struct TrainerMonItemCustomMoves sParty_DeltaSage[] = {
    {
        .iv = 0,
        .lvl = 42,
        .species = SPECIES_APOKARGO,
    ...
    },
    {
        ...
        .heldItem = ITEM_CUSTOMITE,
        .species = SPECIES_SIGILYPH,
        .moves = {MOVE_MYSTICAL_POWER, MOVE_ESPER_WING, MOVE_STORED_POWER, MOVE_MIRACLE_EYE}
    },
};
