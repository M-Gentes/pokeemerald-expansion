...
const struct MonCoords gMonBackPicCoords[] =
    {
        ...
        [SPECIES_GOLEM_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_NOCTOWL_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_KINGDRA_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_CHIMECHO_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_WAILORD_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_CHESNAUGHT_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_DELPHOX_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_PALOSSAND_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_FALINKS_MEGA] = {.size = MON_COORDS_SIZE(64, 64), .y_offset = 0},
        [SPECIES_ECLIMINARY] = {.size = MON_COORDS_SIZE(48, 56), .y_offset = 3},
        [SPECIES_PUMPKING] = {.size = MON_COORDS_SIZE(48, 56), .y_offset = 3},
