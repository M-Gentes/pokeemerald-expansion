const u8 *const gMonFootprintTable[] =
    {
...
#endif
        [SPECIES_SMASHBAG] = gMonFootprint_Smashbag,
        [SPECIES_CLAWHILL] = gMonFootprint_Clawhill,
        [SPECIES_MAGICORN] = gMonFootprint_Magicorn,
        [SPECIES_MAGICOAT] = gMonFootprint_Magicoat,
        [SPECIES_SWIRLHEAD] = gMonFootprint_Swirlhead,
        [SPECIES_TERRORKING] = gMonFootprint_Terrorking,
        [SPECIES_IRONBLOON] = gMonFootprint_Ironbloon,
        [SPECIES_IRONHUT] = gMonFootprint_Ironhut,
        [SPECIES_IRONTITAN] = gMonFootprint_Irontitan,
        [SPECIES_IRONWINGS] = gMonFootprint_Ironwings,
        [SPECIES_IRONWITCH] = gMonFootprint_Ironwitch,
        [SPECIES_BRUTEBONNET] = gMonFootprint_Brutebonnet,
        [SPECIES_GREATTUSK] = gMonFootprint_Greattusk,
        [SPECIES_SLITHERWING] = gMonFootprint_Slitherwing,
        [SPECIES_SCREAMTAIL] = gMonFootprint_Screamtail,
        [SPECIES_SANDYSHOCKS] = gMonFootprint_Sandyshocks,
        [SPECIES_FLUTTERMANE] = gMonFootprint_Fluttermane,
        [SPECIES_ROARINGMOON] = gMonFootprint_Roaringmoon,
        [SPECIES_IRONBUNDLE] = gMonFootprint_Ironbundle,
        [SPECIES_IRONHANDS] = gMonFootprint_Ironhands,
        [SPECIES_IRONJUGULIS] = gMonFootprint_Ironjugulis,
        [SPECIES_IRONMOTH] = gMonFootprint_Ironmoth,
        [SPECIES_IRONTHORNS] = gMonFootprint_Ironthorns,
        [SPECIES_IRONTREADS] = gMonFootprint_Irontreads,
        [SPECIES_IRONVALIANT] = gMonFootprint_Ironvaliant,
        // [SPECIES_SPIRIGATITO] = gMonFootprint_Spirigatito,
        // [SPECIES_FLORAGATO] = gMonFootprint_Floragato,
        // [SPECIES_YUKAXATO] = gMonFootprint_Yukaxato,
        // [SPECIES_FUECOCO] = gMonFootprint_Fuecoco,
        // [SPECIES_CROCALOR] = gMonFootprint_Crocalor,
        // [SPECIES_SPICABORO] = gMonFootprint_Spicaboro,
        // [SPECIES_QUAXLY] = gMonFootprint_Quaxly,
        // [SPECIES_QUAXWELL] = gMonFootprint_Quaxwell,
        // [SPECIES_QUAXISTADOR] = gMonFootprint_Quaxistador,
        [SPECIES_SPIRIGATITO] = gMonFootprint_Pawmi,
        [SPECIES_FLORAGATO] = gMonFootprint_Pawmi,
        [SPECIES_YUKAXATO] = gMonFootprint_Pawmi,
        [SPECIES_FUECOCO] = gMonFootprint_Pawmi,
        [SPECIES_CROCALOR] = gMonFootprint_Pawmi,
        [SPECIES_SPICABORO] = gMonFootprint_Pawmi,
        [SPECIES_QUAXLY] = gMonFootprint_Pawmi,
        [SPECIES_QUAXWELL] = gMonFootprint_Pawmi,
        [SPECIES_QUAXISTADOR] = gMonFootprint_Pawmi,
        ...
        [SPECIES_BRYNXESS] = gMonFootprint_Brynxess,
        [SPECIES_APOKARGO] = gMonFootprint_Apokargo,
        [SPECIES_QUEZATU] = gMonFootprint_Quezatu,
        [SPECIES_RELICLIFFON] = gMonFootprint_Relicliffon,
