const struct CompressedSpriteSheet gMonFrontPicTable[] =
    {
...
#endif
        SPECIES_SPRITE(SMASHBAG, gMonFrontPic_Smashbag),
        SPECIES_SPRITE(CLAWHILL, gMonFrontPic_Clawhill),
        SPECIES_SPRITE(MAGICORN, gMonFrontPic_Magicorn),
        SPECIES_SPRITE(MAGICOAT, gMonFrontPic_Magicoat),
        SPECIES_SPRITE(SWIRLHEAD, gMonFrontPic_Swirlhead),
        SPECIES_SPRITE(TERRORKING, gMonFrontPic_Terrorking),
        SPECIES_SPRITE(IRONBLOON, gMonFrontPic_Ironbloon),
        SPECIES_SPRITE(IRONHUT, gMonFrontPic_Ironhut),
        SPECIES_SPRITE(IRONTITAN, gMonFrontPic_Irontitan),
        SPECIES_SPRITE(IRONWINGS, gMonFrontPic_Ironwings),
        SPECIES_SPRITE(IRONWITCH, gMonFrontPic_Ironwitch),
        SPECIES_SPRITE(BRUTEBONNET, gMonFrontPic_Brutebonnet),
        SPECIES_SPRITE(GREATTUSK, gMonFrontPic_Greattusk),
        SPECIES_SPRITE(SLITHERWING, gMonFrontPic_Slitherwing),
        SPECIES_SPRITE(SCREAMTAIL, gMonFrontPic_Screamtail),
        SPECIES_SPRITE(SANDYSHOCKS, gMonFrontPic_Sandyshocks),
        SPECIES_SPRITE(FLUTTERMANE, gMonFrontPic_Fluttermane),
        SPECIES_SPRITE(ROARINGMOON, gMonFrontPic_Roaringmoon),
        SPECIES_SPRITE(IRONBUNDLE, gMonFrontPic_Ironbundle),
        SPECIES_SPRITE(IRONHANDS, gMonFrontPic_Ironhands),
        SPECIES_SPRITE(IRONJUGULIS, gMonFrontPic_Ironjugulis),
        ...
        SPECIES_SPRITE(IRONVALIANT, gMonFrontPic_Ironvaliant),
        SPECIES_SPRITE(SPIRIGATITO, gMonFrontPic_Spirigatito),
        SPECIES_SPRITE(FLORAGATO, gMonFrontPic_Floragato),
        SPECIES_SPRITE(YUKAXATO, gMonFrontPic_Yukaxato),
        SPECIES_SPRITE(FUECOCO, gMonFrontPic_Fuecoco),
        SPECIES_SPRITE(CROCALOR, gMonFrontPic_Crocalor),
        SPECIES_SPRITE(SPICABORO, gMonFrontPic_Spicaboro),
        SPECIES_SPRITE(QUAXLY, gMonFrontPic_Quaxly),
        SPECIES_SPRITE(QUAXWELL, gMonFrontPic_Quaxwell),
        SPECIES_SPRITE(QUAXISTADOR, gMonFrontPic_Quaxistador),
        ...
        SPECIES_SPRITE(CASTSTORM, gMonFrontPic_Caststorm),
        SPECIES_SPRITE(BRYNXESS, gMonFrontPic_Brynxess),
        SPECIES_SPRITE(APOKARGO, gMonFrontPic_Apokargo),
        SPECIES_SPRITE(QUEZATU, gMonFrontPic_Quezatu),
        SPECIES_SPRITE(RELICLIFFON, gMonFrontPic_Relicliffon),
        SPECIES_SPRITE(DRACONEON, gMonFrontPic_Draconeon),
        SPECIES_SPRITE(MERAKI, gMonFrontPic_Meraki),
        SPECIES_SPRITE(KAGECOON, gMonFrontPic_Kagecoon),
        SPECIES_SPRITE(TANDAYU, gMonFrontPic_Tandayu),
        SPECIES_SPRITE(TAROUNTULA, gMonFrontPic_Tarountula),

        SPECIES_SPRITE(TENTACRUEL_MEGA, gMonFrontPic_TentacruelMega),
        SPECIES_SPRITE(FLYGON_MEGA, gMonFrontPic_FlygonMega),
        SPECIES_SPRITE(LUXRAY_MEGA, gMonFrontPic_LuxrayMega),
        SPECIES_SPRITE(BUTTERFREE_MEGA, gMonFrontPic_ButterfreeMega),
        SPECIES_SPRITE(FEAROW_MEGA, gMonFrontPic_FearowMega),
        SPECIES_SPRITE(MACHAMP_MEGA, gMonFrontPic_MachampMega),
        SPECIES_SPRITE(GOLEM_MEGA, gMonFrontPic_GolemMega),
        SPECIES_SPRITE(NOCTOWL_MEGA, gMonFrontPic_NoctowlMega),
        SPECIES_SPRITE(KINGDRA_MEGA, gMonFrontPic_KingdraMega),
        SPECIES_SPRITE(CHIMECHO_MEGA, gMonFrontPic_ChimechoMega),
        SPECIES_SPRITE(WAILORD_MEGA, gMonFrontPic_WailordMega),
        SPECIES_SPRITE(CHESNAUGHT_MEGA, gMonFrontPic_ChesnaughtMega),
        SPECIES_SPRITE(DELPHOX_MEGA, gMonFrontPic_DelphoxMega),
        SPECIES_SPRITE(PALOSSAND_MEGA, gMonFrontPic_PalossandMega),
        SPECIES_SPRITE(FALINKS_MEGA, gMonFrontPic_FalinksMega),
        SPECIES_SPRITE(ECLIMINARY, gMonFrontPic_Ecliminary),
        SPECIES_SPRITE(PUMPKING, gMonFrontPic_Pumpking),
        ...
        SPECIES_SPRITE(KECLILISK, gMonFrontPic_Keclilisk),
        SPECIES_SPRITE(DHELVESSEL, gMonFrontPic_Dhelvessel),
        SPECIES_SPRITE(SPIKEDASH, gMonFrontPic_Spikedash),
        SPECIES_SPRITE(IRONWALKS, gMonFrontPic_Ironwalks),
        SPECIES_SPRITE(LURINSKULL, gMonFrontPic_Lurinskull),
        SPECIES_SPRITE(IRONSEEKER, gMonFrontPic_Ironseeker),
        SPECIES_SPRITE(NOKAY, gMonFrontPic_Nokay),
        SPECIES_SPRITE(IRONKNEEL, gMonFrontPic_Ironkneel),
        SPECIES_SPRITE(VENOMFEAR, gMonFrontPic_Venomfear),
        SPECIES_SPRITE(IRONSTING, gMonFrontPic_Ironsting),
        SPECIES_SPRITE(SLENDERSUN, gMonFrontPic_Slendersun),
        SPECIES_SPRITE(IRONPANEL, gMonFrontPic_Ironpanel),
        SPECIES_SPRITE(DREADBOULD, gMonFrontPic_Dreadbould),
        SPECIES_SPRITE(IRONHOLE, gMonFrontPic_Ironhole),
        SPECIES_SPRITE(ARCHMUSSEL, gMonFrontPic_Archmussel),
        SPECIES_SPRITE(IRONPUMP, gMonFrontPic_Ironpump),
        SPECIES_SPRITE(STEAMOUNT, gMonFrontPic_Steamount),
        SPECIES_SPRITE(IRONFUSE, gMonFrontPic_Ironfuse),
        SPECIES_SPRITE(ABYSSCLAW, gMonFrontPic_Abyssclaw),
        SPECIES_SPRITE(IRONSUB, gMonFrontPic_Ironsub),
        SPECIES_SPRITE(CINDEROOT, gMonFrontPic_Cinderoot),
        SPECIES_SPRITE(IRONPLASMA, gMonFrontPic_Ironplasma),
        SPECIES_SPRITE(GLACIARMOR, gMonFrontPic_Glaciarmor),
        SPECIES_SPRITE(IRONWAVES, gMonFrontPic_Ironwaves),
        SPECIES_SPRITE(SUMMONCIRCLE, gMonFrontPic_Summoncircle),
        SPECIES_SPRITE(IRONGATE, gMonFrontPic_Irongate),
        SPECIES_SPRITE(CUBEPUNCH, gMonFrontPic_Cubepunch),
        SPECIES_SPRITE(IRONVISION, gMonFrontPic_Ironvision),
        SPECIES_SPRITE(BARKJAM, gMonFrontPic_Barkjam),
        SPECIES_SPRITE(IRONBUZZ, gMonFrontPic_Ironbuzz),
        SPECIES_SPRITE(FLOATINHUNT, gMonFrontPic_Floatinhunt),
        SPECIES_SPRITE(IRONROCKET, gMonFrontPic_Ironrocket),
        SPECIES_SPRITE(PLEASODOR, gMonFrontPic_Pleasodor),
        SPECIES_SPRITE(IRONSPRAY, gMonFrontPic_Ironspray),
        SPECIES_SPRITE(SANESECT, gMonFrontPic_Sanesect),
        SPECIES_SPRITE(IRONFECTION, gMonFrontPic_Ironfection),
        SPECIES_SPRITE(INFINAGA, gMonFrontPic_Infinaga),
        SPECIES_SPRITE(IRONFAN, gMonFrontPic_Ironfan),
        SPECIES_SPRITE(TOXSPITTLE, gMonFrontPic_Toxspittle),
        SPECIES_SPRITE(IRONSAT, gMonFrontPic_Ironsat),
        SPECIES_SPRITE(CRAWLFANG, gMonFrontPic_Crawlfang),
        SPECIES_SPRITE(IRONBOOM, gMonFrontPic_Ironboom),
        SPECIES_SPRITE(SEALSTONE, gMonFrontPic_Sealstone),
        SPECIES_SPRITE(IRONSABER, gMonFrontPic_Ironsaber),
        SPECIES_SPRITE(GLIDEBURN, gMonFrontPic_Glideburn),
        SPECIES_SPRITE(IRONCUBATOR, gMonFrontPic_Ironcubator),
        SPECIES_SPRITE(RAPIDASH_MEGA, gMonFrontPic_RapidashMega),
        SPECIES_SPRITE(MIGHTYENA_MEGA, gMonFrontPic_MightyenaMega),
        SPECIES_SPRITE(DRIFBLIM_MEGA, gMonFrontPic_DrifblimMega),
        SPECIES_SPRITE(VANILLUXE_MEGA, gMonFrontPic_VanilluxeMega),
        SPECIES_SPRITE(FORRETRESS_MEGA, gMonFrontPic_ForretressMega),
        SPECIES_SPRITE(BOLTUND_MEGA, gMonFrontPic_BoltundMega),
        SPECIES_SPRITE(SWALOT_MEGA, gMonFrontPic_SwalotMega),
        SPECIES_SPRITE(SLOWKING_MEGA, gMonFrontPic_SlowkingMega),
        SPECIES_SPRITE(SEAKING_MEGA, gMonFrontPic_SeakingMega),
        SPECIES_SPRITE(LEDIAN_MEGA, gMonFrontPic_LedianMega),
        SPECIES_SPRITE(ARBOK_MEGA, gMonFrontPic_ArbokMega),
        SPECIES_SPRITE(SMEARGLE_MEGA, gMonFrontPic_SmeargleMega),
        SPECIES_SPRITE(REVAVROOM_MEGA, gMonFrontPic_RevavroomMega),
        SPECIES_SPRITE(KLEFKI_MEGA, gMonFrontPic_KlefkiMega),
        SPECIES_SPRITE(PINCURCHIN_MEGA, gMonFrontPic_PincurchinMega),
        SPECIES_SPRITE(TURTONATOR_MEGA, gMonFrontPic_TurtonatorMega),
        SPECIES_SPRITE(THIEVUL_MEGA, gMonFrontPic_ThievulMega),
        SPECIES_SPRITE(TOUCANNON_MEGA, gMonFrontPic_ToucannonMega),
        SPECIES_SPRITE(YANMEGA_MEGA, gMonFrontPic_YanmegaMega),
        SPECIES_SPRITE(LIEPARD_MEGA, gMonFrontPic_LiepardMega),
        SPECIES_SPRITE(KLINKLANG_MEGA, gMonFrontPic_KlinklangMega),
        SPECIES_SPRITE(HONCHKROW_MEGA, gMonFrontPic_HonchkrowMega),
        SPECIES_SPRITE(GOLDUCK_MEGA, gMonFrontPic_GolduckMega),
        SPECIES_SPRITE(ROSERADE_MEGA, gMonFrontPic_RoseradeMega),
        SPECIES_SPRITE(SIGILYPH_MEGA, gMonFrontPic_SigilyphMega),
        SPECIES_SPRITE(MANTINE_MEGA, gMonFrontPic_MantineMega),
        SPECIES_SPRITE(BIDOOF_MEGA, gMonFrontPic_BidoofMega),
        ...
        SPECIES_SPRITE(MARACTUS_MEGA, gMonFrontPic_MaractusMega),
        SPECIES_SPRITE(WHISCASH_MEGA, gMonFrontPic_WhiscashMega),
        SPECIES_SPRITE(SHUCKLE_MEGA, gMonFrontPic_ShuckleMega),
        SPECIES_SPRITE(PARASECT_MEGA, gMonFrontPic_ParasectMega),
        SPECIES_SPRITE(RABSCA_MEGA, gMonFrontPic_RabscaMega),
        SPECIES_SPRITE(SPIDOPS_MEGA, gMonFrontPic_SpidopsMega),
        SPECIES_SPRITE(KRICKETUNE_MEGA, gMonFrontPic_KricketuneMega),
        SPECIES_SPRITE(VENOMOTH_MEGA, gMonFrontPic_VenomothMega),
        SPECIES_SPRITE(MEGANIUM_MEGA, gMonFrontPic_MeganiumMega),
        SPECIES_SPRITE(FERALIGATR_MEGA, gMonFrontPic_FeraligatrMega),
        SPECIES_SPRITE(TORTERRA_MEGA, gMonFrontPic_TorterraMega),
        SPECIES_SPRITE(INFERNAPE_MEGA, gMonFrontPic_InfernapeMega),
        SPECIES_SPRITE(EMPOLEON_MEGA, gMonFrontPic_EmpoleonMega),
        ...
        SPECIES_SPRITE(RILLABOOM_MEGA, gMonFrontPic_RillaboomMega),
        SPECIES_SPRITE(CINDERACE_MEGA, gMonFrontPic_CinderaceMega),
        SPECIES_SPRITE(INTELEON_MEGA, gMonFrontPic_InteleonMega),
        ...
        SPECIES_SPRITE(GARBODOR_MEGA, gMonFrontPic_GarbodorMega),
        SPECIES_SPRITE(CORVIKNIGHT_MEGA, gMonFrontPic_CorviknightMega),
        SPECIES_SPRITE(ORBEETLE_MEGA, gMonFrontPic_OrbeetleMega),
        SPECIES_SPRITE(COALOSSAL_MEGA, gMonFrontPic_CoalossalMega),
        SPECIES_SPRITE(DREDNAW_MEGA, gMonFrontPic_DrednawMega),
        SPECIES_SPRITE(FLAPPLE_MEGA, gMonFrontPic_FlappleMega),
        SPECIES_SPRITE(SANDACONDA_MEGA, gMonFrontPic_SandacondaMega),
        SPECIES_SPRITE(TOXTRICITY_MEGA, gMonFrontPic_ToxtricityMega),
        SPECIES_SPRITE(CENTISKORCH_MEGA, gMonFrontPic_CentiskorchMega),
        SPECIES_SPRITE(HATTERENE_MEGA, gMonFrontPic_HattereneMega),
        SPECIES_SPRITE(GRIMMSNARL_MEGA, gMonFrontPic_GrimmsnarlMega),
        SPECIES_SPRITE(ALCREMIE_MEGA, gMonFrontPic_AlcremieMega),
        SPECIES_SPRITE(COPPERAJAH_MEGA, gMonFrontPic_CopperajahMega),
        SPECIES_SPRITE(SNORLAX_MEGA, gMonFrontPic_SnorlaxMega),
        ...
        SPECIES_SPRITE(STARAPTOR_MEGA, gMonFrontPic_StaraptorMega),
        ...
        SPECIES_SPRITE(GOLURK_MEGA, gMonFrontPic_GolurkMega),
        SPECIES_SPRITE(PYROAR_MEGA_M, gMonFrontPic_PyroarMegaM),
        SPECIES_SPRITE(PYROAR_MEGA_F, gMonFrontPic_PyroarMegaF),
        SPECIES_SPRITE(MEOWSTIC_MEGA, gMonFrontPic_MeowsticMega),
        SPECIES_SPRITE(MALAMAR_MEGA, gMonFrontPic_MalamarMega),
        SPECIES_SPRITE(BARBARACLE_MEGA, gMonFrontPic_BarbaracleMega),
        SPECIES_SPRITE(DRAGALGE_MEGA, gMonFrontPic_DragalgeMega),
        SPECIES_SPRITE(HAWLUCHA_MEGA, gMonFrontPic_HawluchaMega),
        SPECIES_SPRITE(CRABOMINABLE_MEGA, gMonFrontPic_CrabominableMega),
        SPECIES_SPRITE(GOLISOPOD_MEGA, gMonFrontPic_GolisopodMega),
        SPECIES_SPRITE(DRAMPA_MEGA, gMonFrontPic_DrampaMega),
        SPECIES_SPRITE(SCOVILLAIN_MEGA, gMonFrontPic_ScovillainMega),
        SPECIES_SPRITE(GLIMMORA_MEGA, gMonFrontPic_GlimmoraMega),
        SPECIES_SPRITE(TATSUGIRI_MEGA, gMonFrontPic_TatsugiriMega),
        SPECIES_SPRITE(BAXCALIBUR_MEGA, gMonFrontPic_BaxcaliburMega),
        ...
        SPECIES_SPRITE(ROTOM_SOUND, gMonFrontPic_RotomSound),
