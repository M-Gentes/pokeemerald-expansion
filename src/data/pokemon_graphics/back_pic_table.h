const struct CompressedSpriteSheet gMonBackPicTable[] =
    {
        ...
        SPECIES_SPRITE(SMASHBAG, gMonBackPic_Smashbag),
        SPECIES_SPRITE(CLAWHILL, gMonBackPic_Clawhill),
        SPECIES_SPRITE(MAGICORN, gMonBackPic_Magicorn),
        SPECIES_SPRITE(MAGICOAT, gMonBackPic_Magicoat),
        SPECIES_SPRITE(SWIRLHEAD, gMonBackPic_Swirlhead),
        SPECIES_SPRITE(TERRORKING, gMonBackPic_Terrorking),
        SPECIES_SPRITE(IRONBLOON, gMonBackPic_Ironbloon),
        SPECIES_SPRITE(IRONHUT, gMonBackPic_Ironhut),
        SPECIES_SPRITE(IRONTITAN, gMonBackPic_Irontitan),
        SPECIES_SPRITE(IRONWINGS, gMonBackPic_Ironwings),
        SPECIES_SPRITE(IRONWITCH, gMonBackPic_Ironwitch),

        SPECIES_SPRITE(BRUTEBONNET, gMonBackPic_Brutebonnet),
        SPECIES_SPRITE(GREATTUSK, gMonBackPic_Greattusk),
        SPECIES_SPRITE(SLITHERWING, gMonBackPic_Slitherwing),
        SPECIES_SPRITE(SCREAMTAIL, gMonBackPic_Screamtail),
        SPECIES_SPRITE(SANDYSHOCKS, gMonBackPic_Sandyshocks),
        SPECIES_SPRITE(FLUTTERMANE, gMonBackPic_Fluttermane),
        SPECIES_SPRITE(ROARINGMOON, gMonBackPic_Roaringmoon),
        SPECIES_SPRITE(IRONBUNDLE, gMonBackPic_Ironbundle),
        SPECIES_SPRITE(IRONHANDS, gMonBackPic_Ironhands),
        SPECIES_SPRITE(IRONJUGULIS, gMonBackPic_Ironjugulis),
        SPECIES_SPRITE(IRONMOTH, gMonBackPic_Ironmoth),
        SPECIES_SPRITE(IRONTHORNS, gMonBackPic_Ironthorns),
        SPECIES_SPRITE(IRONTREADS, gMonBackPic_Irontreads),
        SPECIES_SPRITE(IRONVALIANT, gMonBackPic_Ironvaliant),
        SPECIES_SPRITE(SPIRIGATITO, gMonBackPic_Spirigatito),
        SPECIES_SPRITE(FLORAGATO, gMonBackPic_Floragato),
        SPECIES_SPRITE(YUKAXATO, gMonBackPic_Yukaxato),
        SPECIES_SPRITE(FUECOCO, gMonBackPic_Fuecoco),
        SPECIES_SPRITE(CROCALOR, gMonBackPic_Crocalor),
        SPECIES_SPRITE(SPICABORO, gMonBackPic_Spicaboro),
        SPECIES_SPRITE(QUAXLY, gMonBackPic_Quaxly),
        SPECIES_SPRITE(QUAXWELL, gMonBackPic_Quaxwell),
        SPECIES_SPRITE(QUAXISTADOR, gMonBackPic_Quaxistador),
        ...
        SPECIES_SPRITE(CASTSTORM, gMonBackPic_Caststorm),
        SPECIES_SPRITE(BRYNXESS, gMonBackPic_Brynxess),
        SPECIES_SPRITE(APOKARGO, gMonBackPic_Apokargo),
        SPECIES_SPRITE(QUEZATU, gMonBackPic_Quezatu),
        SPECIES_SPRITE(RELICLIFFON, gMonBackPic_Relicliffon),
        SPECIES_SPRITE(DRACONEON, gMonBackPic_Draconeon),
        ...
        SPECIES_SPRITE(KECLILISK, gMonBackPic_Keclilisk),
        SPECIES_SPRITE(DHELVESSEL, gMonBackPic_Dhelvessel),
        SPECIES_SPRITE(SPIKEDASH, gMonBackPic_Spikedash),
        SPECIES_SPRITE(IRONWALKS, gMonBackPic_Ironwalks),
        SPECIES_SPRITE(LURINSKULL, gMonBackPic_Lurinskull),
        SPECIES_SPRITE(IRONSEEKER, gMonBackPic_Ironseeker),
        SPECIES_SPRITE(NOKAY, gMonBackPic_Nokay),
        SPECIES_SPRITE(IRONKNEEL, gMonBackPic_Ironkneel),
        SPECIES_SPRITE(VENOMFEAR, gMonBackPic_Venomfear),
        ...
        SPECIES_SPRITE(IRONFUSE, gMonBackPic_Ironfuse),
        SPECIES_SPRITE(ABYSSCLAW, gMonBackPic_Abyssclaw),
        SPECIES_SPRITE(IRONSUB, gMonBackPic_Ironsub),
        SPECIES_SPRITE(CINDEROOT, gMonBackPic_Cinderoot),
        SPECIES_SPRITE(IRONPLASMA, gMonBackPic_Ironplasma),
        SPECIES_SPRITE(GLACIARMOR, gMonBackPic_Glaciarmor),
        SPECIES_SPRITE(IRONWAVES, gMonBackPic_Ironwaves),
        SPECIES_SPRITE(SUMMONCIRCLE, gMonBackPic_Summoncircle),
        SPECIES_SPRITE(IRONGATE, gMonBackPic_Irongate),
        SPECIES_SPRITE(CUBEPUNCH, gMonBackPic_Cubepunch),
        SPECIES_SPRITE(IRONVISION, gMonBackPic_Ironvision),
        SPECIES_SPRITE(BARKJAM, gMonBackPic_Barkjam),
        SPECIES_SPRITE(IRONBUZZ, gMonBackPic_Ironbuzz),
        SPECIES_SPRITE(FLOATINHUNT, gMonBackPic_Floatinhunt),
        SPECIES_SPRITE(IRONROCKET, gMonBackPic_Ironrocket),
        SPECIES_SPRITE(PLEASODOR, gMonBackPic_Pleasodor),
        SPECIES_SPRITE(IRONSPRAY, gMonBackPic_Ironspray),
        SPECIES_SPRITE(SANESECT, gMonBackPic_Sanesect),
        SPECIES_SPRITE(IRONFECTION, gMonBackPic_Ironfection),
        SPECIES_SPRITE(INFINAGA, gMonBackPic_Infinaga),
        SPECIES_SPRITE(IRONFAN, gMonBackPic_Ironfan),
        SPECIES_SPRITE(TOXSPITTLE, gMonBackPic_Toxspittle),
        SPECIES_SPRITE(IRONSAT, gMonBackPic_Ironsat),
        SPECIES_SPRITE(CRAWLFANG, gMonBackPic_Crawlfang),
        SPECIES_SPRITE(IRONBOOM, gMonBackPic_Ironboom),
        SPECIES_SPRITE(SEALSTONE, gMonBackPic_Sealstone),
        SPECIES_SPRITE(IRONSABER, gMonBackPic_Ironsaber),
        SPECIES_SPRITE(GLIDEBURN, gMonBackPic_Glideburn),
        SPECIES_SPRITE(IRONCUBATOR, gMonBackPic_Ironcubator),
        SPECIES_SPRITE(RAPIDASH_MEGA, gMonBackPic_RapidashMega),
        SPECIES_SPRITE(MIGHTYENA_MEGA, gMonBackPic_MightyenaMega),
        SPECIES_SPRITE(DRIFBLIM_MEGA, gMonBackPic_DrifblimMega),
        SPECIES_SPRITE(VANILLUXE_MEGA, gMonBackPic_VanilluxeMega),
        SPECIES_SPRITE(FORRETRESS_MEGA, gMonBackPic_ForretressMega),
        SPECIES_SPRITE(BOLTUND_MEGA, gMonBackPic_BoltundMega),
        SPECIES_SPRITE(SWALOT_MEGA, gMonBackPic_SwalotMega),
        SPECIES_SPRITE(SLOWKING_MEGA, gMonBackPic_SlowkingMega),
        SPECIES_SPRITE(SEAKING_MEGA, gMonBackPic_SeakingMega),
        SPECIES_SPRITE(LEDIAN_MEGA, gMonBackPic_LedianMega),
        SPECIES_SPRITE(ARBOK_MEGA, gMonBackPic_ArbokMega),
        SPECIES_SPRITE(SMEARGLE_MEGA, gMonBackPic_SmeargleMega),
        SPECIES_SPRITE(REVAVROOM_MEGA, gMonBackPic_RevavroomMega),
        SPECIES_SPRITE(KLEFKI_MEGA, gMonBackPic_KlefkiMega),
        SPECIES_SPRITE(PINCURCHIN_MEGA, gMonBackPic_PincurchinMega),
        SPECIES_SPRITE(TURTONATOR_MEGA, gMonBackPic_TurtonatorMega),
        SPECIES_SPRITE(THIEVUL_MEGA, gMonBackPic_ThievulMega),
        SPECIES_SPRITE(TOUCANNON_MEGA, gMonBackPic_ToucannonMega),
        SPECIES_SPRITE(YANMEGA_MEGA, gMonBackPic_YanmegaMega),
        SPECIES_SPRITE(LIEPARD_MEGA, gMonBackPic_LiepardMega),
        SPECIES_SPRITE(KLINKLANG_MEGA, gMonBackPic_KlinklangMega),
        SPECIES_SPRITE(HONCHKROW_MEGA, gMonBackPic_HonchkrowMega),
        SPECIES_SPRITE(GOLDUCK_MEGA, gMonBackPic_GolduckMega),
        SPECIES_SPRITE(ROSERADE_MEGA, gMonBackPic_RoseradeMega),
        SPECIES_SPRITE(SIGILYPH_MEGA, gMonBackPic_SigilyphMega),
        SPECIES_SPRITE(MANTINE_MEGA, gMonBackPic_MantineMega),
        SPECIES_SPRITE(BIDOOF_MEGA, gMonBackPic_BidoofMega),
        ...
        SPECIES_SPRITE(MARACTUS_MEGA, gMonBackPic_MaractusMega),
        SPECIES_SPRITE(WHISCASH_MEGA, gMonBackPic_WhiscashMega),
        SPECIES_SPRITE(SHUCKLE_MEGA, gMonBackPic_ShuckleMega),
        SPECIES_SPRITE(PARASECT_MEGA, gMonBackPic_ParasectMega),
        SPECIES_SPRITE(RABSCA_MEGA, gMonBackPic_RabscaMega),
        SPECIES_SPRITE(SPIDOPS_MEGA, gMonBackPic_SpidopsMega),
        SPECIES_SPRITE(KRICKETUNE_MEGA, gMonBackPic_KricketuneMega),
        SPECIES_SPRITE(VENOMOTH_MEGA, gMonBackPic_VenomothMega),
        ...
        SPECIES_SPRITE(FLAPPLE_MEGA, gMonBackPic_FlappleMega),
        ...
        SPECIES_SPRITE(PYROAR_MEGA_M, gMonBackPic_PyroarMegaM),
        SPECIES_SPRITE(PYROAR_MEGA_F, gMonBackPic_PyroarMegaF),
        ...
        SPECIES_SPRITE(ROTOM_SOUND, gMonBackPic_RotomSound),
