const struct CompressedSpritePalette gMonPaletteTable[] =
    {
...
#endif
        SPECIES_PAL(SMASHBAG, gMonPalette_Smashbag),
        SPECIES_PAL(CLAWHILL, gMonPalette_Clawhill),
        SPECIES_PAL(MAGICORN, gMonPalette_Magicorn),
        SPECIES_PAL(MAGICOAT, gMonPalette_Magicoat),
        SPECIES_PAL(SWIRLHEAD, gMonPalette_Swirlhead),
        SPECIES_PAL(TERRORKING, gMonPalette_Terrorking),
        SPECIES_PAL(IRONBLOON, gMonPalette_Ironbloon),
        SPECIES_PAL(IRONHUT, gMonPalette_Ironhut),
        SPECIES_PAL(IRONTITAN, gMonPalette_Irontitan),
        SPECIES_PAL(IRONWINGS, gMonPalette_Ironwings),
        SPECIES_PAL(IRONWITCH, gMonPalette_Ironwitch),
        SPECIES_PAL(BRUTEBONNET, gMonPalette_Brutebonnet),
        SPECIES_PAL(GREATTUSK, gMonPalette_Greattusk),
        SPECIES_PAL(SLITHERWING, gMonPalette_Slitherwing),
        SPECIES_PAL(SCREAMTAIL, gMonPalette_Screamtail),
        SPECIES_PAL(SANDYSHOCKS, gMonPalette_Sandyshocks),
        SPECIES_PAL(FLUTTERMANE, gMonPalette_Fluttermane),
        SPECIES_PAL(ROARINGMOON, gMonPalette_Roaringmoon),
        SPECIES_PAL(IRONBUNDLE, gMonPalette_Ironbundle),
        SPECIES_PAL(IRONHANDS, gMonPalette_Ironhands),
        SPECIES_PAL(IRONJUGULIS, gMonPalette_Ironjugulis),
        ...
        SPECIES_PAL(IRONVALIANT, gMonPalette_Ironvaliant),
        SPECIES_PAL(SPIRIGATITO, gMonPalette_Spirigatito),
        SPECIES_PAL(FLORAGATO, gMonPalette_Floragato),
        SPECIES_PAL(YUKAXATO, gMonPalette_Yukaxato),
        SPECIES_PAL(FUECOCO, gMonPalette_Fuecoco),
        SPECIES_PAL(CROCALOR, gMonPalette_Crocalor),
        SPECIES_PAL(SPICABORO, gMonPalette_Spicaboro),
        SPECIES_PAL(QUAXLY, gMonPalette_Quaxly),
        SPECIES_PAL(QUAXWELL, gMonPalette_Quaxwell),
        SPECIES_PAL(QUAXISTADOR, gMonPalette_Quaxistador),
        ...
        SPECIES_PAL(CASTSTORM, gMonPalette_Caststorm),
        SPECIES_PAL(BRYNXESS, gMonPalette_Brynxess),
        SPECIES_PAL(APOKARGO, gMonPalette_Apokargo),
        SPECIES_PAL(QUEZATU, gMonPalette_Quezatu),
        SPECIES_PAL(RELICLIFFON, gMonPalette_Relicliffon),
        SPECIES_PAL(DRACONEON, gMonPalette_Draconeon),
        ...
        SPECIES_PAL(LUXRAY_MEGA, gMonPalette_LuxrayMega),
        SPECIES_PAL(BUTTERFREE_MEGA, gMonPalette_ButterfreeMega),
        SPECIES_PAL(FEAROW_MEGA, gMonPalette_FearowMega),
        SPECIES_PAL(MACHAMP_MEGA, gMonPalette_MachampMega),
        SPECIES_PAL(GOLEM_MEGA, gMonPalette_GolemMega),
        SPECIES_PAL(NOCTOWL_MEGA, gMonPalette_NoctowlMega),
        SPECIES_PAL(KINGDRA_MEGA, gMonPalette_KingdraMega),
        SPECIES_PAL(CHIMECHO_MEGA, gMonPalette_ChimechoMega),
        SPECIES_PAL(WAILORD_MEGA, gMonPalette_WailordMega),
        SPECIES_PAL(CHESNAUGHT_MEGA, gMonPalette_ChesnaughtMega),
        SPECIES_PAL(DELPHOX_MEGA, gMonPalette_DelphoxMega),
        SPECIES_PAL(PALOSSAND_MEGA, gMonPalette_PalossandMega),
        SPECIES_PAL(FALINKS_MEGA, gMonPalette_FalinksMega),
        SPECIES_PAL(ECLIMINARY, gMonPalette_Ecliminary),
        SPECIES_PAL(PUMPKING, gMonPalette_Pumpking),
        ...
        SPECIES_PAL(KECLILISK, gMonPalette_Keclilisk),
        SPECIES_PAL(DHELVESSEL, gMonPalette_Dhelvessel),
        SPECIES_PAL(SPIKEDASH, gMonPalette_Spikedash),
        SPECIES_PAL(IRONWALKS, gMonPalette_Ironwalks),
        SPECIES_PAL(LURINSKULL, gMonPalette_Lurinskull),
        SPECIES_PAL(IRONSEEKER, gMonPalette_Ironseeker),
        SPECIES_PAL(NOKAY, gMonPalette_Nokay),
        SPECIES_PAL(IRONKNEEL, gMonPalette_Ironkneel),
        SPECIES_PAL(VENOMFEAR, gMonPalette_Venomfear),
        ...
        SPECIES_PAL(IRONFUSE, gMonPalette_Ironfuse),
        SPECIES_PAL(ABYSSCLAW, gMonPalette_Abyssclaw),
        SPECIES_PAL(IRONSUB, gMonPalette_Ironsub),
        SPECIES_PAL(CINDEROOT, gMonPalette_Cinderoot),
        SPECIES_PAL(IRONPLASMA, gMonPalette_Ironplasma),
        SPECIES_PAL(GLACIARMOR, gMonPalette_Glaciarmor),
        SPECIES_PAL(IRONWAVES, gMonPalette_Ironwaves),
        SPECIES_PAL(SUMMONCIRCLE, gMonPalette_Summoncircle),
        SPECIES_PAL(IRONGATE, gMonPalette_Irongate),
        SPECIES_PAL(CUBEPUNCH, gMonPalette_Cubepunch),
        SPECIES_PAL(IRONVISION, gMonPalette_Ironvision),
        SPECIES_PAL(BARKJAM, gMonPalette_Barkjam),
        SPECIES_PAL(IRONBUZZ, gMonPalette_Ironbuzz),
        SPECIES_PAL(FLOATINHUNT, gMonPalette_Floatinhunt),
        SPECIES_PAL(IRONROCKET, gMonPalette_Ironrocket),
        SPECIES_PAL(PLEASODOR, gMonPalette_Pleasodor),
        SPECIES_PAL(IRONSPRAY, gMonPalette_Ironspray),
        SPECIES_PAL(SANESECT, gMonPalette_Sanesect),
        SPECIES_PAL(IRONFECTION, gMonPalette_Ironfection),
        SPECIES_PAL(INFINAGA, gMonPalette_Infinaga),
        SPECIES_PAL(IRONFAN, gMonPalette_Ironfan),
        SPECIES_PAL(TOXSPITTLE, gMonPalette_Toxspittle),
        SPECIES_PAL(IRONSAT, gMonPalette_Ironsat),
        SPECIES_PAL(CRAWLFANG, gMonPalette_Crawlfang),
        SPECIES_PAL(IRONBOOM, gMonPalette_Ironboom),
        SPECIES_PAL(SEALSTONE, gMonPalette_Sealstone),
        SPECIES_PAL(IRONSABER, gMonPalette_Ironsaber),
        SPECIES_PAL(GLIDEBURN, gMonPalette_Glideburn),
        SPECIES_PAL(IRONCUBATOR, gMonPalette_Ironcubator),
        SPECIES_PAL(RAPIDASH_MEGA, gMonPalette_RapidashMega),
        SPECIES_PAL(MIGHTYENA_MEGA, gMonPalette_MightyenaMega),
        SPECIES_PAL(DRIFBLIM_MEGA, gMonPalette_DrifblimMega),
        SPECIES_PAL(VANILLUXE_MEGA, gMonPalette_VanilluxeMega),
        SPECIES_PAL(FORRETRESS_MEGA, gMonPalette_ForretressMega),
        SPECIES_PAL(BOLTUND_MEGA, gMonPalette_BoltundMega),
        SPECIES_PAL(SWALOT_MEGA, gMonPalette_SwalotMega),
        SPECIES_PAL(SLOWKING_MEGA, gMonPalette_SlowkingMega),
        SPECIES_PAL(SEAKING_MEGA, gMonPalette_SeakingMega),
        SPECIES_PAL(LEDIAN_MEGA, gMonPalette_LedianMega),
        SPECIES_PAL(ARBOK_MEGA, gMonPalette_ArbokMega),
        SPECIES_PAL(SMEARGLE_MEGA, gMonPalette_SmeargleMega),
        SPECIES_PAL(REVAVROOM_MEGA, gMonPalette_RevavroomMega),
        SPECIES_PAL(KLEFKI_MEGA, gMonPalette_KlefkiMega),
        SPECIES_PAL(PINCURCHIN_MEGA, gMonPalette_PincurchinMega),
        SPECIES_PAL(TURTONATOR_MEGA, gMonPalette_TurtonatorMega),
        SPECIES_PAL(THIEVUL_MEGA, gMonPalette_ThievulMega),
        SPECIES_PAL(TOUCANNON_MEGA, gMonPalette_ToucannonMega),
        SPECIES_PAL(YANMEGA_MEGA, gMonPalette_YanmegaMega),
        SPECIES_PAL(LIEPARD_MEGA, gMonPalette_LiepardMega),
        SPECIES_PAL(KLINKLANG_MEGA, gMonPalette_KlinklangMega),
        SPECIES_PAL(HONCHKROW_MEGA, gMonPalette_HonchkrowMega),
        SPECIES_PAL(GOLDUCK_MEGA, gMonPalette_GolduckMega),
        SPECIES_PAL(ROSERADE_MEGA, gMonPalette_RoseradeMega),
        SPECIES_PAL(SIGILYPH_MEGA, gMonPalette_SigilyphMega),
        SPECIES_PAL(MANTINE_MEGA, gMonPalette_MantineMega),
        SPECIES_PAL(BIDOOF_MEGA, gMonPalette_BidoofMega),
        ...
        SPECIES_PAL(MARACTUS_MEGA, gMonPalette_MaractusMega),
        SPECIES_PAL(WHISCASH_MEGA, gMonPalette_WhiscashMega),
        SPECIES_PAL(SHUCKLE_MEGA, gMonPalette_ShuckleMega),
        SPECIES_PAL(PARASECT_MEGA, gMonPalette_ParasectMega),
        SPECIES_PAL(RABSCA_MEGA, gMonPalette_RabscaMega),
        SPECIES_PAL(SPIDOPS_MEGA, gMonPalette_SpidopsMega),
        SPECIES_PAL(KRICKETUNE_MEGA, gMonPalette_KricketuneMega),
        SPECIES_PAL(VENOMOTH_MEGA, gMonPalette_VenomothMega),
        SPECIES_PAL(MEGANIUM_MEGA, gMonPalette_MeganiumMega),
        SPECIES_PAL(FERALIGATR_MEGA, gMonPalette_FeraligatrMega),
        SPECIES_PAL(TORTERRA_MEGA, gMonPalette_TorterraMega),
        SPECIES_PAL(INFERNAPE_MEGA, gMonPalette_InfernapeMega),
        SPECIES_PAL(EMPOLEON_MEGA, gMonPalette_EmpoleonMega),
        SPECIES_PAL(SERPERIOR_MEGA, gMonPalette_SerperiorMega),
        ...
        SPECIES_PAL(RILLABOOM_MEGA, gMonPalette_RillaboomMega),
        SPECIES_PAL(CINDERACE_MEGA, gMonPalette_CinderaceMega),
        SPECIES_PAL(INTELEON_MEGA, gMonPalette_InteleonMega),
        ...
        SPECIES_PAL(GARBODOR_MEGA, gMonPalette_GarbodorMega),
        SPECIES_PAL(CORVIKNIGHT_MEGA, gMonPalette_CorviknightMega),
        SPECIES_PAL(ORBEETLE_MEGA, gMonPalette_OrbeetleMega),
        SPECIES_PAL(COALOSSAL_MEGA, gMonPalette_CoalossalMega),
        SPECIES_PAL(DREDNAW_MEGA, gMonPalette_DrednawMega),
        SPECIES_PAL(FLAPPLE_MEGA, gMonPalette_FlappleMega),
        SPECIES_PAL(SANDACONDA_MEGA, gMonPalette_SandacondaMega),
        SPECIES_PAL(TOXTRICITY_MEGA, gMonPalette_ToxtricityMega),
        SPECIES_PAL(CENTISKORCH_MEGA, gMonPalette_CentiskorchMega),
        SPECIES_PAL(HATTERENE_MEGA, gMonPalette_HattereneMega),
        ...
        SPECIES_PAL(SKARMORY_MEGA, gMonPalette_SkarmoryMega),
        SPECIES_PAL(STARAPTOR_MEGA, gMonPalette_StaraptorMega),
        SPECIES_PAL(FROSLASS_MEGA, gMonPalette_FroslassMega),
        SPECIES_PAL(EXCADRILL_MEGA, gMonPalette_ExcadrillMega),
        SPECIES_PAL(SCOLIPEDE_MEGA, gMonPalette_ScolipedeMega),
        SPECIES_PAL(SCRAFTY_MEGA, gMonPalette_ScraftyMega),
        SPECIES_PAL(EELEKTROSS_MEGA, gMonPalette_EelektrossMega),
        SPECIES_PAL(CHANDELURE_MEGA, gMonPalette_ChandelureMega),
        SPECIES_PAL(GOLURK_MEGA, gMonPalette_GolurkMega),
        SPECIES_PAL(PYROAR_MEGA_M, gMonPalette_PyroarMegaM),
        SPECIES_PAL(PYROAR_MEGA_F, gMonPalette_PyroarMegaF),
        SPECIES_PAL(MEOWSTIC_MEGA, gMonPalette_MeowsticMega),
        SPECIES_PAL(MALAMAR_MEGA, gMonPalette_MalamarMega),
        SPECIES_PAL(BARBARACLE_MEGA, gMonPalette_BarbaracleMega),
        SPECIES_PAL(DRAGALGE_MEGA, gMonPalette_DragalgeMega),
        SPECIES_PAL(HAWLUCHA_MEGA, gMonPalette_HawluchaMega),
        SPECIES_PAL(CRABOMINABLE_MEGA, gMonPalette_CrabominableMega),
        SPECIES_PAL(GOLISOPOD_MEGA, gMonPalette_GolisopodMega),
        SPECIES_PAL(DRAMPA_MEGA, gMonPalette_DrampaMega),
