...
const u8 gEnemyMonElevation[NUM_SPECIES] =
    {
        ...
        [SPECIES_SINISTCHA] = 3,
        [SPECIES_IRONPANEL] = 3,
        [SPECIES_IRONPLASMA] = 3,
        [SPECIES_IRONWAVES] = 3,
        [SPECIES_IRONROCKET] = 3,
        [SPECIES_INFINAGA] = 5,
        [SPECIES_IRONFAN] = 5,
        [SPECIES_IRONSAT] = 2,
        [SPECIES_IRONSABER] = 5,
        [SPECIES_RAPIDASH_MEGA] = 5,
        [SPECIES_DRIFBLIM_MEGA] = 5,
        [SPECIES_LEDIAN_MEGA] = 3,
        [SPECIES_KLEFKI_MEGA] = 3,
        [SPECIES_YANMEGA_MEGA] = 3,
        [SPECIES_KLINKLANG_MEGA] = 5,
        [SPECIES_SIGILYPH_MEGA] = 5,
        [SPECIES_MANTINE_MEGA] = 5,
        [SPECIES_PORYGON_Z_MEGA] = 5,
        [SPECIES_CLEFABLE_MEGA] = 5,
        [SPECIES_SKARMORY_MEGA] = 5,
        [SPECIES_EELEKTROSS_MEGA] = 3,
        [SPECIES_CHANDELURE_MEGA] = 10,
        [SPECIES_PYROAR_MEGA_M] = 5,
        [SPECIES_MEOWSTIC_MEGA] = 5,
        [SPECIES_MALAMAR_MEGA] = 5,
};
