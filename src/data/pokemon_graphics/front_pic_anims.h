...
SINGLE_ANIMATION(FORRETRESS_MEGA);
SINGLE_ANIMATION(BOLTUND_MEGA);
SINGLE_ANIMATION(SWALOT_MEGA);
SINGLE_ANIMATION(SLOWKING_MEGA);
SINGLE_ANIMATION(SEAKING_MEGA);
...
SINGLE_ANIMATION(PORYGON_Z_MEGA);
