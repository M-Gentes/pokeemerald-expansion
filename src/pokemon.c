...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
    {
        ...
        [SPECIES_PORYGON_Z_MEGA - 1] = NATIONAL_DEX_PORYGONZ,
        ...
        [SPECIES_MEOWSCARADA_MEGA - 1] = NATIONAL_DEX_MEOWSCARADA,
        [SPECIES_SKELEDIRGE_MEGA - 1] = NATIONAL_DEX_SKELEDIRGE,
        [SPECIES_QUAQUAVAL_MEGA - 1] = NATIONAL_DEX_QUAQUAVAL,
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
    {
        ...
        [SPECIES_TATSUGIRI - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_CLODSIRE - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_SINISTCHA - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_ARCHALUDON - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_HYDRAPPLE - 1] = ANIM_GROW_IN_STAGES,

        [SPECIES_KECLILISK - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_DHELVESSEL - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_LURINSKULL - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONSEEKER - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_NOKAY - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONKNEEL - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_VENOMFEAR - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONSTING - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_SLENDERSUN - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONPANEL - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_DREADBOULD - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONHOLE - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_ARCHMUSSEL - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONPUMP - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_STEAMOUNT - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONFUSE - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_ABYSSCLAW - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONSUB - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_CINDEROOT - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONPLASMA - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_GLACIARMOR - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONWAVES - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_SUMMONCIRCLE - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONGATE - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_CUBEPUNCH - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONVISION - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_BARKJAM - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONBUZZ - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_FLOATINHUNT - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONROCKET - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_PLEASODOR - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONSPRAY - 1] = ANIM_GROW_IN_STAGES,
