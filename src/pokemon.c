...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
    {
        ...
        [SPECIES_INFINAGA - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONFAN - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_TOXSPITTLE - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONSAT - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_CRAWLFANG - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONBOOM - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_SEALSTONE - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONSABER - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_GLIDEBURN - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONCUBATOR - 1] = ANIM_GROW_IN_STAGES,
