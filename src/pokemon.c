...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
    {
        ...
        SPECIES_TO_HOENN(SMASHBAG),
        SPECIES_TO_HOENN(CLAWHILL),
        SPECIES_TO_HOENN(MAGICORN),
        SPECIES_TO_HOENN(MAGICOAT),
        SPECIES_TO_HOENN(SWIRLHEAD),
        SPECIES_TO_HOENN(TERRORKING),
        SPECIES_TO_HOENN(IRONBLOON),
        SPECIES_TO_HOENN(IRONHUT),
        SPECIES_TO_HOENN(IRONTITAN),
        SPECIES_TO_HOENN(IRONWINGS),
        SPECIES_TO_HOENN(IRONWITCH),
        SPECIES_TO_HOENN(BRUTEBONNET),
        SPECIES_TO_HOENN(GREATTUSK),
        SPECIES_TO_HOENN(SLITHERWING),
        SPECIES_TO_HOENN(SCREAMTAIL),
        SPECIES_TO_HOENN(SANDYSHOCKS),
        SPECIES_TO_HOENN(FLUTTERMANE),
        SPECIES_TO_HOENN(ROARINGMOON),
        SPECIES_TO_HOENN(IRONBUNDLE),
        SPECIES_TO_HOENN(IRONHANDS),
        SPECIES_TO_HOENN(IRONJUGULIS),
        SPECIES_TO_HOENN(IRONMOTH),
        SPECIES_TO_HOENN(IRONTHORNS),
        SPECIES_TO_HOENN(IRONTREADS),
        SPECIES_TO_HOENN(IRONVALIANT),
        SPECIES_TO_HOENN(SPIRIGATITO),
        SPECIES_TO_HOENN(FLORAGATO),
        SPECIES_TO_HOENN(YUKAXATO),
        SPECIES_TO_HOENN(FUECOCO),
        SPECIES_TO_HOENN(CROCALOR),
        SPECIES_TO_HOENN(SPICABORO),
        SPECIES_TO_HOENN(QUAXLY),
        SPECIES_TO_HOENN(QUAXWELL),
        SPECIES_TO_HOENN(QUAXISTADOR),
        ...
        SPECIES_TO_HOENN(BRYNXESS),
        SPECIES_TO_HOENN(APOKARGO),
        SPECIES_TO_HOENN(QUEZATU),
        SPECIES_TO_HOENN(RELICLIFFON),
        SPECIES_TO_HOENN(DRACONEON),
        SPECIES_TO_HOENN(MERAKI),
        SPECIES_TO_HOENN(KAGECOON),
        SPECIES_TO_HOENN(TANDAYU),
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
    {
...
#endif
        SPECIES_TO_NATIONAL(SMASHBAG),
        SPECIES_TO_NATIONAL(CLAWHILL),
        SPECIES_TO_NATIONAL(MAGICORN),
        SPECIES_TO_NATIONAL(MAGICOAT),
        SPECIES_TO_NATIONAL(SWIRLHEAD),
        SPECIES_TO_NATIONAL(TERRORKING),
        SPECIES_TO_NATIONAL(IRONBLOON),
        SPECIES_TO_NATIONAL(IRONHUT),
        SPECIES_TO_NATIONAL(IRONTITAN),
        SPECIES_TO_NATIONAL(IRONWINGS),
        SPECIES_TO_NATIONAL(IRONWITCH),
        SPECIES_TO_NATIONAL(BRUTEBONNET),
        SPECIES_TO_NATIONAL(GREATTUSK),
        SPECIES_TO_NATIONAL(SLITHERWING),
        SPECIES_TO_NATIONAL(SCREAMTAIL),
        SPECIES_TO_NATIONAL(SANDYSHOCKS),
        SPECIES_TO_NATIONAL(FLUTTERMANE),
        SPECIES_TO_NATIONAL(ROARINGMOON),
        SPECIES_TO_NATIONAL(IRONBUNDLE),
        SPECIES_TO_NATIONAL(IRONHANDS),
        SPECIES_TO_NATIONAL(IRONJUGULIS),
        SPECIES_TO_NATIONAL(IRONMOTH),
        SPECIES_TO_NATIONAL(IRONTHORNS),
        SPECIES_TO_NATIONAL(IRONTREADS),
        SPECIES_TO_NATIONAL(IRONVALIANT),
        SPECIES_TO_NATIONAL(SPIRIGATITO),
        SPECIES_TO_NATIONAL(FLORAGATO),
        SPECIES_TO_NATIONAL(YUKAXATO),
        SPECIES_TO_NATIONAL(FUECOCO),
        SPECIES_TO_NATIONAL(CROCALOR),
        SPECIES_TO_NATIONAL(SPICABORO),
        SPECIES_TO_NATIONAL(QUAXLY),
        SPECIES_TO_NATIONAL(QUAXWELL),
        SPECIES_TO_NATIONAL(QUAXISTADOR),
        ...
        SPECIES_TO_NATIONAL(BRYNXESS),
        SPECIES_TO_NATIONAL(APOKARGO),
        SPECIES_TO_NATIONAL(QUEZATU),
        SPECIES_TO_NATIONAL(RELICLIFFON),
        SPECIES_TO_NATIONAL(DRACONEON),
        SPECIES_TO_NATIONAL(MERAKI),
        SPECIES_TO_NATIONAL(KAGECOON),
        SPECIES_TO_NATIONAL(TANDAYU),
        ...
        SPECIES_TO_NATIONAL(KECLILISK),
        SPECIES_TO_NATIONAL(DHELVESSEL),
        SPECIES_TO_NATIONAL(SPIKEDASH),
        SPECIES_TO_NATIONAL(IRONWALKS),
        SPECIES_TO_NATIONAL(LURINSKULL),
        SPECIES_TO_NATIONAL(IRONSEEKER),
        SPECIES_TO_NATIONAL(NOKAY),
        SPECIES_TO_NATIONAL(IRONKNEEL),
        SPECIES_TO_NATIONAL(VENOMFEAR),
        SPECIES_TO_NATIONAL(IRONSTING),
        SPECIES_TO_NATIONAL(SLENDERSUN),
        SPECIES_TO_NATIONAL(IRONPANEL),
        SPECIES_TO_NATIONAL(DREADBOULD),
        SPECIES_TO_NATIONAL(IRONHOLE),
        SPECIES_TO_NATIONAL(ARCHMUSSEL),
        SPECIES_TO_NATIONAL(IRONPUMP),
        SPECIES_TO_NATIONAL(STEAMOUNT),
        SPECIES_TO_NATIONAL(IRONFUSE),
        SPECIES_TO_NATIONAL(ABYSSCLAW),
        SPECIES_TO_NATIONAL(IRONSUB),
        SPECIES_TO_NATIONAL(CINDEROOT),
        SPECIES_TO_NATIONAL(IRONPLASMA),
        SPECIES_TO_NATIONAL(GLACIARMOR),
        SPECIES_TO_NATIONAL(IRONWAVES),
        SPECIES_TO_NATIONAL(SUMMONCIRCLE),
        SPECIES_TO_NATIONAL(IRONGATE),
        SPECIES_TO_NATIONAL(CUBEPUNCH),
        SPECIES_TO_NATIONAL(IRONVISION),
        SPECIES_TO_NATIONAL(BARKJAM),
        SPECIES_TO_NATIONAL(IRONBUZZ),
        SPECIES_TO_NATIONAL(FLOATINHUNT),
        SPECIES_TO_NATIONAL(IRONROCKET),
        SPECIES_TO_NATIONAL(PLEASODOR),
        SPECIES_TO_NATIONAL(IRONSPRAY),
        SPECIES_TO_NATIONAL(SANESECT),
        SPECIES_TO_NATIONAL(IRONFECTION),
        SPECIES_TO_NATIONAL(INFINAGA),
        SPECIES_TO_NATIONAL(IRONFAN),
        SPECIES_TO_NATIONAL(TOXSPITTLE),
        SPECIES_TO_NATIONAL(IRONSAT),
        SPECIES_TO_NATIONAL(CRAWLFANG),
        SPECIES_TO_NATIONAL(IRONBOOM),
        SPECIES_TO_NATIONAL(SEALSTONE),
        SPECIES_TO_NATIONAL(IRONSABER),
        SPECIES_TO_NATIONAL(GLIDEBURN),
        SPECIES_TO_NATIONAL(IRONCUBATOR),
        ...
        [SPECIES_TENTACRUEL_MEGA - 1] = NATIONAL_DEX_TENTACRUEL,
        ...
        [SPECIES_FEAROW_MEGA - 1] = NATIONAL_DEX_FEAROW,
        [SPECIES_MACHAMP_MEGA - 1] = NATIONAL_DEX_MACHAMP,
        [SPECIES_GOLEM_MEGA - 1] = NATIONAL_DEX_GOLEM,
        [SPECIES_NOCTOWL_MEGA - 1] = NATIONAL_DEX_NOCTOWL,
        [SPECIES_KINGDRA_MEGA - 1] = NATIONAL_DEX_KINGDRA,
        [SPECIES_CHIMECHO_MEGA - 1] = NATIONAL_DEX_CHIMECHO,
        [SPECIES_WAILORD_MEGA - 1] = NATIONAL_DEX_WAILORD,
        [SPECIES_CHESNAUGHT_MEGA - 1] = NATIONAL_DEX_CHESNAUGHT,
        [SPECIES_DELPHOX_MEGA - 1] = NATIONAL_DEX_DELPHOX,
        [SPECIES_PALOSSAND_MEGA - 1] = NATIONAL_DEX_PALOSSAND,
        [SPECIES_FALINKS_MEGA - 1] = NATIONAL_DEX_FALINKS,
        [SPECIES_ECLIMINARY - 1] = NATIONAL_DEX_SOLROCK,
        [SPECIES_PUMPKING - 1] = NATIONAL_DEX_TREVENANT,
        [SPECIES_RAPIDASH_MEGA - 1] = NATIONAL_DEX_RAPIDASH,
        [SPECIES_MIGHTYENA_MEGA - 1] = NATIONAL_DEX_MIGHTYENA,
        [SPECIES_DRIFBLIM_MEGA - 1] = NATIONAL_DEX_DRIFBLIM,
        [SPECIES_VANILLUXE_MEGA - 1] = NATIONAL_DEX_VANILLUXE,
        [SPECIES_FORRETRESS_MEGA - 1] = NATIONAL_DEX_FORRETRESS,
        [SPECIES_BOLTUND_MEGA - 1] = NATIONAL_DEX_BOLTUND,
        [SPECIES_SWALOT_MEGA - 1] = NATIONAL_DEX_SWALOT,
        [SPECIES_SLOWKING_MEGA - 1] = NATIONAL_DEX_SLOWKING,
        [SPECIES_SEAKING_MEGA - 1] = NATIONAL_DEX_SEAKING,
        [SPECIES_LEDIAN_MEGA - 1] = NATIONAL_DEX_LEDIAN,
        [SPECIES_ARBOK_MEGA - 1] = NATIONAL_DEX_ARBOK,
        [SPECIES_SMEARGLE_MEGA - 1] = NATIONAL_DEX_SMEARGLE,
        [SPECIES_REVAVROOM_MEGA - 1] = NATIONAL_DEX_REVAVROOM,
        [SPECIES_KLEFKI_MEGA - 1] = NATIONAL_DEX_KLEFKI,
        [SPECIES_PINCURCHIN_MEGA - 1] = NATIONAL_DEX_PINCURCHIN,
        [SPECIES_TURTONATOR_MEGA - 1] = NATIONAL_DEX_TURTONATOR,
        [SPECIES_THIEVUL_MEGA - 1] = NATIONAL_DEX_THIEVUL,
        [SPECIES_TOUCANNON_MEGA - 1] = NATIONAL_DEX_TOUCANNON,
        [SPECIES_YANMEGA_MEGA - 1] = NATIONAL_DEX_YANMEGA,
        [SPECIES_LIEPARD_MEGA - 1] = NATIONAL_DEX_LIEPARD,
        [SPECIES_KLINKLANG_MEGA - 1] = NATIONAL_DEX_KLINKLANG,
        [SPECIES_HONCHKROW_MEGA - 1] = NATIONAL_DEX_HONCHKROW,
        [SPECIES_GOLDUCK_MEGA - 1] = NATIONAL_DEX_GOLDUCK,
        [SPECIES_ROSERADE_MEGA - 1] = NATIONAL_DEX_ROSERADE,
        [SPECIES_SIGILYPH_MEGA - 1] = NATIONAL_DEX_SIGILYPH,
        [SPECIES_MANTINE_MEGA - 1] = NATIONAL_DEX_MANTINE,
        [SPECIES_BIDOOF_MEGA - 1] = NATIONAL_DEX_BIDOOF,
        ...
        [SPECIES_MARACTUS_MEGA - 1] = NATIONAL_DEX_MARACTUS,
        [SPECIES_WHISCASH_MEGA - 1] = NATIONAL_DEX_WHISCASH,
        [SPECIES_SHUCKLE_MEGA - 1] = NATIONAL_DEX_SHUCKLE,
        [SPECIES_PARASECT_MEGA - 1] = NATIONAL_DEX_PARASECT,
        [SPECIES_RABSCA_MEGA - 1] = NATIONAL_DEX_RABSCA,
        [SPECIES_SPIDOPS_MEGA - 1] = NATIONAL_DEX_SPIDOPS,
        [SPECIES_KRICKETUNE_MEGA - 1] = NATIONAL_DEX_KRICKETUNE,
        [SPECIES_VENOMOTH_MEGA - 1] = NATIONAL_DEX_VENOMOTH,
        ...
        [SPECIES_SERPERIOR_MEGA - 1] = NATIONAL_DEX_SERPERIOR,
        [SPECIES_EMBOAR_MEGA - 1] = NATIONAL_DEX_EMBOAR,
        [SPECIES_INCINEROAR_MEGA - 1] = NATIONAL_DEX_INCINEROAR,
        [SPECIES_PRIMARINA_MEGA - 1] = NATIONAL_DEX_PRIMARINA,
        ...
        [SPECIES_MEOWSCARADA_MEGA - 1] = NATIONAL_DEX_YUKAXATO,
        [SPECIES_SKELEDIRGE_MEGA - 1] = NATIONAL_DEX_SPICABORO,
        [SPECIES_QUAQUAVAL_MEGA - 1] = NATIONAL_DEX_QUAXISTADOR,
        ...
        [SPECIES_FLAPPLE_MEGA - 1] = NATIONAL_DEX_FLAPPLE,
        [SPECIES_SANDACONDA_MEGA - 1] = NATIONAL_DEX_SANDACONDA,
        [SPECIES_TOXTRICITY_MEGA - 1] = NATIONAL_DEX_TOXTRICITY,
        ...
        [SPECIES_ALCREMIE_MEGA - 1] = NATIONAL_DEX_ALCREMIE,
        [SPECIES_COPPERAJAH_MEGA - 1] = NATIONAL_DEX_COPPERAJAH,
        [SPECIES_SNORLAX_MEGA - 1] = NATIONAL_DEX_SNORLAX,
        [SPECIES_CLEFABLE_MEGA - 1] = NATIONAL_DEX_CLEFABLE,
        ...
        [SPECIES_STARAPTOR_MEGA - 1] = NATIONAL_DEX_STARAPTOR,
        [SPECIES_FROSLASS_MEGA - 1] = NATIONAL_DEX_FROSLASS,
        [SPECIES_EXCADRILL_MEGA - 1] = NATIONAL_DEX_EXCADRILL,
        [SPECIES_SCOLIPEDE_MEGA - 1] = NATIONAL_DEX_SCOLIPEDE,
        [SPECIES_SCRAFTY_MEGA - 1] = NATIONAL_DEX_SCRAFTY,
        [SPECIES_EELEKTROSS_MEGA - 1] = NATIONAL_DEX_EELEKTROSS,
        [SPECIES_CHANDELURE_MEGA - 1] = NATIONAL_DEX_CHANDELURE,
        [SPECIES_GOLURK_MEGA - 1] = NATIONAL_DEX_GOLURK,
        [SPECIES_PYROAR_MEGA_M - 1] = NATIONAL_DEX_PYROAR,
        [SPECIES_PYROAR_MEGA_F - 1] = NATIONAL_DEX_PYROAR,
        [SPECIES_MEOWSTIC_MEGA - 1] = NATIONAL_DEX_MEOWSTIC,
        [SPECIES_MALAMAR_MEGA - 1] = NATIONAL_DEX_MALAMAR,
        [SPECIES_BARBARACLE_MEGA - 1] = NATIONAL_DEX_BARBARACLE,
        [SPECIES_DRAGALGE_MEGA - 1] = NATIONAL_DEX_DRAGALGE,
        [SPECIES_HAWLUCHA_MEGA - 1] = NATIONAL_DEX_HAWLUCHA,
        [SPECIES_CRABOMINABLE_MEGA - 1] = NATIONAL_DEX_CRABOMINABLE,
        [SPECIES_GOLISOPOD_MEGA - 1] = NATIONAL_DEX_GOLISOPOD,
        [SPECIES_DRAMPA_MEGA - 1] = NATIONAL_DEX_DRAMPA,
        [SPECIES_SCOVILLAIN_MEGA - 1] = NATIONAL_DEX_SCOVILLAIN,
        [SPECIES_GLIMMORA_MEGA - 1] = NATIONAL_DEX_GLIMMORA,
        [SPECIES_TATSUGIRI_MEGA - 1] = NATIONAL_DEX_TATSUGIRI,
        [SPECIES_BAXCALIBUR_MEGA - 1] = NATIONAL_DEX_BAXCALIBUR,
        // Alolan Forms
        ...
        [SPECIES_ROTOM_SOUND - 1] = NATIONAL_DEX_ROTOM,
        // Origin Forme
        ...
        // [SPECIES_SMASHBAG - 1] = NATIONAL_DEX_SMASHBAG,
        // [SPECIES_CLAWHILL - 1] = NATIONAL_DEX_CLAWHILL,
        // [SPECIES_MAGICORN - 1] = NATIONAL_DEX_MAGICORN,
        // [SPECIES_MAGICOAT - 1] = NATIONAL_DEX_MAGICOAT,
        // [SPECIES_SWIRLHEAD - 1] = NATIONAL_DEX_SWIRLHEAD,
        // [SPECIES_TERRORKING - 1] = NATIONAL_DEX_TERRORKING,
        // [SPECIES_IRONBLOON - 1] = NATIONAL_DEX_IRONBLOON,
        // [SPECIES_IRONHUT - 1] = NATIONAL_DEX_IRONHUT,
        // [SPECIES_IRONTITAN - 1] = NATIONAL_DEX_IRONTITAN,
        // [SPECIES_IRONWINGS - 1] = NATIONAL_DEX_IRONWINGS,
        // [SPECIES_IRONWITCH - 1] = NATIONAL_DEX_IRONWITCH,
};
...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
    {
        ...
        HOENN_TO_NATIONAL(SMASHBAG),
        HOENN_TO_NATIONAL(CLAWHILL),
        HOENN_TO_NATIONAL(MAGICORN),
        HOENN_TO_NATIONAL(MAGICOAT),
        HOENN_TO_NATIONAL(SWIRLHEAD),
        HOENN_TO_NATIONAL(TERRORKING),
        HOENN_TO_NATIONAL(IRONBLOON),
        HOENN_TO_NATIONAL(IRONHUT),
        HOENN_TO_NATIONAL(IRONTITAN),
        HOENN_TO_NATIONAL(IRONWINGS),
        HOENN_TO_NATIONAL(IRONWITCH),
        HOENN_TO_NATIONAL(BRUTEBONNET),
        HOENN_TO_NATIONAL(GREATTUSK),
        HOENN_TO_NATIONAL(SLITHERWING),
        HOENN_TO_NATIONAL(SCREAMTAIL),
        HOENN_TO_NATIONAL(SANDYSHOCKS),
        HOENN_TO_NATIONAL(FLUTTERMANE),
        HOENN_TO_NATIONAL(ROARINGMOON),
        HOENN_TO_NATIONAL(IRONBUNDLE),
        HOENN_TO_NATIONAL(IRONHANDS),
        HOENN_TO_NATIONAL(IRONJUGULIS),
        HOENN_TO_NATIONAL(IRONMOTH),
        HOENN_TO_NATIONAL(IRONTHORNS),
        HOENN_TO_NATIONAL(IRONTREADS),
        HOENN_TO_NATIONAL(IRONVALIANT),
        HOENN_TO_NATIONAL(SPIRIGATITO),
        HOENN_TO_NATIONAL(FLORAGATO),
        HOENN_TO_NATIONAL(YUKAXATO),
        HOENN_TO_NATIONAL(FUECOCO),
        HOENN_TO_NATIONAL(CROCALOR),
        HOENN_TO_NATIONAL(SPICABORO),
        HOENN_TO_NATIONAL(QUAXLY),
        HOENN_TO_NATIONAL(QUAXWELL),
        HOENN_TO_NATIONAL(QUAXISTADOR),
        ...
        HOENN_TO_NATIONAL(BRYNXESS),
        HOENN_TO_NATIONAL(APOKARGO),
        HOENN_TO_NATIONAL(QUEZATU),
        HOENN_TO_NATIONAL(RELICLIFFON),
        HOENN_TO_NATIONAL(DRACONEON),
        HOENN_TO_NATIONAL(MERAKI),
        HOENN_TO_NATIONAL(KAGECOON),
        HOENN_TO_NATIONAL(TANDAYU),
};
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
    {
        ...
        [SPECIES_SMASHBAG - 1] = ANIM_H_JUMPS,
        [SPECIES_CLAWHILL - 1] = ANIM_H_JUMPS,
        [SPECIES_MAGICORN - 1] = ANIM_TWIST,
        [SPECIES_MAGICOAT - 1] = ANIM_FOUR_PETAL,
        [SPECIES_SWIRLHEAD - 1] = ANIM_V_STRETCH,
        [SPECIES_TERRORKING - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONBLOON - 1] = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        [SPECIES_IRONHUT - 1] = ANIM_FLASH_YELLOW,
        [SPECIES_IRONTITAN - 1] = ANIM_V_SHAKE,
        [SPECIES_IRONWINGS - 1] = ANIM_H_SLIDE_SLOW,
        [SPECIES_IRONWITCH - 1] = ANIM_H_JUMPS,
        [SPECIES_BRUTEBONNET - 1] = ANIM_H_JUMPS,
        [SPECIES_GREATTUSK - 1] = ANIM_H_JUMPS,
        [SPECIES_SLITHERWING - 1] = ANIM_ROTATE_UP_SLAM_DOWN,
        [SPECIES_SCREAMTAIL - 1] = ANIM_H_JUMPS,
        [SPECIES_SANDYSHOCKS - 1] = ANIM_H_JUMPS,
        [SPECIES_FLUTTERMANE - 1] = ANIM_GROW_STUTTER,
        [SPECIES_ROARINGMOON - 1] = ANIM_GROW_VIBRATE,
        [SPECIES_IRONBUNDLE - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONHANDS - 1] = ANIM_V_SQUISH_AND_BOUNCE,
        [SPECIES_IRONJUGULIS - 1] = ANIM_ZIGZAG_SLOW,
        [SPECIES_IRONMOTH - 1] = ANIM_H_SLIDE_SHRINK,
        [SPECIES_IRONTHORNS - 1] = ANIM_V_STRETCH_BOTH_ENDS_SLOW,
        [SPECIES_IRONTREADS - 1] = ANIM_SPIN_LONG,
        [SPECIES_IRONVALIANT - 1] = ANIM_GROW_VIBRATE,
        [SPECIES_SPIRIGATITO - 1] = ANIM_H_JUMPS,
        [SPECIES_FLORAGATO - 1] = ANIM_H_JUMPS,
        [SPECIES_YUKAXATO - 1] = ANIM_H_JUMPS,
        [SPECIES_FUECOCO - 1] = ANIM_H_JUMPS,
        [SPECIES_CROCALOR - 1] = ANIM_H_JUMPS,
        [SPECIES_SPICABORO - 1] = ANIM_H_JUMPS,
        [SPECIES_QUAXLY - 1] = ANIM_H_JUMPS,
        [SPECIES_QUAXWELL - 1] = ANIM_H_JUMPS,
        [SPECIES_QUAXISTADOR - 1] = ANIM_H_JUMPS,
        [SPECIES_PAWMI - 1] = ANIM_H_JUMPS,
        [SPECIES_PAWMO - 1] = ANIM_H_JUMPS,
        [SPECIES_PAWMOT - 1] = ANIM_H_JUMPS,
        [SPECIES_ANNIHILAPE - 1] = ANIM_GLOW_RED,
        [SPECIES_DUDUNSPARCE - 1] = ANIM_H_JUMPS,
        [SPECIES_FARIGIRAF - 1] = ANIM_H_JUMPS,
        [SPECIES_KINGAMBIT - 1] = ANIM_GROW_STUTTER_SLOW,
        [SPECIES_CASTSTORM - 1] = ANIM_H_JUMPS,
        [SPECIES_BRYNXESS - 1] = ANIM_CONVEX_DOUBLE_ARC,
        [SPECIES_APOKARGO - 1] = ANIM_V_STRETCH_BOTH_ENDS_TWICE,
        [SPECIES_QUEZATU - 1] = ANIM_RISING_WOBBLE,
        [SPECIES_RELICLIFFON - 1] = ANIM_BACK_AND_LUNGE,
        [SPECIES_ECLIMINARY - 1] = ANIM_CONVEX_DOUBLE_ARC_SLOW,
        [SPECIES_DRACONEON - 1] = ANIM_H_JUMPS,
        [SPECIES_MERAKI - 1] = ANIM_H_JUMPS,
        [SPECIES_KAGECOON - 1] = ANIM_H_JUMPS,
        [SPECIES_TANDAYU - 1] = ANIM_H_JUMPS,

        [SPECIES_TAROUNTULA - 1] = ANIM_H_JUMPS,
        [SPECIES_SPIDOPS - 1] = ANIM_H_JUMPS,
        [SPECIES_RABSCA - 1] = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
        [SPECIES_REVAVROOM - 1] = ANIM_H_JUMPS,
        [SPECIES_GLIMMORA - 1] = ANIM_H_JUMPS,
        [SPECIES_VELUZA - 1] = ANIM_H_JUMPS,
        [SPECIES_SCOVILLAIN - 1] = ANIM_H_JUMPS,
        [SPECIES_BAXCALIBUR - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_TATSUGIRI - 1] = ANIM_H_JUMPS,
        [SPECIES_CLODSIRE - 1] = ANIM_H_JUMPS,
        [SPECIES_SINISTCHA - 1] = ANIM_H_JUMPS,
        [SPECIES_ARCHALUDON - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_HYDRAPPLE - 1] = ANIM_V_STRETCH_BOTH_ENDS_SLOW,

        [SPECIES_KECLILISK - 1] = ANIM_FLICKER_INCREASING,
        [SPECIES_DHELVESSEL - 1] = ANIM_SWING_CONCAVE_FAST_SHORT,
        [SPECIES_SPIKEDASH - 1] = ANIM_ROTATE_UP_SLAM_DOWN,
        [SPECIES_IRONWALKS - 1] = ANIM_H_SLIDE,
        [SPECIES_LURINSKULL - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONSEEKER - 1] = ANIM_H_JUMPS,
        [SPECIES_NOKAY - 1] = ANIM_ROTATE_UP_SLAM_DOWN,
        [SPECIES_IRONKNEEL - 1] = ANIM_GLOW_BLUE,
        [SPECIES_VENOMFEAR - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONSTING - 1] = ANIM_H_JUMPS,
        [SPECIES_SLENDERSUN - 1] = ANIM_GROW_STUTTER_TWICE,
        [SPECIES_IRONPANEL - 1] = ANIM_SPRING_RISING,
        [SPECIES_DREADBOULD - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONHOLE - 1] = ANIM_GROW_STUTTER_SLOW,
        [SPECIES_ARCHMUSSEL - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONPUMP - 1] = ANIM_GROW_VIBRATE,
        [SPECIES_STEAMOUNT - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONFUSE - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_ABYSSCLAW - 1] = ANIM_BACK_AND_LUNGE,
        [SPECIES_IRONSUB - 1] = ANIM_TRIANGLE_DOWN_TWICE,
        [SPECIES_CINDEROOT - 1] = ANIM_GLOW_RED,
        [SPECIES_IRONPLASMA - 1] = ANIM_GLOW_RED,
        [SPECIES_GLACIARMOR - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONWAVES - 1] = ANIM_H_JUMPS,
        [SPECIES_SUMMONCIRCLE - 1] = ANIM_SHAKE_GLOW_WHITE_SLOW,
        [SPECIES_IRONGATE - 1] = ANIM_GLOW_PURPLE,
        [SPECIES_CUBEPUNCH - 1] = ANIM_H_SHAKE,
        [SPECIES_IRONVISION - 1] = ANIM_GLOW_YELLOW,
        [SPECIES_BARKJAM - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONBUZZ - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_FLOATINHUNT - 1] = ANIM_SWING_CONVEX_FAST_SHORT,
        [SPECIES_IRONROCKET - 1] = ANIM_TRIANGLE_DOWN,
        [SPECIES_PLEASODOR - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONSPRAY - 1] = ANIM_H_SLIDE,
        [SPECIES_IRONFECTION - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_INFINAGA - 1] = ANIM_SPIN_LONG,
        [SPECIES_IRONFAN - 1] = ANIM_FOUR_PETAL,
        [SPECIES_TOXSPITTLE - 1] = ANIM_H_JUMPS_V_STRETCH,
        [SPECIES_IRONSAT - 1] = ANIM_SHAKE_FLASH_YELLOW,
        [SPECIES_CRAWLFANG - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_IRONBOOM - 1] = ANIM_GROW_IN_STAGES,
        [SPECIES_SEALSTONE - 1] = ANIM_H_SHAKE_SLOW,
        [SPECIES_IRONSABER - 1] = ANIM_TUMBLING_FRONT_FLIP,
        [SPECIES_GLIDEBURN - 1] = ANIM_V_JUMPS_H_JUMPS,
        [SPECIES_IRONCUBATOR - 1] = ANIM_GLOW_PURPLE,
        ...
        [SPECIES_ROTOM_SOUND - 1] = ANIM_TIP_MOVE_FORWARD,
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] =
    {
        ...
        [SPECIES_SMASHBAG - 1] = 10,
        [SPECIES_CLAWHILL - 1] = 10,
        [SPECIES_MAGICORN - 1] = 10,
        [SPECIES_MAGICOAT - 1] = 10,
        [SPECIES_SWIRLHEAD - 1] = 10,
        [SPECIES_TERRORKING - 1] = 10,
        [SPECIES_IRONBLOON - 1] = 10,
        [SPECIES_IRONHUT - 1] = 10,
        [SPECIES_IRONTITAN - 1] = 10,
        [SPECIES_IRONWINGS - 1] = 10,
        [SPECIES_IRONWITCH - 1] = 10,
        [SPECIES_BRUTEBONNET - 1] = 10,
        [SPECIES_GREATTUSK - 1] = 10,
        [SPECIES_SLITHERWING - 1] = 10,
        [SPECIES_SCREAMTAIL - 1] = 10,
        [SPECIES_SANDYSHOCKS - 1] = 10,
        [SPECIES_FLUTTERMANE - 1] = 10,
        [SPECIES_ROARINGMOON - 1] = 10,
        [SPECIES_IRONBUNDLE - 1] = 10,
        [SPECIES_IRONHANDS - 1] = 10,
        [SPECIES_IRONJUGULIS - 1] = 10,
        [SPECIES_IRONMOTH - 1] = 10,
        [SPECIES_IRONTHORNS - 1] = 10,
        [SPECIES_IRONTREADS - 1] = 10,
        [SPECIES_IRONVALIANT - 1] = 10,
        [SPECIES_SPIRIGATITO - 1] = 10,
        [SPECIES_FLORAGATO - 1] = 10,
        [SPECIES_YUKAXATO - 1] = 10,
        [SPECIES_FUECOCO - 1] = 10,
        [SPECIES_CROCALOR - 1] = 10,
        [SPECIES_SPICABORO - 1] = 10,
        [SPECIES_QUAXLY - 1] = 10,
        [SPECIES_QUAXWELL - 1] = 10,
        [SPECIES_QUAXISTADOR - 1] = 10,
        [SPECIES_PAWMI - 1] = 10,
        [SPECIES_PAWMO - 1] = 10,
        [SPECIES_PAWMOT - 1] = 10,
        [SPECIES_ANNIHILAPE - 1] = 10,
        [SPECIES_DUDUNSPARCE - 1] = 10,
        [SPECIES_FARIGIRAF - 1] = 10,
        [SPECIES_KINGAMBIT - 1] = 10,
        [SPECIES_CASTSTORM - 1] = 10,
        [SPECIES_BRYNXESS - 1] = 10,
        [SPECIES_APOKARGO - 1] = 10,
        [SPECIES_QUEZATU - 1] = 10,
        [SPECIES_RELICLIFFON - 1] = 10,
        [SPECIES_DRACONEON - 1] = 10,
        [SPECIES_MERAKI - 1] = 10,
        [SPECIES_KAGECOON - 1] = 10,
        [SPECIES_TANDAYU - 1] = 10,
#if P_GEN_7_POKEMON == TRUE
...
u16 GetEvolutionTargetSpecies(struct Pokemon *mon, u8 mode, u16 evolutionItem, struct Pokemon *tradePartner)
{
    ...
    case EVO_MODE_NORMAL:
        ...
        for (i = 0; i < EVOS_PER_MON; i++)
        {
            ...
            case EVO_LEVEL_RAIN:
                j = GetCurrentWeather();
                if (gEvolutionTable[species][i].param <= level && (j == WEATHER_RAIN || j == WEATHER_RAIN_THUNDERSTORM || j == WEATHER_DOWNPOUR))
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            case EVO_MAPSEC:
    ...
    case EVO_MODE_OVERWORLD_SPECIAL:
        for (i = 0; i < EVOS_PER_MON; i++)
        {
            ...
            case EVO_SCRIPT_TRIGGER_DMG:
            {
                ...
                if (evolutionItem == EVO_SCRIPT_TRIGGER_DMG && currentHp != 0 && (GetMonData(mon, MON_DATA_MAX_HP, NULL) - currentHp >= gEvolutionTable[species][i].param))
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            }
...
void SetWildMonHeldItem(void)
{
    if (!(gBattleTypeFlags & (BATTLE_TYPE_LEGENDARY | BATTLE_TYPE_TRAINER | BATTLE_TYPE_PYRAMID | BATTLE_TYPE_PIKE)))
    {
        ...
        if (!GetMonData(&gPlayerParty[0], MON_DATA_SANITY_IS_EGG, 0) && (GetMonAbility(&gPlayerParty[0]) == ABILITY_COMPOUND_EYES || GetMonAbility(&gPlayerParty[0]) == ABILITY_SUPER_LUCK))
        {
            chanceNoItem = 20;
            chanceNotRare = 80;
        }
...
void TryToSetBattleFormChangeMoves(struct Pokemon *mon)
{
    ...
    for (i = 0; formChanges[i].method != FORM_CHANGE_END; i++)
    {
        if ((formChanges[i].method == FORM_BATTLE_BEGIN || formChanges[i].method == FORM_BATTLE_END) && formChanges[i].param2 && formChanges[i].param3 && formChanges[i].targetSpecies == species)
        {
