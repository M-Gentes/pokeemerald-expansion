...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
    {
        ...
        [SPECIES_FLUTTERMANE - 1] = ANIM_H_JUMPS,
        [SPECIES_ROARINGMOON - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONBUNDLE - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONHANDS - 1] = ANIM_V_SQUISH_AND_BOUNCE,
        [SPECIES_IRONJUGULIS - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONMOTH - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONTHORNS - 1] = ANIM_H_JUMPS,
        [SPECIES_IRONTREADS - 1] = ANIM_SPIN_LONG,
        [SPECIES_IRONVALIANT - 1] = ANIM_H_JUMPS,
        ...
        [SPECIES_BRYNXESS - 1] = ANIM_H_JUMPS,
