...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
    {
        ...
        [SPECIES_FORTRESS_MEGA - 1] = NATIONAL_DEX_FORTRESS,
        [SPECIES_BOLTUND_MEGA - 1] = NATIONAL_DEX_BOLTUND,
        [SPECIES_SWALOT_MEGA - 1] = NATIONAL_DEX_SWALOT,
        [SPECIES_SLOKING_MEGA - 1] = NATIONAL_DEX_SLOKING,
        [SPECIES_GOLKING_MEGA - 1] = NATIONAL_DEX_GOLKING,
        ...
        [SPECIES_SRAFTY_MEGA - 1] = NATIONAL_DEX_SRAFTY,
