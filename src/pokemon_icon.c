...
const u8 *const gMonIconTable[] =
    {
...
#endif
        [SPECIES_SMASHBAG] = gMonIcon_Smashbag,
        [SPECIES_CLAWHILL] = gMonIcon_Clawhill,
        [SPECIES_MAGICORN] = gMonIcon_Magicorn,
        [SPECIES_MAGICOAT] = gMonIcon_Magicoat,
        [SPECIES_SWIRLHEAD] = gMonIcon_Swirlhead,
        [SPECIES_TERRORKING] = gMonIcon_Terrorking,
        [SPECIES_IRONBLOON] = gMonIcon_Ironbloon,
        [SPECIES_IRONHUT] = gMonIcon_Ironhut,
        [SPECIES_IRONTITAN] = gMonIcon_Irontitan,
        [SPECIES_IRONWINGS] = gMonIcon_Ironwings,
        [SPECIES_IRONWITCH] = gMonIcon_Ironwitch,
        [SPECIES_BRUTEBONNET] = gMonIcon_Brutebonnet,
        [SPECIES_GREATTUSK] = gMonIcon_Greattusk,
        [SPECIES_SLITHERWING] = gMonIcon_Slitherwing,
        [SPECIES_SCREAMTAIL] = gMonIcon_Screamtail,
        [SPECIES_SANDYSHOCKS] = gMonIcon_Sandyshocks,
        [SPECIES_FLUTTERMANE] = gMonIcon_Fluttermane,
        [SPECIES_ROARINGMOON] = gMonIcon_Roaringmoon,
        [SPECIES_IRONBUNDLE] = gMonIcon_Ironbundle,
        [SPECIES_IRONHANDS] = gMonIcon_Ironhands,
        [SPECIES_IRONJUGULIS] = gMonIcon_Ironjugulis,
        [SPECIES_IRONMOTH] = gMonIcon_Ironmoth,
        [SPECIES_IRONTHORNS] = gMonIcon_Ironthorns,
        [SPECIES_IRONTREADS] = gMonIcon_Irontreads,
        [SPECIES_IRONVALIANT] = gMonIcon_Ironvaliant,
        [SPECIES_SPIRIGATITO] = gMonIcon_Spirigatito,
        [SPECIES_FLORAGATO] = gMonIcon_Floragato,
        [SPECIES_YUKAXATO] = gMonIcon_Yukaxato,
        [SPECIES_FUECOCO] = gMonIcon_Fuecoco,
        [SPECIES_CROCALOR] = gMonIcon_Crocalor,
        [SPECIES_SPICABORO] = gMonIcon_Spicaboro,
        [SPECIES_QUAXLY] = gMonIcon_Quaxly,
        [SPECIES_QUAXWELL] = gMonIcon_Quaxwell,
        [SPECIES_QUAXISTADOR] = gMonIcon_Quaxistador,
        ...
        [SPECIES_CASTSTORM] = gMonIcon_Caststorm,
        [SPECIES_BRYNXESS] = gMonIcon_Brynxess,
        [SPECIES_APOKARGO] = gMonIcon_Apokargo,
        [SPECIES_QUEZATU] = gMonIcon_Quezatu,
        [SPECIES_RELICLIFFON] = gMonIcon_Relicliffon,
        [SPECIES_DRACONEON] = gMonIcon_Draconeon,
        [SPECIES_MERAKI] = gMonIcon_Meraki,
        [SPECIES_KAGECOON] = gMonIcon_Kagecoon,
        [SPECIES_TANDAYU] = gMonIcon_Tandayu,
        [SPECIES_TENTACRUEL_MEGA] = gMonIcon_TentacruelMega,
        ...
        [SPECIES_FEAROW_MEGA] = gMonIcon_FearowMega,
        [SPECIES_MACHAMP_MEGA] = gMonIcon_MachampMega,
        [SPECIES_GOLEM_MEGA] = gMonIcon_GolemMega,
        [SPECIES_NOCTOWL_MEGA] = gMonIcon_NoctowlMega,
        [SPECIES_KINGDRA_MEGA] = gMonIcon_KingdraMega,
        [SPECIES_CHIMECHO_MEGA] = gMonIcon_ChimechoMega,
        [SPECIES_WAILORD_MEGA] = gMonIcon_WailordMega,
        [SPECIES_CHESNAUGHT_MEGA] = gMonIcon_ChesnaughtMega,
        [SPECIES_DELPHOX_MEGA] = gMonIcon_DelphoxMega,
        [SPECIES_PALOSSAND_MEGA] = gMonIcon_PalossandMega,
        [SPECIES_FALINKS_MEGA] = gMonIcon_FalinksMega,
        [SPECIES_ECLIMINARY] = gMonIcon_Ecliminary,
        [SPECIES_PUMPKING] = gMonIcon_Pumpking,
        ...
        [SPECIES_KECLILISK] = gMonIcon_Keclilisk,
        [SPECIES_DHELVESSEL] = gMonIcon_Dhelvessel,
        [SPECIES_SPIKEDASH] = gMonIcon_Spikedash,
        [SPECIES_IRONWALKS] = gMonIcon_Ironwalks,
        [SPECIES_LURINSKULL] = gMonIcon_Lurinskull,
        [SPECIES_IRONSEEKER] = gMonIcon_Ironseeker,
        [SPECIES_NOKAY] = gMonIcon_Nokay,
        [SPECIES_IRONKNEEL] = gMonIcon_Ironkneel,
        [SPECIES_VENOMFEAR] = gMonIcon_Venomfear,
        [SPECIES_IRONSTING] = gMonIcon_Ironsting,
        [SPECIES_SLENDERSUN] = gMonIcon_Slendersun,
        [SPECIES_IRONPANEL] = gMonIcon_Ironpanel,
        [SPECIES_DREADBOULD] = gMonIcon_Dreadbould,
        [SPECIES_IRONHOLE] = gMonIcon_Ironhole,
        [SPECIES_ARCHMUSSEL] = gMonIcon_Archmussel,
        [SPECIES_IRONPUMP] = gMonIcon_Ironpump,
        [SPECIES_STEAMOUNT] = gMonIcon_Steamount,
        [SPECIES_IRONFUSE] = gMonIcon_Ironfuse,
        [SPECIES_ABYSSCLAW] = gMonIcon_Abyssclaw,
        [SPECIES_IRONSUB] = gMonIcon_Ironsub,
        [SPECIES_CINDEROOT] = gMonIcon_Cinderoot,
        [SPECIES_IRONPLASMA] = gMonIcon_Ironplasma,
        [SPECIES_GLACIARMOR] = gMonIcon_Glaciarmor,
        [SPECIES_IRONWAVES] = gMonIcon_Ironwaves,
        [SPECIES_SUMMONCIRCLE] = gMonIcon_Summoncircle,
        [SPECIES_IRONGATE] = gMonIcon_Irongate,
        [SPECIES_CUBEPUNCH] = gMonIcon_Cubepunch,
        [SPECIES_IRONVISION] = gMonIcon_Ironvision,
        [SPECIES_BARKJAM] = gMonIcon_Barkjam,
        [SPECIES_IRONBUZZ] = gMonIcon_Ironbuzz,
        [SPECIES_FLOATINHUNT] = gMonIcon_Floatinhunt,
        [SPECIES_IRONROCKET] = gMonIcon_Ironrocket,
        [SPECIES_PLEASODOR] = gMonIcon_Pleasodor,
        [SPECIES_IRONSPRAY] = gMonIcon_Ironspray,
        [SPECIES_SANESECT] = gMonIcon_Sanesect,
        [SPECIES_IRONFECTION] = gMonIcon_Ironfection,
        [SPECIES_INFINAGA] = gMonIcon_Infinaga,
        [SPECIES_IRONFAN] = gMonIcon_Ironfan,
        [SPECIES_TOXSPITTLE] = gMonIcon_Toxspittle,
        [SPECIES_IRONSAT] = gMonIcon_Ironsat,
        [SPECIES_CRAWLFANG] = gMonIcon_Crawlfang,
        [SPECIES_IRONBOOM] = gMonIcon_Ironboom,
        [SPECIES_SEALSTONE] = gMonIcon_Sealstone,
        [SPECIES_IRONSABER] = gMonIcon_Ironsaber,
        [SPECIES_GLIDEBURN] = gMonIcon_Glideburn,
        [SPECIES_IRONCUBATOR] = gMonIcon_Ironcubator,
        [SPECIES_RAPIDASH_MEGA] = gMonIcon_RapidashMega,
        [SPECIES_MIGHTYENA_MEGA] = gMonIcon_MightyenaMega,
        [SPECIES_DRIFBLIM_MEGA] = gMonIcon_DrifblimMega,
        [SPECIES_VANILLUXE_MEGA] = gMonIcon_VanilluxeMega,
        [SPECIES_FORRETRESS_MEGA] = gMonIcon_ForretressMega,
        [SPECIES_BOLTUND_MEGA] = gMonIcon_BoltundMega,
        [SPECIES_SWALOT_MEGA] = gMonIcon_SwalotMega,
        [SPECIES_SLOWKING_MEGA] = gMonIcon_SlowkingMega,
        [SPECIES_SEAKING_MEGA] = gMonIcon_SeakingMega,
        [SPECIES_LEDIAN_MEGA] = gMonIcon_LedianMega,
        [SPECIES_ARBOK_MEGA] = gMonIcon_ArbokMega,
        [SPECIES_SMEARGLE_MEGA] = gMonIcon_SmeargleMega,
        [SPECIES_REVAVROOM_MEGA] = gMonIcon_RevavroomMega,
        [SPECIES_KLEFKI_MEGA] = gMonIcon_KlefkiMega,
        [SPECIES_PINCURCHIN_MEGA] = gMonIcon_PincurchinMega,
        [SPECIES_TURTONATOR_MEGA] = gMonIcon_TurtonatorMega,
        [SPECIES_THIEVUL_MEGA] = gMonIcon_ThievulMega,
        [SPECIES_TOUCANNON_MEGA] = gMonIcon_ToucannonMega,
        [SPECIES_YANMEGA_MEGA] = gMonIcon_YanmegaMega,
        [SPECIES_LIEPARD_MEGA] = gMonIcon_LiepardMega,
        [SPECIES_KLINKLANG_MEGA] = gMonIcon_KlinklangMega,
        [SPECIES_HONCHKROW_MEGA] = gMonIcon_HonchkrowMega,
        [SPECIES_GOLDUCK_MEGA] = gMonIcon_GolduckMega,
        [SPECIES_ROSERADE_MEGA] = gMonIcon_RoseradeMega,
        [SPECIES_SIGILYPH_MEGA] = gMonIcon_SigilyphMega,
        [SPECIES_MANTINE_MEGA] = gMonIcon_MantineMega,
        [SPECIES_BIDOOF_MEGA] = gMonIcon_BidoofMega,
        ...
        [SPECIES_MARACTUS_MEGA] = gMonIcon_MaractusMega,
        [SPECIES_WHISCASH_MEGA] = gMonIcon_WhiscashMega,
        [SPECIES_SHUCKLE_MEGA] = gMonIcon_ShuckleMega,
        [SPECIES_PARASECT_MEGA] = gMonIcon_ParasectMega,
        [SPECIES_RABSCA_MEGA] = gMonIcon_RabscaMega,
        [SPECIES_SPIDOPS_MEGA] = gMonIcon_SpidopsMega,
        [SPECIES_KRICKETUNE_MEGA] = gMonIcon_KricketuneMega,
        [SPECIES_VENOMOTH_MEGA] = gMonIcon_VenomothMega,
        ...
        [SPECIES_FLAPPLE_MEGA] = gMonIcon_FlappleMega,
        ...
        [SPECIES_CLEFABLE_MEGA] = gMonIcon_ClefableMega,
        [SPECIES_VICTREEBEL_MEGA] = gMonIcon_VictreebelMega,
        ...
        [SPECIES_STARAPTOR_MEGA] = gMonIcon_StaraptorMega,
        [SPECIES_FROSLASS_MEGA] = gMonIcon_FroslassMega,
        [SPECIES_EXCADRILL_MEGA] = gMonIcon_ExcadrillMega,
        [SPECIES_SCOLIPEDE_MEGA] = gMonIcon_ScolipedeMega,
        [SPECIES_SCRAFTY_MEGA] = gMonIcon_ScraftyMega,
        [SPECIES_EELEKTROSS_MEGA] = gMonIcon_EelektrossMega,
        [SPECIES_CHANDELURE_MEGA] = gMonIcon_ChandelureMega,
        [SPECIES_GOLURK_MEGA] = gMonIcon_GolurkMega,
        [SPECIES_PYROAR_MEGA_M] = gMonIcon_PyroarMegaM,
        [SPECIES_PYROAR_MEGA_F] = gMonIcon_PyroarMegaF,
        [SPECIES_MEOWSTIC_MEGA] = gMonIcon_MeowsticMega,
        [SPECIES_MALAMAR_MEGA] = gMonIcon_MalamarMega,
        [SPECIES_BARBARACLE_MEGA] = gMonIcon_BarbaracleMega,
        [SPECIES_DRAGALGE_MEGA] = gMonIcon_DragalgeMega,
        [SPECIES_HAWLUCHA_MEGA] = gMonIcon_HawluchaMega,
        [SPECIES_CRABOMINABLE_MEGA] = gMonIcon_CrabominableMega,
        [SPECIES_GOLISOPOD_MEGA] = gMonIcon_GolisopodMega,
        [SPECIES_DRAMPA_MEGA] = gMonIcon_DrampaMega,
        [SPECIES_SCOVILLAIN_MEGA] = gMonIcon_ScovillainMega,
        [SPECIES_GLIMMORA_MEGA] = gMonIcon_GlimmoraMega,
        [SPECIES_TATSUGIRI_MEGA] = gMonIcon_TatsugiriMega,
        [SPECIES_BAXCALIBUR_MEGA] = gMonIcon_BaxcaliburMega,
        ...
        [SPECIES_ROTOM_SOUND] = gMonIcon_RotomSound,
...
const u8 gMonIconPaletteIndices[] =
    {
        ...
        [SPECIES_MAGICOAT] = 1,
        [SPECIES_SWIRLHEAD] = 1,
        [SPECIES_TERRORKING] = 2,
        [SPECIES_IRONBLOON] = 0,
        [SPECIES_IRONHUT] = 1,
        [SPECIES_IRONTITAN] = 0,
        [SPECIES_IRONWINGS] = 1,
        [SPECIES_IRONWITCH] = 0,
        [SPECIES_BRUTEBONNET] = 0,
        [SPECIES_GREATTUSK] = 0,
        [SPECIES_SLITHERWING] = 0,
        [SPECIES_SCREAMTAIL] = 0,
        [SPECIES_SANDYSHOCKS] = 0,
        [SPECIES_FLUTTERMANE] = 0,
        [SPECIES_ROARINGMOON] = 0,
        [SPECIES_IRONBUNDLE] = 0,
        [SPECIES_IRONHANDS] = 2,
        [SPECIES_IRONJUGULIS] = 2,
        [SPECIES_IRONMOTH] = 0,
        [SPECIES_IRONTHORNS] = 0,
        [SPECIES_IRONTREADS] = 0,
        [SPECIES_IRONVALIANT] = 1,
        [SPECIES_SPIRIGATITO] = 4,
        [SPECIES_FLORAGATO] = 4,
        [SPECIES_YUKAXATO] = 4,
        [SPECIES_FUECOCO] = 0,
        [SPECIES_CROCALOR] = 0,
        ...
        [SPECIES_HYDRAPPLE] = 1,
        [SPECIES_KECLILISK] = 1,
        [SPECIES_DHELVESSEL] = 1,
        [SPECIES_SPIKEDASH] = 0,
        [SPECIES_IRONWALKS] = 2,
        [SPECIES_LURINSKULL] = 0,
        [SPECIES_IRONSEEKER] = 0,
        [SPECIES_NOKAY] = 0,
        [SPECIES_IRONKNEEL] = 0,
        [SPECIES_VENOMFEAR] = 0,
        [SPECIES_IRONSTING] = 0,
        [SPECIES_SLENDERSUN] = 1,
        [SPECIES_IRONPANEL] = 0,
        [SPECIES_DREADBOULD] = 0,
        [SPECIES_IRONHOLE] = 2,
        [SPECIES_ARCHMUSSEL] = 0,
        [SPECIES_IRONPUMP] = 0,
        [SPECIES_STEAMOUNT] = 0,
        [SPECIES_IRONFUSE] = 1,
        [SPECIES_ABYSSCLAW] = 0,
        [SPECIES_IRONSUB] = 0,
        [SPECIES_CINDEROOT] = 0,
        [SPECIES_IRONPLASMA] = 2,
        [SPECIES_GLACIARMOR] = 0,
        [SPECIES_IRONWAVES] = 0,
        [SPECIES_SUMMONCIRCLE] = 0,
        [SPECIES_IRONGATE] = 1,
        [SPECIES_CUBEPUNCH] = 0,
        [SPECIES_IRONVISION] = 0,
        [SPECIES_BARKJAM] = 1,
        [SPECIES_IRONBUZZ] = 0,
        [SPECIES_FLOATINHUNT] = 1,
        [SPECIES_IRONROCKET] = 0,
        [SPECIES_PLEASODOR] = 2,
        [SPECIES_IRONSPRAY] = 0,
        [SPECIES_SANESECT] = 0,
        [SPECIES_IRONFECTION] = 0,
        [SPECIES_INFINAGA] = 0,
        [SPECIES_IRONFAN] = 0,
        [SPECIES_TOXSPITTLE] = 0,
        [SPECIES_IRONSAT] = 0,
        [SPECIES_CRAWLFANG] = 0,
        [SPECIES_IRONBOOM] = 0,
        [SPECIES_SEALSTONE] = 0,
        [SPECIES_IRONSABER] = 0,
        [SPECIES_GLIDEBURN] = 0,
        [SPECIES_IRONCUBATOR] = 0,
        [SPECIES_RAPIDASH_MEGA] = 3,
        [SPECIES_MIGHTYENA_MEGA] = 2,
        [SPECIES_DRIFBLIM_MEGA] = 2,
        [SPECIES_VANILLUXE_MEGA] = 2,
        [SPECIES_FORRETRESS_MEGA] = 2,
        [SPECIES_BOLTUND_MEGA] = 1,
        [SPECIES_SWALOT_MEGA] = 2,
        [SPECIES_SLOWKING_MEGA] = 0,
        [SPECIES_SEAKING_MEGA] = 0,
        [SPECIES_LEDIAN_MEGA] = 0,
        [SPECIES_ARBOK_MEGA] = 2,
        [SPECIES_SMEARGLE_MEGA] = 1,
        [SPECIES_REVAVROOM_MEGA] = 0,
        [SPECIES_KLEFKI_MEGA] = 0,
        [SPECIES_PINCURCHIN_MEGA] = 0,
        [SPECIES_TURTONATOR_MEGA] = 0,
        [SPECIES_THIEVUL_MEGA] = 2,
        [SPECIES_TOUCANNON_MEGA] = 0,
        [SPECIES_YANMEGA_MEGA] = 1,
        [SPECIES_LIEPARD_MEGA] = 0,
        [SPECIES_KLINKLANG_MEGA] = 0,
        [SPECIES_HONCHKROW_MEGA] = 2,
        [SPECIES_GOLDUCK_MEGA] = 0,
        [SPECIES_ROSERADE_MEGA] = 0,
        [SPECIES_SIGILYPH_MEGA] = 0,
        [SPECIES_MANTINE_MEGA] = 2,
        [SPECIES_BIDOOF_MEGA] = 2,
        [SPECIES_OMASTAR_MEGA] = 0,
        [SPECIES_KABUTOPS_MEGA] = 2,
        [SPECIES_PORYGON_Z_MEGA] = 0,
        [SPECIES_MARACTUS_MEGA] = 1,
        [SPECIES_WHISCASH_MEGA] = 0,
        [SPECIES_SHUCKLE_MEGA] = 1,
        [SPECIES_PARASECT_MEGA] = 0,
        [SPECIES_RABSCA_MEGA] = 0,
        [SPECIES_SPIDOPS_MEGA] = 1,
        [SPECIES_KRICKETUNE_MEGA] = 2,
        [SPECIES_VENOMOTH_MEGA] = 2,
        ...
        [SPECIES_FLAPPLE_MEGA] = 1,
        [SPECIES_SANDACONDA_MEGA] = 2,
        ...
        [SPECIES_PYROAR_MEGA_M] = 0,
        [SPECIES_PYROAR_MEGA_F] = 2,
