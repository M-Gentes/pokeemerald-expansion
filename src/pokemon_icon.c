...
const u8 *const gMonIconTable[] =
    {
        ...
        [SPECIES_SPIRIGATITO] = gMonIcon_Pawmi,
        [SPECIES_FLORAGATO] = gMonIcon_Pawmi,
        [SPECIES_YUKAXATO] = gMonIcon_Pawmi,
        [SPECIES_FUECOCO] = gMonIcon_Pawmi,
        [SPECIES_CROCALOR] = gMonIcon_Pawmi,
        [SPECIES_SPICABORO] = gMonIcon_Pawmi,
        [SPECIES_QUAXLY] = gMonIcon_Pawmi,
        [SPECIES_QUAXWELL] = gMonIcon_Pawmi,
        [SPECIES_QUAXISTADOR] = gMonIcon_Pawmi,
