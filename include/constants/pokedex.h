...
#define NATIONAL_DEX_COUNT NATIONAL_DEX_IRONCUBATOR
...
enum
{
    ...
    HOENN_DEX_MAGICOAT,
    HOENN_DEX_SWIRLHEAD,
    HOENN_DEX_TERRORKING,
    HOENN_DEX_IRONBLOON,
    HOENN_DEX_IRONHUT,
    HOENN_DEX_IRONTITAN,
    HOENN_DEX_IRONWINGS,
    HOENN_DEX_IRONWITCH,
    HOENN_DEX_BRUTEBONNET,
    HOENN_DEX_GREATTUSK,
    HOENN_DEX_SLITHERWING,
    HOENN_DEX_SCREAMTAIL,
    HOENN_DEX_SANDYSHOCKS,
    HOENN_DEX_FLUTTERMANE,
    HOENN_DEX_ROARINGMOON,
    HOENN_DEX_IRONBUNDLE,
    HOENN_DEX_IRONHANDS,
    HOENN_DEX_IRONJUGULIS,
    HOENN_DEX_IRONMOTH,
    HOENN_DEX_IRONTHORNS,
    HOENN_DEX_IRONTREADS,
    HOENN_DEX_IRONVALIANT,
    // Paldea
    HOENN_DEX_SPIRIGATITO,
    HOENN_DEX_FLORAGATO,
    HOENN_DEX_YUKAXATO,
    HOENN_DEX_FUECOCO,
    HOENN_DEX_CROCALOR,
...
#define HOENN_DEX_COUNT (HOENN_DEX_TANDAYU + 1)
