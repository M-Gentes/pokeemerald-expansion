...
#define TRAINER_STEVEN_CUSTOM               855
#define TRAINER_ARCHIE_OCEANIC_MUSEUM       856
#define TRAINER_DELTA_SAGE                  857
#define TRAINER_MAY_LEAGUE_TREECKO          858
#define TRAINER_MAY_LEAGUE_TORCHIC          859
#define TRAINER_MAY_LEAGUE_MUDKIP           860
#define TRAINER_BRENDAN_LEAGUE_TREECKO      861
#define TRAINER_BRENDAN_LEAGUE_TORCHIC      862
#define TRAINER_BRENDAN_LEAGUE_MUDKIP       863

// NOTE: Because each Trainer uses a flag to determine when they are defeated, there is only space for 9 additional trainers before trainer flag space overflows
//       More space can be made by shifting flags around in constants/flags.h or changing how trainer flags are handled
//       MAX_TRAINERS_COUNT can be increased but will take up additional saveblock space

#define TRAINERS_COUNT                      TRAINER_BRENDAN_LEAGUE_MUDKIP + 1
