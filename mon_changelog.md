...
- Item Trade Evolutions -> {EVO_ITEM, e.g. ITEM_METAL_COAT, e.g. SCISSOR}
    - use Item out of Battle
- PIKACHU -> {
    {EVO_ITEM, ITEM_THUNDER_STONE, RAICHU},
    {EVO_ITEM, ITEM_SUN_STONE, RAICHU_ALOLAN}
}
- PIKACHU_COSPLAY -> {
            {EVO_ITEM, ITEM_SHINY_STONE, PIKACHU_POP_STAR},
            {EVO_ITEM, ITEM_DUSK_STONE, PIKACHU_ROCK_STAR},
            {EVO_ITEM, ITEM_DAWN_STONE, PIKACHU_PH_D},
            {EVO_ITEM, ITEM_ICE_STONE, PIKACHU_BELLE},
            {EVO_MOVE_TYPE, TYPE_FIGHTING, PIKACHU_LIBRE},
}
- PIKACHU_COSPLAY Form -> {EVO_ITEM, ITEM_POKE_DOLL, PIKACHU_COSPLAY}
- GROWLITHE_HISUIAN -> {EVO_ITEM, ITEM_FIRE_STONE, ARCANINE_HISUIAN}
- VOLTORB HISUIAN -> {EVO_LEVEL, Level 30, ELECTRODE_HISUIAN}
- EEVEE -> {EVO_ITEM, ITEM_DRAGON_SCALE, DRACONEON}
- QUILAVA -> {EVO_LEVEL_NIGHT, Level 36, TYPHLOSION_HISUIAN}
...
- ZORUA_HISUIAN -> {EVO_LEVEL, 30, ZOROARK_HISUIAN}
- RUFFLET -> {EVO_ITEM, ITEM_MOON_STONE, BRAVIARY_HISUIAN}
- BISHARP -> {EVO_ITEM, ITEM_DUSK_STONE, KINGAMBIT}
- GOOMY -> {EVO_ITEM, ITEM_METAL_COAT, SLIGGOO_HISUIAN}
- BERGMITE -> {EVO_MOVE_TYPE, TYPE_ROCK, AVALUGG_HISUIAN}
- DARTRIX -> {EVO_MOVE_TYPE, TYPE_FIGHTING, DECIDUEYE_HISUIAN}
- PAWMO -> {EVO_FRIENDSHIP, 25, PAWMOT}
- MAGCARGO -> {EVO_LEVEL, 40, APOKARGO}
- RELICANTH -> {EVO_LEVEL, 40, RELICLIFFON}
- XATU -> {EVO_LEVEL, 40, QUEZATU}
...
|Furret||+Speed Boost, Keen Eye, Frisk|85 + 10|76 + 20|64 + 10|45|55 + 10|90|
|Hoothoot|+Psychic, Flying|Tinted Lens, Insomnia, Keen Eye|||||||
|Noctowl|+Psychic, Flying|Tinted Lens, Insomnia, Keen Eye||||86 + 10|||
...
|Torchic|Fire|+Speed Boost, Blaze, Speed Boost|||||||
|Combusken|Fire, Fighting|+Speed Boost, Blaze, Speed Boost|||||||
|Blaziken|Fire, Fighting|+Speed Boost, Blaze, Speed Boost|||||||
|Mudkip|Water|+Water Compaction, Torrent, Damp|||||||
|Marshtomp|Water, Ground|+Water Compaction, Torrent, Damp|||||||
|Swampert|Water, Ground|+Water Compaction, Torrent, Damp|||||||
|Poochyena|Dark, +Ghost|Run Away, Quick Feet, Rattled|||||||
|Mightyena|Dark, +Ghost|Intimidate, Quick Feet, Moxie|70|90 + 20|70|60|60 + 10|70 + 20|
|Beautifly|Bug, Flying|+Triage, Swarm, Rivalry|60 + 60|70|50 + 15|100|50 + 15|65 + 20|
|Dustox|Bug, Poison|+Filter, Shield Dust, Compound Eyes|60|50|70 + 30|50 + 25|90 + 20|65|
|Shiftry|Grass, Dark|Chlorophyll, +Sheer Force, Pickpocket|90|100|60|90 + 10|60|80|
|Taillow|Normal, Flying|Guts, Scrappy, +Lightning Rod|40|55|30|30|30|85|
|Swellow|Normal, Flying|Guts, Scrappy, +Lightning Rod|60|85|60|75 + 10|50|125|
|Pelipper|Water, Flying|+Drizzle, Rain Dish, Keen Eye|||||||
|Masquerain|Bug, Flying|Intimidate, +Water Bubble, Unnerve|||||||
|Shedinja|Bug, Ghost|Wonder Guard|1 + 11|90 + 12|45|30|30|40|
